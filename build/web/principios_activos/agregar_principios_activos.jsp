...
<f:view>
    <html>
        ...
        <body>
            <br><br>
            <h:form id="form1"  >
                <h:outputText value="#{ManagedPrincipiosActivos.codigoPrincipioActivo}" styleClass="outputText2" />
                <div align="center">
                    <br>
                    <h:outputText value="Registrar Principios Activos" styleClass="tituloCabezera1"    />
                    ...
                    <br>
                    <h:commandButton value="Guardar" styleClass="commandButton" action="#{ManagedPrincipiosActivos.guardarPrincipiosActivos}"   onclick="return validar();" />
