            ...
            <a4j:form id="form1">
                <div align="center">
                    ...
                    <rich:dataTable value="#{ManagedSolicitudMantenimiento.solicitudMantenimientoList}"
                                    binding="#{ManagedSolicitudMantenimiento.solicitudMantenimientoDataTable1}"
                        ...
                        <rich:column>
                            ...
                            <a4j:commandLink action="#{ManagedSolicitudMantenimiento.verSolicitudMantenimientoDetalleMateriales_action}"
                                             rendered="#{data.solicitudProduccion eq '1'}" >
                                                 <f:param value="navegador_solicitud_mantenimiento.jsf?direccion=navegador_solicitud_mantenimiento.jsf" name="direccion" />
                    ...
                    <%-- proyectos --%>
                    <%--h:commandButton value="Agregar Solicitud de proyectos"   styleClass="btn"  actionListener="#{ManagedSolicitudMantenimiento.actionSave}">
                        <f:attribute name="url" value="navegador_solicitud_mantenimiento.jsf?nombreArea=PROYECTOS" />
                        <f:attribute name="solicitudProyectos" value="1" />
                    </h:commandButton-%>
                    <%-- produccion --%>
                    <h:commandButton value="Agregar solicitud de produccion"   styleClass="btn"  actionListener="#{ManagedSolicitudMantenimiento.actionSave}">
                        <f:attribute name="url" value="navegador_solicitud_mantenimiento.jsf?nombreArea=PRODUCCION" />
                        <f:attribute name="solicitudProduccion" value="1" />
                    </h:commandButton>
