    ...
    <html>
        ...
        <body>
            ...
            <h:form id="formulario"  >
                <div align="center"><br>
                    <h:outputText value="Modificar Materiales" styleClass="tituloCabezera1"    />
                    ...
                    <h:panelGrid columns="3" styleClass="navegadorTabla" headerClass="headerClassACliente" style="border:1px solid #0A5B99;">
                        ...
                        <h:selectOneMenu  styleClass="inputText" value="#{ManagedRegistroSolicitudMateriales.modificarItemMaterial.codMaterial}">
                        ...
                        <h:outputText styleClass="outputText2" value="::"  />
                        <h:inputTextarea styleClass="inputText" rows="2" cols="38"  value="#{ManagedRegistroSolicitudMateriales.modificarItemMaterial.descripcion}"/>

                        <h:outputText value="Cantidad" styleClass="outputText2"  />
                        <h:outputText styleClass="outputText2" value="::"  />
                        <h:inputText styleClass="inputText" value="#{ManagedRegistroSolicitudMateriales.modificarItemMaterial.cantidad}" id="cantidad"/>
                        
                    </h:panelGrid>
                    <br>
                    <h:commandButton value="Guardar" styleClass="commandButton"  action="#{ManagedRegistroSolicitudMateriales.action_guardarModificacionMaterial}" onclick="return validarFormulario();" />
