    ...
    <html>
        ...
        <body>
            ...
            <h:form id="formulario"  >
                <div align="center"><br>
                    <h:outputText value="Modificar Trabajos a Realizar" styleClass="tituloCabezera1"    />
                    ...
                    <h:panelGrid columns="3" styleClass="navegadorTabla" headerClass="headerClassACliente" style="border:1px solid #0A5B99;">
                        ...
                        <h:selectOneMenu  styleClass="inputText" value="#{ManagedRegistroSolicitudTrabajos.modificarItemTrabajo.codTipoTrabajo}">
                        ...
                        <h:outputText styleClass="outputText2" value="::"  />
                        <h:inputTextarea styleClass="inputText" rows="2" cols="38"  value="#{ManagedRegistroSolicitudTrabajos.modificarItemTrabajo.descripcion}"/>
                        ...
                        <h:panelGrid>
                            <h:selectOneMenu id="selectPersonal" styleClass="inputText" value="#{ManagedRegistroSolicitudTrabajos.modificarItemTrabajo.codPersonal}" disabled="#{ManagedRegistroSolicitudTrabajos.modificarItemTrabajo.conPersonal=='true'?'false':'true'}">
                                <f:selectItems value="#{ManagedRegistroSolicitudTrabajos.personalList}"/>
                            </h:selectOneMenu>
                            <h:selectOneMenu id="selectProovedor" styleClass="inputText" value="#{ManagedRegistroSolicitudTrabajos.modificarItemTrabajo.codProveedor}" disabled="#{ManagedRegistroSolicitudTrabajos.modificarItemTrabajo.conProveedor =='true'?'false':'true'}">
                        ...
                        <h:outputText value="" styleClass="outputText2"   />
                        <h:selectOneRadio value="#{ManagedRegistroSolicitudTrabajos.enteAsignado}" styleClass="outputText2" onclick="javascript:submit(); seleccionarAsignado(this.value);" valueChangeListener="#{ManagedRegistroSolicitudTrabajos.asignado_change}" >
                        ...
                        <h:outputText styleClass="outputText2" value="::"  />
                        <h:inputText styleClass="inputText" value="#{ManagedRegistroSolicitudTrabajos.modificarItemTrabajo.horasTrabajo}" id="horasTrabajo"/>
                    ...
                    <br>
                    <h:commandButton value="Guardar" styleClass="commandButton"  action="#{ManagedRegistroSolicitudTrabajos.action_guardarModificacionTrabajo}" onclick="return validarFormulario();" />
