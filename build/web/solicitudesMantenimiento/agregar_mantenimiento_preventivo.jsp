    ...
    <html>
        ...
        <body>
            ...
            <h:form id="formulario"  >
                <div align="center"><br>
                    <h:outputText value="Registrar Mantenimiento Preventivo" styleClass="tituloCabezera1"    />
                    ...
                    <h:panelGrid columns="3" styleClass="navegadorTabla" headerClass="headerClassACliente" style="border:1px solid #0A5B99;">
                        ...
                        <h:selectOneMenu  styleClass="inputText" value="#{ManagedRegistroMantenimientoPreventivo.adicionarMantenimientoPreventivo.codMaquina}">
                        ...
                        <h:outputText styleClass="outputText2" value="::"  />
                        <h:inputTextarea styleClass="inputText" rows="2" cols="38"  value="#{ManagedRegistroMantenimientoPreventivo.adicionarMantenimientoPreventivo.descripcion}"/>
                        ...
                        <h:outputText  value="Tiempo Estimado(hrs.)" styleClass="outputText2"  />
                        <h:outputText styleClass="outputText2" value="::"/>
                        <h:inputText styleClass="inputText" value="#{ManagedRegistroMantenimientoPreventivo.adicionarMantenimientoPreventivo.tiempoEstimado}" id="tiempoEstimado"/>

                        <h:outputText  value="Tipo de Mantenimiento Preventivo" styleClass="outputText2"  />
                        <h:outputText styleClass="outputText2" value="::"  />
                        <h:selectOneMenu  styleClass="inputText" value="#{ManagedRegistroMantenimientoPreventivo.adicionarMantenimientoPreventivo.codtipoMantenimientoPreventivo}">
                    ...
                    <br>
                    <h:commandButton value="Guardar" styleClass="commandButton"  action="#{ManagedRegistroMantenimientoPreventivo.guardarMantenimientoPreventivo_action}" onclick="return validarFormulario();" />
                    <h:commandButton value="Cancelar"  styleClass="commandButton" action="#{ManagedRegistroMantenimientoPreventivo.cancelarGuardarMantenimientoPreventivo_action}" />
                </div>
            </h:form>
        </body>
    </html>
