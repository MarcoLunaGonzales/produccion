package reporteExplosionProductosSimulacion;
...
*/
        ...
        try {
            ...
            sql4 = " select ppd.COD_MATERIAL from PROGRAMA_PRODUCCION_DETALLE ppd";
            sql4 += " where ppd.COD_PROGRAMA_PROD in (" + codProgramaProd + ") and ppd.cod_compprod in (" + codProductos + ") ";

            sql4 = "select DISTINCT PPRD.COD_MATERIAL, M.NOMBRE_MATERIAL from PROGRAMA_PRODUCCION PPR INNER JOIN PROGRAMA_PRODUCCION_DETALLE PPRD " +
            ...
            sql_exp += " (select SUM(iade.cantidad_restante)" +
                    ...
                    " and iade.cod_estado_material in (2, 6,8) and iade.cantidad_restante > 0)as aprobados,";
            ...
            <DIV ALIGN="CENTER" CLASS="outputText2" ID="panel">
                ...
                while (rs2.next()) {
                    ...
                    System.out.println("aprobados "+aprobados +" salidas "+salidas+" devoluciones "+devoluciones+" rechazado "+rechazado+" vencido "+vencido+" obsoleto "+obsoleto+" reserva"+reserva);
                    ...
                    while (rs4.next()) {
                        ...
                        cantidadProd = cantidadProd + (rs4.getDouble(2));
                    ...
                    sql4 += " cod_material='" + codMaterial + "' and oc.FECHA_ENTREGA >= '"+sdf.format(fechaInicioEntrega)+"'  order by oc.FECHA_EMISION asc";
                    ...
                    <tr >
                        ...
                        try {
                            ...
                            sqlCompra = " SELECT  cp.nombre_prod_semiterminado, sum(ppd.CANTIDAD) CANTIDAD,count(p.CANT_LOTE_PRODUCCION) cant,tpp.nombre_tipo_programa_prod,t.nombre_tipo_material" +
                                     ...
                                     " where p.COD_PROGRAMA_PROD = '" + codProgramaProd + "'  and p.COD_ESTADO_PROGRAMA = 4 and cp.COD_COMPPROD = p.COD_COMPPROD " +
