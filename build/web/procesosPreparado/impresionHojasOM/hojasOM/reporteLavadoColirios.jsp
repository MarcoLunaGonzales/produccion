...
<div class="pagina">
    <table width="80%" align="center" class="outputText0"  cellpadding="0" cellspacing="0" >
                ...
                int cantidadFrascosFrv=0;
                int cantidadFrascosLavados=0;
                  try
                  {
                    Connection con=null;
                    ...
                    if(res.next())
                    {
                       ...
                       if(res.next())
                       {
                        ...
                        out.println("<tr ><th colspan='2' rowspan='3'><center><img src='../../../img/cofar.png'></center></th>" +
                                ...
                                " ");
                        out.println("<table width='80%' style='margin-top:1em' align='center' class='outputText0'  cellpadding='0' cellspacing='0' >" +
                        ...
                        consulta="SELECT sppp.FECHA_INICIO,sppp.FECHA_FINAL,(p.AP_PATERNO_PERSONAL+' '+p.AP_MATERNO_PERSONAL+' '+p.NOMBRES_PERSONAL) as nombresPersonal"+
                                 ...
                                 " and sppp.COD_TIPO_PROGRAMA_PROD in ("+codTipoprogramaProd+") and sppp.COD_LOTE_PRODUCCION = '"+codLoteProduccion+"'";
                        ...
                        out.println("<table width='80%' style='margin-top:0.5em' align='center' class='outputText0'  cellpadding='0' cellspacing='0' >" +
                                    "<tr>" +
                                    "<th bgcolor='#cccccc'><span class='bold'>Material<br>Recibido</span></th>" +
                                    "<th bgcolor='#cccccc'><span class='bold'>N° de Packs<br>Recibidos</span></th>" +
                        ...
                        res=st.executeQuery(consulta);
                        String tipoMaterialRecibido="";
                        while(res.next())
                        {
                            switch(res.getInt("COD_MATERIAL_OM_RECIBIDO"))
                            {
                                case 1:sumaCantFrascosRecibidos+=(res.getInt("CANTIDAD_PACKS_AMPOLLAS")*res.getInt("CANTIDAD_AMPOLLAS_PACK"));
                                       tipoMaterialRecibido="Frascos";
                                       break;
                                case 2:sumaCantTapasRecibidas+=(res.getInt("CANTIDAD_PACKS_AMPOLLAS")*res.getInt("CANTIDAD_AMPOLLAS_PACK"));
                                       tipoMaterialRecibido="Tapas";
                                       break;
                                case 3:sumaCantTaponesRecibidos+=(res.getInt("CANTIDAD_PACKS_AMPOLLAS")*res.getInt("CANTIDAD_AMPOLLAS_PACK"));
                                       tipoMaterialRecibido="Tapones";
                                       break;
                                default:break;
                            }
                            out.println("<tr>" +
                                        "<th><span class='normal'>"+tipoMaterialRecibido+"</span></th>" +
                                        "<th><span class='normal'>"+res.getInt("CANTIDAD_PACKS_AMPOLLAS")+"</span></th>" +
                        ...
                        out.println("</table></th></tr></table>" +
                                    ...
                                    "<th bgcolor='#cccccc'><span class='bold'>N° de <br>Frascos<br>Lavado<br>bandeja</span></th>" +
                                    "<th bgcolor='#cccccc'><span class='bold'>N° de<br>bandejas</span></th>" +
                                    "<th bgcolor='#cccccc'><span class='bold'>N° de <br>Frascos<br>Totales</span></th>" +
                                    "<th bgcolor='#cccccc'><span class='bold'>N° de <br>Frascos<br>a Frv</span></th>" +
                        ...
                        consulta="SELECT sall.COD_REGISTRO_ORDEN_MANUFACTURA,sall.CANTIDAD_AMPOLLAS_BANDEJAS,sall.CANTIDAD_AMPOLLAS_ROTAS,"+
                                 " sall.CANTIDAD_BANDEJAS,sppp.FECHA_INICIO,sppp.FECHA_FINAL,(p.AP_PATERNO_PERSONAL+' '+p.AP_MATERNO_PERSONAL+' '+p.NOMBRES_PERSONAL)as nombrePErsonal"+
                                 ...
                                 " inner join PERSONAL p on p.COD_PERSONAL=sall.COD_PERSONAL_OBRERO"+
                        ...
                        while(res.next())
                        {
                                out.println("<tr><th><span class='normal'>"+res.getRow()+"</span></th>" +
                                             ...
                                             "</tr>");
                                cantidadFrascosLavados+=(res.getInt("CANTIDAD_BANDEJAS")*res.getInt("CANTIDAD_AMPOLLAS_BANDEJAS"));
                                cantidadFrascosFrv+=(res.getInt("CANTIDAD_AMPOLLAS_ROTAS"));
                         }

                        out.println("</table></th></tr></table></div><div class='pagina'><table width='80%' align='center' class='outputText0'  cellpadding='0' cellspacing='0' ><tr><th class='ultCol ultFil' align='left'>" +
                                    ...
                                    "<tr><th align='left' style='border:none'><span class='normal'>Cantidad de frascos recibidos</span></th><th style='border:none'>&nbsp&nbsp&nbsp&nbsp</th><th align='left' style='border-bottom:none'><span class='normal'>"+sumaCantFrascosRecibidos+"</span></th></tr>" +
                                    "<tr><th align='left' style='border:none'><span class='normal'>Cantidad de tapas recibidas</span></th><th style='border:none'>&nbsp&nbsp&nbsp&nbsp</th><th align='left' style='border-bottom:none'><span class='normal'>"+sumaCantTapasRecibidas+"</span></th></tr>" +
                                    "<tr><th align='left' style='border:none'><span class='normal'>Cantidad de tapones recibidos</span></th><th style='border:none'>&nbsp&nbsp&nbsp&nbsp</th><th align='left' style='border-bottom:none'><span class='normal'>"+sumaCantTaponesRecibidos+"</span></th></tr>" +
                                    "<tr><th align='left' style='border:none'><span class='normal'>Cantidad de frascos lavados</span></th><th style='border:none'>&nbsp&nbsp&nbsp&nbsp</th><th align='left' style='border-bottom:none'><span class='normal'>"+cantidadFrascosLavados+"</span></th></tr>" +
                                    "<tr><th align='left' style='border:none'><span class='normal'>Cantidad de Frascos frv</span></th><th style='border:none'>&nbsp&nbsp&nbsp&nbsp</th><th align='left' style='border-bottom:none'><span class='normal'>"+cantidadFrascosFrv+"</span></th></tr>" +
                                    "<tr><th align='left' style='border-right:none'><span class='normal'>Rendimiento Final</span></th><th style='border-right:none'>&nbsp&nbsp&nbsp&nbsp</th><th align='left'><span class='normal'>"+(cantidadFrascosLavados>0?(Math.rint(((Double.valueOf(cantidadFrascosLavados)-cantidadFrascosFrv)/cantidadAmpollasRecibidas)*10000d)/100d):"No se lavaron frascos")+"</span></th></tr></table>");
