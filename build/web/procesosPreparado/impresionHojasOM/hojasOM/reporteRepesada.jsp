                ...
                String observacion="";
                  try
                  {
                    ...
                    String consulta="select pp.cod_formula_maestra,f.cod_forma,pp.COD_FORMULA_MAESTRA,cp.COD_COMPPROD,f.abreviatura_forma,p.nombre_prod,cp.NOMBRE_GENERICO,f.nombre_forma,cp.REG_SANITARIO,"+
                                    ...
                                    " ,srl.COD_SEGUIMIENTO_REPESADA_LOTE,srl.FECHA_CIERRE"+
                                    ...
                                    " inner join SEGUIMIENTO_REPESADA_LOTE srl on srl.COD_PROGRAMA_PROD=pp.COD_PROGRAMA_PROD"+
                    ...
                    if(res.next())
                    {
                        ...
                        codSeguimiento=res.getInt("COD_SEGUIMIENTO_REPESADA_LOTE");
                       ...
                       if(res.next())
                       {
                        ...
                        out.println("<tr ><th colspan='2' rowspan='3'><center><img src='../../../img/cofar.png'></center></th>" +
                                ...
                                "<th  align='center'><input type='text' size='3' value='2' style='text-align:center;border:none;background-color:#ffffff'></th>" +
                                ...
                                "</tr>" +
                                "<tr>" +
                                "<th colspan='3'  align='center' rowspan='2'><span class='bold'><b>ORDEN DE REPESADA</b></span></th>" +
                                ...
                                "<tr><th bgcolor='#cccccc' colspan='9' align='center' class='ultCol'><span class='bold' style='font-size:12px;'>ORDEN DE REPESADA</span></th></tr>" +
                                "<tr><th colspan='9' align='left' class='ultCol ultFil'><span class='bold'>Condiciones Generales</span><br><br><span class='normal'>"+indicacionesRepesada+"</span>" +
                                " <table width='80%' style='margin-top:2em' align='center' class='outputText0'  cellpadding='0' cellspacing='0' >" +
                                "<tr><th bgcolor='#cccccc' colspan='2' align='center'><span class='bold'>PESADA</span></th>" +
                                "<th bgcolor='#cccccc' rowspan='2' align='center'><span class='bold'>V°B° REPESADA</span></th></tr>"+
                                "<tr><th bgcolor='#cccccc'><span class='bold'>MATERIA PRIMA</span></th>" +
                                "<th bgcolor='#cccccc' ><span class='bold'>CANTIDAD</span></th></tr>"
                                );
                        ...
                        consulta="select fmdp.COD_FORMULA_MAESTRA_FRACCIONES,um.ABREVIATURA,"+
                                    ...
                                    " srld.COD_MATERIAL=fmdp.COD_MATERIAL and srld.COD_SEGUIMIENTO_REPESADA_LOTE='"+codSeguimiento+"'"+
                        ...
                        while(res.next())
                        {
                            out.println("<tr><th><span class='normal'>"+res.getString("NOMBRE_MATERIAL")+"</span></th>" +
                                        "<th><span class='normal'>"+format.format((tamanoLote/res.getDouble("CANTIDAD_LOTE"))*res.getDouble("CANTIDAD"))+" "+res.getString("ABREVIATURA")+"</span></th>"+
                                        "<th align='center'><span class='bold'>"+(res.getInt("PESADA_CORRECTAMENTE")>0?"√":"&nbsp;")+"</span></th></tr>");
                            

                        }
                        out.println("</table>" +
                                "<br><br><span class='bold'>RESPONSABLE DE REPESADA:&nbsp;&nbsp;&nbsp;</span><span class='normal'>"+personalAprueba+"</span>" +
