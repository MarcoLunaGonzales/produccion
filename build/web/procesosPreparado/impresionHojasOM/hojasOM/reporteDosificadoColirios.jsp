                ...
                int codActividadAcomodado=0;
                  try
                  {
                    ...
                    String consulta="select pp.cod_formula_maestra,f.cod_forma,pp.COD_FORMULA_MAESTRA,cp.COD_COMPPROD,f.abreviatura_forma,p.nombre_prod,cp.NOMBRE_GENERICO,f.nombre_forma,cp.REG_SANITARIO,"+
                                    ...
                                    " ,sdl.COD_SEGUIMIENTO_DOSIFICADO_LOTE,sdl.FECHA_CIERRE"+
                                    ...
                                    " ,sdl.OBSERVACIONES,isnull(cpc.COD_RECETA_DOSIFICADO,0) as COD_RECETA_DOSIFICADO," +
                                    " (per1.AP_PATERNO_PERSONAL + ' ' + per1.AP_MATERNO_PERSONAL + ' ' + per1.NOMBRES_PERSONAL + ' ' + per1.nombre2_personal) as nombrePersonalDespeje," +
                                    " (per2.AP_PATERNO_PERSONAL + ' ' + per2.AP_MATERNO_PERSONAL + ' ' + per2.NOMBRES_PERSONAL + ' ' + per2.nombre2_personal) as nombrePersonalApruebaPeso," +
                                    "sdl.FECHA_APROBACION_SELLADO," +
                                    ...
                                    " isnull(afm2.COD_ACTIVIDAD_FORMULA, 0) as codActividadReguladoEquipo,ISNULL(cpc.ENVASADO_CON_GAS_NITROGENO,0) as ENVASADO_CON_GAS_NITROGENO"+
                                    ...
                                    " inner join SEGUIMIENTO_DOSIFICADO_LOTE sdl on sdl.COD_PROGRAMA_PROD=pp.COD_PROGRAMA_PROD"+
                                    " and sdl.COD_LOTE=pp.COD_LOTE_PRODUCCION"+
                                    " inner join personal per on per.COD_PERSONAL=sdl.COD_PERSONAL_SUPERVISOR" +
                                    " inner join personal per1 on per1.COD_PERSONAL = sdl.COD_PERSONAL_APRUEBA_DESPEJE" +
                                    " left outer join personal per2 on per2.COD_PERSONAL = sdl.COD_PERSONAL_APRUEBA_PESO" +
                                    " left outer join ACTIVIDADES_FORMULA_MAESTRA afm on afm.COD_AREA_EMPRESA ="+
                                    " 96 and afm.COD_ACTIVIDAD = 87 and afm.COD_FORMULA_MAESTRA ="+
                                    ...
                                    " 96 and afm1.COD_ACTIVIDAD = 53 and afm1.COD_FORMULA_MAESTRA ="+
                                    ...
                                    " 96 and afm2.COD_ACTIVIDAD = 271 and afm2.COD_FORMULA_MAESTRA ="+
                    ...
                    if(res.next())
                    {
                        ...
                        personalApruebaSellado=res.getString("nombrePersonalApruebaPeso");
                        fechaApruebaSellado=res.getTimestamp("FECHA_APROBACION_SELLADO");
                        ...
                        personalDespeje=res.getString("nombrePersonalDespeje");
                        observacion=res.getString("OBSERVACIONES");
                        codSeguimiento=res.getInt("COD_SEGUIMIENTO_DOSIFICADO_LOTE");
                       ...
                       if(res.next())
                       {
                        ...
                        out.println("<tr ><th colspan='2' rowspan='3'><center><img src='../../../img/cofar.png'></center></th>" +
                                ...
                                "<th  align='center'><input type='text' size='3' value='5' style='text-align:center;border:none;background-color:#ffffff'></th>" +
                                ...
                                "<span class='normal'>Realice el acomodado de frascos y registre las cantidades</span><br>" +
                                "<table width='80%' style='margin-top:0.6em' align='center' class='outputText0'  cellpadding='0' cellspacing='0' >" +
                                "<tr><th bgcolor='#cccccc' colspan='6'><span class='bold'>Acomodado y pesaje de frascos vacios</span></th></tr>" +
                                "<tr><th bgcolor='#cccccc'><span class='bold'>Personal</span></th>" +
                                "<th bgcolor='#cccccc'><span class='bold'>Cantidad</span></th>" +
                                ...
                                "</tr>");
                    consulta="select sppp.UNIDADES_PRODUCIDAS,sppp.FECHA_INICIO,sppp.FECHA_FINAL,sppp.HORAS_HOMBRE,"+
                             ...
                             " and sppp.COD_FORMULA_MAESTRA = '"+codFormulaMaestra+"' and sppp.COD_COMPPROD = '"+codCompProd+"'" +
                             " and sppp.COD_TIPO_PROGRAMA_PROD = '"+codTipoprogramaProd+"' and sppp.COD_ACTIVIDAD_PROGRAMA = '"+codActividadAcomodado+"'"+
                             " order by sppp.FECHA_INICIO";
                    System.out.println("consulta detalle cambio formato "+consulta);
                    res=st.executeQuery(consulta);
                    while(res.next())
                    {
                        out.println("<tr><th><span class='normal'>"+res.getString("nombrePersonal")+"</span></th>" +
                                    "<th><span class='normal'>"+res.getInt("UNIDADES_PRODUCIDAS")+"</span></th>" +
                       ...
                       out.println("</table><span class='normal'>"+preIndicacionesDosificado+"</span>" +
                                " <table width='80%' style='margin-top:0.6em' align='center' class='outputText0'  cellpadding='0' cellspacing='0' >");
                       ...
                       consulta="select p.COD_PERSONAL,(p.AP_PATERNO_PERSONAL+' '+p.AP_MATERNO_PERSONAL+'<br>'+p.NOMBRES_PERSONAL)as nombrePersonal"+
                                 " from SEGUIMIENTO_DOSIFICADO_LOTE_PREFILTRADO s inner join personal p on"+
                                 " p.COD_PERSONAL=s.COD_PERSONAL"+
                                 " where s.COD_SEGUIMIENTO_DOSIFICADO_LOTE='"+codSeguimiento+"'"+
                        ...
                        while(res.next())
                        {
                            innerCabeceraPersonal+="<th colspan='5' bgcolor='#cccccc' align='center'><span class='bold'>"+res.getString("nombrePersonal")+"</span></th>";
                            ...
                            detallePersonal+=" left outer join SEGUIMIENTO_DOSIFICADO_LOTE_PREFILTRADO sedl"+res.getRow()+" on"+
                                             ...
                                             " sedl"+res.getRow()+".COD_SEGUIMIENTO_DOSIFICADO_LOTE = '"+codSeguimiento+"'" +
                        ...
                        out.println("<tr><th bgcolor='#cccccc' colspan='4' align='center' ><span class='bold'>ESPECIFICACIONES</span></th>"+
                                   " <th bgcolor='#cccccc' colspan='"+(contDetalle*5)+"' align='center'><span class='bold'>CONDICIONES DEL PROCESO</span></th>"+
                                   "</tr>"+
                        ...
                        for(int i=1;i<=contDetalle;i++)out.println("<th bgcolor='#cccccc' align='center'><span class='bold'>Prueba de Integridad<br>Positivo</span></th>"+
                        ...
                        while(res.next())
                        {
                            ...
                            {
                                out.println("<th align='center'><span class='bold'>"+(res.getInt("PRUEBA_DE_INTEGRIDAD_POSITIVO"+i)==1?"√":"&nbsp;")+"</span></th>" +
                                            "<th align='center'><span class='normal'>"+res.getString("PRESION_REGISTRADA"+i)+"&nbsp;</span></th>"+
                                            "<th align='center'><span class='normal'>"+res.getString("unidadPresion")+"</span></th>"+
                                            " <th align='center'><span class='normal'>"+res.getInt("NUMERO_FILTROS_UTILIZADOS"+i)+"&nbsp;</span></th>"+
                        ...
                        out.println("</table><table width='80%' style='margin-top:0.6em' align='center' class='outputText0'  cellpadding='0' cellspacing='0' >" +
                                    ...
                                    "<th bgcolor='#cccccc'><span class='bold'>Horas<br>Hombre</span></th>" +
                                    "</tr>");
                        consulta="select sppp.FECHA_INICIO,sppp.FECHA_FINAL,sppp.HORAS_HOMBRE,"+
                                 " (p.AP_PATERNO_PERSONAL+' '+p.AP_MATERNO_PERSONAL+' '+p.NOMBRES_PERSONAL)as nombrePersonal"+
                                 " from SEGUIMIENTO_PROGRAMA_PRODUCCION_PERSONAL sppp"+
                                 " inner join PERSONAL p on p.COD_PERSONAL=sppp.COD_PERSONAL"+
                                 " where sppp.COD_LOTE_PRODUCCION = '"+codLoteProduccion+"' and sppp.COD_PROGRAMA_PROD = '"+codProgramaProd+"'" +
                                 " and sppp.COD_FORMULA_MAESTRA = '"+codFormulaMaestra+"' and sppp.COD_COMPPROD = '"+codCompProd+"'" +
                                 " and sppp.COD_TIPO_PROGRAMA_PROD = '"+codTipoprogramaProd+"' and sppp.COD_ACTIVIDAD_PROGRAMA = '"+codActividadCambioFormato+"'"+
                                 " order by sppp.FECHA_INICIO";
                        System.out.println("consulta detalle cambio formato "+consulta);
                        res=st.executeQuery(consulta);
                        while(res.next())
                        ...
                        out.println("</table></th></tr></table></div><div class='pagina'>" +
                                    ...
                                    "<tr><th class='ultCol ultFil' align='left'>" +
                                    "<table width='80%' style='margin-top:0.6em' align='center' class='outputText0'  cellpadding='0' cellspacing='0' >" +
                        ...
                        consulta="select sppp.FECHA_INICIO,sppp.FECHA_FINAL,sppp.HORAS_HOMBRE,"+
                                 ...
                                 " where sppp.COD_LOTE_PRODUCCION = '"+codLoteProduccion+"' and sppp.COD_PROGRAMA_PROD = '"+codProgramaProd+"'" +
                                 " and sppp.COD_FORMULA_MAESTRA = '"+codFormulaMaestra+"' and sppp.COD_COMPPROD = '"+codCompProd+"'" +
                                 " and sppp.COD_TIPO_PROGRAMA_PROD = '"+codTipoprogramaProd+"' and sppp.COD_ACTIVIDAD_PROGRAMA = '"+codActividadArmadoFiltros+"'"+
                                 " order by sppp.FECHA_INICIO";
                        System.out.println("consulta detalle cambio formato "+consulta);
                        res=st.executeQuery(consulta);
                        while(res.next())
                        ...
                        out.println("</table><br>" +
                                "<span class='normal'>"+indicacionesDosificado+"</span>" +(envasadoConGasNitrogeno?"<span class='bold'>"+(indicacionesAdicionalesDosificado.equals("")?"7. ENVASAR EL PRODUCTO CON GAS NITROGENO":indicacionesAdicionalesDosificado)+"</span>":"")+
                                "<table width='80%' style='margin-top:0.6em' align='center' class='outputText0'  cellpadding='0' cellspacing='0' >");
                        cabeceraPersonal="";
                        ...
                        contDetalle=0;
                        consulta="select p.COD_PERSONAL,(p.AP_PATERNO_PERSONAL+' '+p.AP_MATERNO_PERSONAL+'<br>'+p.NOMBRES_PERSONAL)as nombrePersonal"+
                                 " from SEGUIMIENTO_ESPECIFICACIONES_DOSIFICADO_LOTE s inner join personal p on"+
                                 " p.COD_PERSONAL=s.COD_PERSONAL"+
                                 " where s.COD_SEGUIMIENTO_DOSIFICADO_LOTE='"+codSeguimiento+"'"+
                                 " group by p.COD_PERSONAL,p.AP_PATERNO_PERSONAL,p.AP_MATERNO_PERSONAL,p.NOMBRES_PERSONAL"+
                                 " order by p.AP_PATERNO_PERSONAL,p.AP_MATERNO_PERSONAL,p.NOMBRES_PERSONAL";
                        ...
                        out.println("<tr><th bgcolor='#cccccc' align='center' colspan='3'><span class='bold'>ESPECIFICACIONES DE ETAPA DE DOSIFICADO</span></th>"+
                                    " <th bgcolor='#cccccc' align='center' colspan='"+(contDetalle*2)+"'><span class='bold'>CONDICCIONES DE ETAPA </span></th>"+
                        ...
                        for(int i=1;i<=contDetalle;i++)out.println("<th align='center' bgcolor='#cccccc' ><span class='bold'>Conforme</span></th><th bgcolor='#cccccc' align='center'><span class='bold'>Observación</span></th>");
                        out.println("</tr>");
                        ...
                        while(res.next())
                        {
                            ...
                            out.println("<tr><th align='center'><span class='normal'>"+res.getString("NOMBRE_ESPECIFICACIONES_PROCESO")+"</span></th>"+
                             ...
                             for(int i=1;i<=contDetalle;i++)out.println("<th align='center'><span class='normal'>"+(res.getInt("RESULTADO_ESPERADO_LOTE")==1?res.getString("valorLote"+i):(res.getInt("conforme"+i)>0?"√":"&nbsp;"))+"</span></th>"+
                                                                        "<th align='center'><span class='normal'>"+res.getString("observacion"+i)+"&nbsp;</span></th>");
                            out.println("</tr>");
                        }
                        out.println("</table><table width='80%' style='margin-top:0.6em' align='center' class='outputText0'  cellpadding='0' cellspacing='0' >" +
                         ...
                         consulta="select sppp.FECHA_INICIO,sppp.FECHA_FINAL,sppp.HORAS_HOMBRE,"+
                                 ...
                                 " where sppp.COD_LOTE_PRODUCCION = '"+codLoteProduccion+"' and sppp.COD_PROGRAMA_PROD = '"+codProgramaProd+"'" +
                                 " and sppp.COD_FORMULA_MAESTRA = '"+codFormulaMaestra+"' and sppp.COD_COMPPROD = '"+codCompProd+"'" +
                                 " and sppp.COD_TIPO_PROGRAMA_PROD = '"+codTipoprogramaProd+"' and sppp.COD_ACTIVIDAD_PROGRAMA = '"+codActividadReguladoEquipo+"'"+
                                 " order by sppp.FECHA_INICIO";
                        System.out.println("consulta detalle cambio formato "+consulta);
                        res=st.executeQuery(consulta);
                        while(res.next())
                       ...
                       out.println("</table><span class='normal'><br>"+(envasadoConGasNitrogeno?"8":"7")+".Una vez termine la dosificación de ampollas, dejar pasar 5 litros de agua purificada y realizar punto burbuja"+
                                   ...
                                   "<table width='60%' style='margin-top:0.6em' align='center' class='outputText0'  cellpadding='0' cellspacing='0' >" +
                                    ...
                                    "<th style='border-bottom:none' ><span class='normal'>"+personalApruebaSellado+"</span></th></tr>" +
                                    "<tr><th style='border-right:none'><span class='bold'>Hora</span></th>" +
                                    "<th><span class='normal'>"+sdfHoras.format(fechaApruebaSellado)+"</span></th></tr></table>" +
                       ...
                       contDetalle=0;
                        consulta="select p.COD_PERSONAL,(p.AP_PATERNO_PERSONAL+' '+p.AP_MATERNO_PERSONAL+'<br>'+p.NOMBRES_PERSONAL)as nombrePersonal"+
                                 " from SEGUIMIENTO_DOSIFICADO_LOTE_POSTFILTRADO s inner join personal p on"+
                                 " p.COD_PERSONAL=s.COD_PERSONAL_OPERARIO"+
                                 " where s.COD_SEGUIMIENTO_DOSIFICADO_LOTE='"+codSeguimiento+"'"+
                                 " group by p.COD_PERSONAL,p.AP_PATERNO_PERSONAL,p.AP_MATERNO_PERSONAL,p.NOMBRES_PERSONAL"+
                                 " order by p.AP_PATERNO_PERSONAL,p.AP_MATERNO_PERSONAL,p.NOMBRES_PERSONAL";
                        res=st.executeQuery(consulta);
                        while(res.next())
                        {
                            innerCabeceraPersonal+="<th colspan='4' bgcolor='#cccccc' align='center'><span class='bold'>"+res.getString("nombrePersonal")+"</span></th>";
                            ...
                            detallePersonal+=" left outer join SEGUIMIENTO_DOSIFICADO_LOTE_POSTFILTRADO sedl"+res.getRow()+" on"+
                                             " sedl"+res.getRow()+".COD_ESPECIFICACION_FILTRADO = fp.COD_FILTRO_PRODUCCION and "+
                                             " sedl"+res.getRow()+".COD_SEGUIMIENTO_DOSIFICADO_LOTE = '"+codSeguimiento+"'" +
                                             " and sedl"+res.getRow()+".COD_PERSONAL_OPERARIO='"+res.getInt("COD_PERSONAL")+"'";
                            contDetalle=res.getRow();
                        }
                        ...
                        for(int i=1;i<=contDetalle;i++)out.println("<th bgcolor='#cccccc' align='center'><span class='bold'>Prueba de integridad Positivo</span></th>"+
                       ...
                       while(res.next())
                       {
                            ...
                            for(int i=1;i<=contDetalle;i++)out.println("<th align='center'><span class='bold'>"+(res.getInt("PRUEBA_DE_INTEGRIDAD_POSITIVO"+i)>0?"√":"&nbsp;")+"&nbsp;</span></th>"+
                                                                        "<th colspan='2' align='center'><span class='normal'> "+res.getString("PRESION_REGISTRADA"+i)+" "+res.getString("abreviaturaPresion")+"&nbsp;</span></th>"+
                                                                        " <th align='center'><span class='normal' >"+res.getString("OBSERVACIONES"+i)+"&nbsp;</span></th>");
