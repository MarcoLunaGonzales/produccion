  var heightCabecera=0;
  var xcd=0;
  var contPro=1;
  var prorateo=0;
  var divPrin=0;
  var prorateoSubProceso=0;
  var puntos=new Array();
  var listaLetras=['a','b','c','d','e','f','g','h'];
  var contAsignador=0;
  var tamHoja=1315;//1220v
  function puntoInterupcion(posicionfY,letraf)
  {
	this.posicion=posicionfY;
	this.letra=letraf;
  ...
  function verificarInterupcion(linea)
  {
	...
	for(var i=0;i<puntos.length;i++)
	{
		...
		if(puntos[i].posicion>linea._start.shape.Y && puntos[i].posicion<linea._end.shape.Y && encontrado==false)
		{
			encontrado=true;
			if(linea._opt.vertices.length==0)
			{
				/*var x=(linea._start.shape.X+(linea._start.shape.W/2));
				var ypoint=linea._start.shape.H+linea._start.shape.Y;

				this.paper.rect(x,ypoint, 0,(puntos[i].posicion-ypoint-30),0).attr('fill','#ffffff');
				this.paper.rect(x,puntos[i].posicion+30, 0,50,0).attr('fill','#000000');
				this.paper.circle(x,(puntos[i].posicion-20),10).attr('fill','#F4A460');
				this.paper.circle(x,(puntos[i].posicion+20),10).attr('fill','#F4A460');
				this.paper.text(x,(puntos[i].posicion-18),listaLetras[contAsignador]).attr('font-weight','bold','text-anchor','start');
				this.paper.text(x,(puntos[i].posicion+22),listaLetras[contAsignador]).attr('font-weight','bold','text-anchor','start');


				var text='M'+x+','+(puntos[i].posicion-30)+'L'+(x-1)+','+(puntos[i].posicion-40)+'L'+x+','+(puntos[i].posicion-40);
				for(var j=1;j<6;j+=2)
				{
					text+='L'+(x-j)+','+(puntos[i].posicion-40)+'L'+(x-j-1)+','+(puntos[i].posicion-40)+'L'+x+','+(puntos[i].posicion-30);
					text+='L'+(x+j)+','+(puntos[i].posicion-40)+'L'+(x+j+1)+','+(puntos[i].posicion-40)+'L'+x+','+(puntos[i].posicion-30);
				}
				this.paper.path(text);*/
				var ini=linea._start.shape;
				var fin=linea._end.shape;
				var coorY=(ini.Y+ini.H);
				var coorX=(ini.X+(ini.W/2));
				for(var j=i;j<puntos.length;j++)
				{
					if(puntos[j].posicion<fin.Y)
					{
						this.paper.rect(coorX,coorY, 0,(puntos[j].posicion-coorY-30),0).attr('fill','#000000');
						this.paper.circle(coorX,(puntos[j].posicion-20),10).attr('fill','#F4A460');
						this.paper.circle(coorX,(puntos[j].posicion+20),10).attr('fill','#F4A460');
						this.paper.text(coorX,(puntos[j].posicion-18),listaLetras[contAsignador]).attr('font-weight','bold','text-anchor','start');
						this.paper.text(coorX,(puntos[j].posicion+22),listaLetras[contAsignador]).attr('font-weight','bold','text-anchor','start');
						coorY=puntos[j].posicion+30;
						var text='M'+coorX+','+(puntos[j].posicion-30)+'L'+(coorX-1)+','+(puntos[j].posicion-40)+'L'+coorX+','+(puntos[j].posicion-40);
						for(var k=1;k<6;k+=2)
						{
							text+='L'+(coorX-k)+','+(puntos[j].posicion-40)+'L'+(coorX-k-1)+','+(puntos[j].posicion-40)+'L'+coorX+','+(puntos[j].posicion-30);
							text+='L'+(coorX+k)+','+(puntos[j].posicion-40)+'L'+(coorX+k+1)+','+(puntos[j].posicion-40)+'L'+coorX+','+(puntos[j].posicion-30);
						}
						this.paper.path(text);
					}
				}
				this.paper.rect(coorX,coorY, 0,(fin.Y-coorY),0).attr('fill','#000000');

			}
			if(linea._opt.vertices.length==2)
			{
				var ini=linea._start.shape;
				var fin=linea._end.shape;
				var nodo1=linea._opt.vertices[0];
				var nodo2=linea._opt.vertices[1];
				this.paper.rect(nodo1.x,nodo1.y,(ini.X-nodo1.x),0,0).attr('fill','#ffffff');
				this.paper.rect(nodo2.x,nodo2.y,(fin.X-nodo2.x),0,0).attr('fill','#ffffff');
				var coorY=nodo1.y;
				for(var j=i;j<puntos.length;j++)
				{
					if(puntos[j].posicion<fin.Y)
					{
						this.paper.rect(nodo1.x,coorY, 0,(puntos[j].posicion-coorY-30),0).attr('fill','#000000');
						this.paper.circle(nodo1.x,(puntos[j].posicion-20),10).attr('fill','#F4A460');
						this.paper.circle(nodo1.x,(puntos[j].posicion+20),10).attr('fill','#F4A460');
						this.paper.text(nodo1.x,(puntos[j].posicion-18),listaLetras[contAsignador]).attr('font-weight','bold','text-anchor','start');
						this.paper.text(nodo1.x,(puntos[j].posicion+22),listaLetras[contAsignador]).attr('font-weight','bold','text-anchor','start');
						coorY=puntos[j].posicion+30;
						var text='M'+nodo1.x+','+(puntos[j].posicion-30)+'L'+(nodo1.x-1)+','+(puntos[j].posicion-40)+'L'+nodo1.x+','+(puntos[j].posicion-40);
						for(var k=1;k<6;k+=2)
						{
							text+='L'+(nodo1.x-k)+','+(puntos[j].posicion-40)+'L'+(nodo1.x-k-1)+','+(puntos[j].posicion-40)+'L'+nodo1.x+','+(puntos[j].posicion-30);
							text+='L'+(nodo1.x+k)+','+(puntos[j].posicion-40)+'L'+(nodo1.x+k+1)+','+(puntos[j].posicion-40)+'L'+nodo1.x+','+(puntos[j].posicion-30);
						}
						this.paper.path(text);
					}
				}
				this.paper.rect(nodo1.x,coorY, 0,(nodo2.y-coorY),0).attr('fill','#000000');
			}
			if(linea._opt.vertices.length==1)
			{
				var ini=linea._start.shape;
				var fin=linea._end.shape;
				var nodo1=linea._opt.vertices[0];
				if(nodo1.x==(ini.X+(ini.W/2)))
				{

				this.paper.rect(nodo1.x,nodo1.y,(fin.X-nodo1.x),0,0).attr('fill','#ffffff');
				var coorY=(ini.Y+ini.H);
				...
				this.paper.rect(nodo1.x,coorY, 0,(nodo1.y-coorY),0).attr('fill','#000000');
				...
				else
				{
					...
					this.paper.rect(nodo1.x,coorY, 0,(fin.Y-coorY),0).attr('fill','#000000');
   ...
   function asignarCabecera()
   {

		/*heightCabecera=parseInt(document.getElementById('cabeceraLote').offsetHeight);
		*/
		divPrin=document.getElementById('diagrama');
		//tamaño de margen=+119
		heightCabecera=0;
    }
   function asignarPuntos(linea)
   {
		...
		linea._opt.vertices[0]._isPoint=false;
   ...
   function crunch2(linea)
   {
        ...
        var start=linea._start.shape;
        var inc=(start.H/10);
        linea._opt.vertices[0]=fd((end.X+(end.W/2)),(start.Y+(inc*8)));
		//linea.update();
        //start.Y=start.Y-(inc*2);
        linea.drawCrunch(["connection","startCap","endCap","handleStart","handleEnd","label"],start.X,(start.Y+(inc*8)),2);
...
function mostrarSeguimiento()
            {
                ...
                document.getElementById('conforme').checked=(procesoActual.properties.conforme=='1');
				document.getElementById('noconforme').checked=(procesoActual.properties.conforme!='1');
 ...
 */Raphael=function(){
    ...
    function t(c,j,p){
		...
		clean2:function()
		{
		this.clean(["connection"]);return this
		},
		redraw:function(){
        ...
        draw:function(c){
            var j=this.jointLocation({
                ...
                },this._opt.vertices),p=this.connectionPathCommands(j.start.connection,j.end.connection,this._opt.vertices,this._opt.beSmooth),
		...
		endCapCrunchs:function(tr,cr){
            var c=this.opt.arrow.end; c=this.paper.path(c.path.join(" ")).attr(c.attrs);
			//c.translate(this.jointLocation.end.translate.x,this.jointLocation.end.translate.y);
			c.translate(tr,cr);
			c.rotate(this.jointLocation.end.rotate);c.show();return c
            }
        };F.prototype={
        constructor:F,
        _isPoint:true,
    ...
    var t=D.Joint;D=t.dia.Element;var F=t.point,g=t.dia.uml={};t.arrows.aggregation=function(){
        ...
        init:function(i){
            ...
            this.getOperariosRegistrados(this);
			},
        calcular:function(v){
			...
			if(parseInt(v.codSubProceso)>0)
			{
				...
				contmenos++;
				v.rect.y+=contador*110;
				//v.rect.y+=prorateo;
			}
			else
			{
				v.rect.y+=(contador-(parseInt(v.codProcesos)==parseInt(codProceso)?contmenos:0))*110;
				v.rect.y-=prorateoSubProceso;
				contmenos=0;
				codProceso='';
				prorateoSubProceso=0;
			...
			//v.rect.height+=60;
            cont=3,
            v.rect.height+=v.labelOffsetY+90,
            v.rect.x-=(v.rect.width/2);

            console.log(v.rect.y+' '+(v.rect.y+v.rect.height));
			if((v.rect.y+v.rect.height)>((contPro*tamHoja)+-80))
			{
                //console.log(v.rect.y+v.rect.height);
				if(parseInt(v.codSubProceso)>0)
				{
					prorateoSubProceso+=(((contPro*tamHoja)+((contPro-1)*heightCabecera))+80)-(v.rect.y);
				}


				prorateo+=(((contPro*tamHoja)+((contPro-1)*heightCabecera))+80)-(v.rect.y);
				puntos[puntos.length]=new puntoInterupcion((contPro*tamHoja),listaLetras[contAsignador]);
				v.rect.y=((contPro*tamHoja)+((contPro-1)*heightCabecera))+80;//(contPro*tamHoja);
				console.log(v.rect.y+' '+prorateo);
				contPro++;

			}
			divPrin.style.height=v.rect.y+v.rect.height;
			paper.canvas.style.height=v.rect.y+v.rect.height;
			paper.setSize(1000,(v.rect.y+v.rect.height));
			//var t =Joint;
			//paper=Joint.paper('diagrama',11,10);
			contador++;
        },
        ...
        getOperariosRegistrados:function(g)
        {
            var n=this.properties;
            var i=this.properties;
                s=this.wrapper.getBBox();i=this.paper.text(s.x+i.actionsOffsetX,s.y+i.labelOffsetY+i.labelHeight+i.actionsOffsetY+n.coorYText,"OPERARIOS:");
                k=i.getBBox();i.attr(n.textBold);i.translate(0,k.height/2);
				n.coorYText+=k.height;
				g.addInner(i);
			i=this.properties;
			var k='';
            k+='-'+i.personal1+"\n"+(i.personal2!=''?'-'+i.personal2+'\n':'');
            k=k.replace(/^\s\s*/,"").replace(/\s\s*$/,"");
            s=this.wrapper.getBBox();i=this.paper.text(s.x+i.actionsOffsetX,s.y+i.labelOffsetY+i.labelHeight+i.actionsOffsetY+n.coorYText,k);
            k=i.getBBox();i.attr(n.textNormal);i.translate(0,k.height/2);
            n.coorYText+=k.height;
            g.addInner(i);
            i=this.properties;
			s=this.wrapper.getBBox();i=this.paper.text(s.x+i.actionsOffsetX,s.y+i.labelOffsetY+i.labelHeight+i.actionsOffsetY+n.coorYText,'CONFORME:'+(i.conforme>0?'SI':'NO'));
            k=i.getBBox();i.attr(n.textBold);i.translate(0,k.height/2);
            n.coorYText+=k.height;
            g.addInner(i);
            i=this.properties;
            ...
            g.addInner(i);
            i=this.properties;
			s=this.wrapper.getBBox();i=this.paper.text(s.x+i.actionsOffsetX,s.y+i.labelOffsetY+i.labelHeight+i.actionsOffsetY+n.coorYText,(i.observacion));
            k=i.getBBox();i.attr(n.textNormal);i.translate(0,k.height/2);
            g.addInner(i);
        ...
        getPersonal:function(g){
			...
			g.addInner(i);
			i=this.properties;
			g.addInner(this.paper.rect(s.x+i.actionsOffsetX,s.y+i.labelOffsetY+i.labelHeight+i.actionsOffsetY+n.coorYText,(i.rect.width-(i.actionsOffsetX*2)),16,i.radius).attr('fill','white'));
			g.addInner(this.paper.rect(s.x+i.actionsOffsetX,s.y+i.labelOffsetY+i.labelHeight+i.actionsOffsetY+n.coorYText+18,(i.rect.width-(i.actionsOffsetX*2)),16,i.radius).attr('fill','white'));
            s=this.wrapper.getBBox();i=this.paper.text(s.x+i.actionsOffsetX,s.y+i.labelOffsetY+i.labelHeight+i.actionsOffsetY+n.coorYText+40,'CONFORME:');
            k=i.getBBox();i.attr(n.textBold);i.translate(0,k.height/2);
			var cd=k.width;
			g.addInner(i);
			i=this.properties;
			s=this.wrapper.getBBox();i=this.paper.text(s.x+i.actionsOffsetX,s.y+i.labelOffsetY+i.labelHeight+i.actionsOffsetY+n.coorYText+57,'NO CONFORME:');
            k=i.getBBox();i.attr(n.textBold);i.translate(0,k.height/2);
			cd=((k.width>cd)?k.width:cd);
			g.addInner(i);
			i=this.properties;
			g.addInner(this.paper.rect(s.x+i.actionsOffsetX+cd+5,s.y+i.labelOffsetY+i.labelHeight+i.actionsOffsetY+n.coorYText+39,12,12,0).attr('fill','white'));
			g.addInner(this.paper.rect(s.x+i.actionsOffsetX+cd+5,s.y+i.labelOffsetY+i.labelHeight+i.actionsOffsetY+n.coorYText+56,12,12,0).attr('fill','white'));
        },
