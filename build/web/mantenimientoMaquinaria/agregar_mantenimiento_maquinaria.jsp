        ...
        <body>
            <h:form id="form1">
                ...
                <div align="center">
                    ...
                    <h:outputText styleClass="outputTextTitulo"  value="Registrar Mantenimiento Maquinaria" />                    
                    <br><br>
                    ...
                    <br>
                    <h:commandButton value="Guardar" styleClass="btn"  action="#{ManagedMantenimientoMaquina.guardarMantenimientoMaquina_action}"   onclick="return validar();" />
                    <h:commandButton value="Cancelar" styleClass="btn"   action="#{ManagedMantenimientoMaquina.cancelarAgregarMantenimientoMaquina_action}"/>
