...
sql+=" from CADENAS_AGENCIA ca,clientes cl";
sql+=" where ca.COD_CADENACLIENTE = cl.cod_cadenacliente and ca.COD_ESTADO_REGISTRO = 1 and ca.cod_area_empresa = "+codAreaEmpresa;
sql+=" and cl.cod_tipocliente in ("+codTipoCliente+") group by ca.COD_CADENACLIENTE";
