            ...
            <div class="large-12 medium-12 small-12 large-centered medium-centered small-centered columns" >
                        ...
                        <div class="row">
                            <div class="large-12 medium-12 small-12 large-centered medium-centered small-centered columns">
                              ...
                              <%
                              consulta=" select ISNULL(p.COD_PERSONAL,pt.COD_PERSONAL) as COD_PERSONAL,"+
                                       " isnull((P.AP_PATERNO_PERSONAL + ' ' + P.AP_MATERNO_PERSONAL + ' ' +"+
                                       " P.NOMBRES_PERSONAL + ' ' + P.nombre2_personal),"+
                                       " (PT.AP_PATERNO_PERSONAL + ' ' + PT.AP_MATERNO_PERSONAL + ' ' +"+
                                       " PT.NOMBRES_PERSONAL + ' ' + PT.nombre2_personal))"+
                                       "  AS NOMBRES_PERSONAL"+
                                       " from  PERSONAL_AREA_PRODUCCION pa left outer join personal p on"+
                                       " p.COD_PERSONAL=pa.COD_PERSONAL"+
                                       " left outer join PERSONAL_TEMPORAL pt on pt.COD_PERSONAL=pa.COD_PERSONAL"+
                                       " where pa.cod_area_empresa in (81) and pa.COD_ESTADO_PERSONAL_AREA_PRODUCCION=1 ORDER BY 2";
                                ...
                                consulta="SELECT tm.COD_TAREA_OM,tm.NOMBRE_TAREA_OM,tareas.COD_PERSONAL,tareas.nombrePersonal,"+
                                         " isnull(tom.COD_PERSONAL, 0) as registrado"+
                                         " FROM TAREAS_OM tm OUTER APPLY"+
                                         " (SELECT p.COD_PERSONAL,(P.AP_PATERNO_PERSONAL+' '+P.AP_MATERNO_PERSONAL+' '+P.NOMBRES_PERSONAL+' '+P.nombre2_personal) AS nombrePersonal FROM PERSONAL P where p.COD_PERSONAL in ("+(personal.equals("")?"-1,-2":personal)+")"+
                                          " union select pt.COD_PERSONAL,(pt.AP_PATERNO_PERSONAL+' '+pt.AP_MATERNO_PERSONAL+' '+pt.NOMBRES_PERSONAL+' '+pt.nombre2_personal) AS nombrePersonal from PERSONAL_TEMPORAL pt where pt.COD_PERSONAL in ("+(personal.equals("")?"-1,-2":personal)+")"+
                                         " ) as tareas"+
                                         " left outer join TAREAS_OM_PERSONAL_LOTE tom on tom.COD_PERSONAL ="+
                                         " tareas.COD_PERSONAL and tm.COD_TAREA_OM = tom.COD_TAREA_OM and tom.COD_LOTE ="+
                                         " '"+codLote+"' and tom.COD_PROGRAMA_PROD = '"+codprogramaProd+"'"+
                                         " where tm.COD_FORMA in (0, "+codForma+") and tm.cod_seccion = 0"+
                                         " order by tm.ORDEN,tareas.nombrePersonal";
                                /*consulta="SELECT tm.COD_TAREA_OM,tm.NOMBRE_TAREA_OM,p.COD_PERSONAL,"+
                                        ...
                                        " where tm.COD_FORMA in (0,"+codForma+") and tm.cod_seccion=0 and p.COD_PERSONAL in ("+(personal.equals("")?"-1,-2":personal)+")"+
