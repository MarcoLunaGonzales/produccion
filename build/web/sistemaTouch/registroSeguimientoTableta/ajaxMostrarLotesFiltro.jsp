...
try
{
    ...
    String consulta="select pp.COD_PROGRAMA_PROD,cp.COD_COMPPROD,cp.nombre_prod_semiterminado,pp.COD_LOTE_PRODUCCION,"+
                       ...
                       " ,ISNULL(toml11.COD_PERSONAL, 0) as permisoGrafado")+
                       ", cp.COD_FORMA"+
                       ...
                       "  and toml3.COD_TAREA_OM in (3, 4,17,18) and toml3.COD_PERSONAL = '"+codPersonal+"' ) as tareaLavado"+
                       ...
                       " and toml6.COD_TAREA_OM in (7,8,9,10,33) and toml6.COD_PERSONAL = '"+codPersonal+"' ) tareaDosificado"+
                       ...
                       " LEFT OUTER JOIN TAREAS_OM_PERSONAL_LOTE toml11 on toml11.COD_LOTE ="+
                       " pp.COD_LOTE_PRODUCCION and toml11.COD_PROGRAMA_PROD = pp.COD_PROGRAMA_PROD"+
                       " and toml11.COD_TAREA_OM in (19) and toml11.COD_PERSONAL = '"+codPersonal+"'")+
                       " where pp.COD_ESTADO_PROGRAMA in (2,5,6,7) and cp.COD_FORMA in (2,25,27) and ppp.COD_PROGRAMA_PROD>=183"+
    ...
    boolean[] permisos=new boolean[11];
    int codForma=0;
    ...
    while(res.next())
    {
        ...
        if(!codLoteCabecera.equals(res.getString("COD_LOTE_PRODUCCION")+" "+res.getString("COD_PROGRAMA_PROD")))
        {
            if(!codLoteCabecera.equals(""))
            {
                ...
                innerHTML+="<tr>" +
                        ...
                        "<td class='tableCell' style='width:10%;align-items:center;' ><center>"+(permisos[0]?"<a onclick=\"openPopup('registroLimpiezaAmbientes/registroLimpiezaAmbientes.jsf?codComprod="+codComprod+"&codLote="+codLote+"&codAreaEmpresa="+codAreaEmpresa+"&cod_prog="+codProgramaProdLista+"&codPersonal="+codPersonal+"')\"><img src='../../img/limpieza.gif' alt='Limpieza'></a>":"")+"<center></td>"+
                        "<td class='tableCell' style='width:10%;align-items:center;' ><center>"+(administrador?"<a onclick=\"openPopup('registroRepesada/registroRepesada.jsf?codComprod="+codComprod+"&codLote="+codLote+"&codAreaEmpresa="+codAreaEmpresa+"&cod_prog="+codProgramaProdLista+"&codPersonal="+codPersonal+"')\"><img src='../reponse/img/repesada.jpg' alt='Repesada'></a>":"")+"<center></td>"+
                        "<td class='tableCell' style='width:10%;align-items:center;' ><center>"+(permisos[2]?"<a onclick=\"registroOM(3,"+codForma+","+codComprod+",'"+codLote+"',"+codAreaEmpresa+","+codProgramaProdLista+","+codPersonal+")\"><img src='../../img/lavado.gif' alt='Seguimiento Lavado'></a>":"")+"<center></td>"+
                        "<td class='tableCell' style='width:10%;align-items:center;' ><center>"+((permisos[3]&&codForma==2)?"<a onclick=\"openPopup('registroDespirogenizado/registroDespirogenizado.jsf??codComprod="+codComprod+"&codLote="+codLote+"&codAreaEmpresa="+codAreaEmpresa+"&cod_prog="+codProgramaProdLista+"&codPersonal="+codPersonal+"')\"><img src='../../img/despirogenizado.gif' alt='Seguimiento Preparado'></a>":"")+"<center></td>"+
                        "<td class='tableCell' style='width:10%;align-items:center;' ><center>"+(permisos[4]?"<a onclick=\"openPopup('seguimientoProcesos.jsf?codComprod="+codComprod+"&codLote="+codLote+"&codAreaEmpresa="+codAreaEmpresa+"&cod_prog="+codProgramaProdLista+"&codPersonal="+codPersonal+"')\"><img src='../reponse/img/preparado.jpg' alt='Seguimiento Preparado'></a>":"")+"<center></td>" +
                        ...
                        "<td class='tableCell' style='width:10%;align-items:center;' ><center>"+((permisos[10]&&codForma==25)?"<a onclick=\"registroOM(13,"+codForma+","+codComprod+",'"+codLote+"',"+codAreaEmpresa+","+codProgramaProdLista+","+codPersonal+")\"><img src='../../img/grafado.gif' alt='Dosificado'></a>":"")+"<center></td>" +
                        //"<td class='tableCell' style='width:10%;align-items:center;' ><center><a onclick=\"openPopup('registroDespejeLinea/registroDespejeLinea.jsf?codComprod="+codComprod+"&codLote="+codLote+"&codAreaEmpresa="+codAreaEmpresa+"&cod_prog="+codProgramaProdLista+"')\"><img src='../../img/despeje.gif' alt='Despeje de Linea'></a><center></td>" +
                        "<td class='tableCell' style='width:10%;align-items:center;' ><center>"+(permisos[6]?"<a onclick=\"registroOM(7,"+codForma+","+codComprod+",'"+codLote+"',"+codAreaEmpresa+","+codProgramaProdLista+","+codPersonal+")\"><img src='../../img/controllenado.gif' alt='Control Llenado Volumen'></a>":"")+"<center></td>" +
                        "<td class='tableCell' style='width:10%;align-items:center;' ><center>"+(permisos[7]?"<a onclick=\"registroOM(8,"+codForma+","+codComprod+",'"+codLote+"',"+codAreaEmpresa+","+codProgramaProdLista+","+codPersonal+")\"><img src='../../img/controlDosificado.gif' alt='Control Dosificado'></a>":"")+"<center></td>" +
                        "<td class='tableCell' style='width:10%;align-items:center;' ><center>"+(codRecetaCalorHUmedo>0&&permisos[9]?" <a onclick=\"openPopup('registroEsterilizacionCalorHumedo/registroEsterilizacionCalorHumedo.jsf?codComprod="+codComprod+"&codLote="+codLote+"&codAreaEmpresa="+codAreaEmpresa+"&cod_prog="+codProgramaProdLista+"&codPersonal="+codPersonal+"')\"><img src='../../img/esterilizacion.gif' alt='Esterilizacion Calor Humedo'></a>":"")+"<center></td>" +
                        "<td class='tableCell' style='width:10%;align-items:center;' ><center>"+(permisos[8]?"<a onclick=\"registroOM(10,"+codForma+","+codComprod+",'"+codLote+"',"+codAreaEmpresa+","+codProgramaProdLista+","+codPersonal+")\"><img src='../../img/rendimiento.gif' alt='Rendimiento Dosificado'></a>":"")+"<center></td>"+
                        "<td class='tableCell' style='width:10%;align-items:center;' ><center>"+(administrador?"<a onclick=\"registroOM(12,"+codForma+","+codComprod+",'"+codLote+"',"+codAreaEmpresa+","+codProgramaProdLista+","+codPersonal+")\"><img src='../../img/rendimiento.gif' alt='Rendimiento Dosificado'></a>":"")+"<center></td>" +
                        "</tr>";
        ...
        else
        {
            ...
            permisos[10]=(res.getInt("permisoGrafado")!=0);
       }
        /*for(int i=0;i<9;i++)
        {
    ...
    out.println("<table id='tablaLotesProcesar' cellpadding='0px' cellspacing='0px' style='width:100%'>"+
                ...
                " <td class='tableHeaderClass' style='width:10%'><span class='textHeaderClass'>Lavado</span></td>"+
                ...
                " <td class='tableHeaderClass' style='width:10%'><span class='textHeaderClass'>Grafado de Frascos</span></td>"+
