                        ...
                        <div class="row">
                            <div class="large-10 medium-10 small-12 large-centered medium-centered small-centered columns">
                                ...
                                <table style="width:100%;margin-top:2%" id="dataCantidades" cellpadding="0px" cellspacing="0px">
                                            <tr>
                                                   <td class="tableHeaderClass"  style="text-align:left" >
                                                       <span class="textHeaderClass">CANTIDAD DE FRASCOS</span>
                                                   </td>
                                                   <td class="tableHeaderClass" style="text-align:center;">
                              ...
                              <%
                                ...
                                res=st.executeQuery(consulta);
                                if(res.next())cantidadFrascosRecibidos=res.getInt("cantidadPacks");
                              ...
                              <tr >
                                           <td class="tableCell" style="text-align:left">
                                               <span class="textHeaderClassBody" style="font-weight:normal">FRASCOS ENVASADOS PARA ACONDICIONAMIENTO</span>
                                           </td>
                                           <td class="tableCell" style="text-align:center;">
                                    ...
                                    <tr >
                                           <td class="tableCell" style="text-align:left">
                                               <span class="textHeaderClassBody" style="font-weight:normal">FRASCOS PARA CONTROL DE CALIDAD </span><%--(ANALISIS MICROBIOLOGICO,ANALISIS PROD TER)--%>
                                           </td>
                                           <td class="tableCell" style="text-align:center;">
                                    ...
                                    <tr >
                                           <td class="tableCell" style="text-align:left">
                                               <span class="textHeaderClassBody" style="font-weight:normal">FRASCOS PARA CONTROL DE VOLUMEN</span>
                                           </td>
                                           <td class="tableCell" style="text-align:center;">
                                    ...
                                    <tr >
                                           <td class="tableCell" style="text-align:left">
                                               <span class="textHeaderClassBody" style="font-weight:normal"><%=(cantidadAmpollasLavadas>0?"LAVADAS":"FRASCOS RECIBIDOS")%></span>
                                           </td>
                                           <td class="tableCell" style="text-align:center;">
                                               <span class="textHeaderClassBody" style="font-weight:normal"><%=(cantidadAmpollasLavadas>0?cantidadAmpollasLavadas:cantidadFrascosRecibidos)%></span>
                                           </td>
                                    </tr>
                              </table>
                                       ...
                                       <tr>
                                               ...
                                               <td class="tableCell" style="text-align:center;width:30%">
                                                   <span class="textHeaderClassBody" id="spanRendimiento" style="font-weight:normal">
                                                       <%=((cantidadAmpollasLavadas>0||cantidadFrascosRecibidos>0)?Math.round(Double.valueOf(cantidadAcond-cantidadCC)/Double.valueOf((cantidadAmpollasLavadas>0?cantidadAmpollasLavadas:cantidadFrascosRecibidos))*10000)/100d:0)%>
                                                   </span>
                                               </td>
                                               <td class="tableHeaderClass"  style="text-align:left" >
