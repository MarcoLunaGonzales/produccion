...
<script type="text/javascript">
    ...
    function guardarAmpollasTurno(turno)
    {
        ...
        for(var i=2;i<tablaAmpollas.rows.length;i++)
        {
            if(validarHoraRegistro(tablaAmpollas.rows[i].cells[0].getElementsByTagName('input')[0])
                &&validarSeleccionRegistro(tablaAmpollas.rows[i].cells[7].getElementsByTagName('select')[0]))
            {
                    ...
                    for(var j=1;j<=6;j++)
                    {
                          ...
                          {
                              dataAmpollas[cont]=tablaAmpollas.rows[i].cells[j].getElementsByTagName('input')[0].value;
                              cont++;
                          }
                          else
                          {
                    ...
                    dataAmpollas[cont]=tablaAmpollas.rows[i].cells[7].getElementsByTagName('select')[0].value;
                    cont++;
            }
            else
            {
        ...
        ajax.open("GET","ajaxGuardarAmpollasTurno.jsf?codLote="+codLote+"&noCache="+ Math.random()+
  ...
  <%
        ...
        out.println("<title>("+codLote+")CONTROL LLENADO VOLUMEN</title>");
        ...
        String observaciones="";
                try
                {
                    ...
                    if(res.next())
                    {
                        ...
                        cantidadColumnasRegistroLLenado=6;//res.getInt("CANTIDAD_COLUMNAS_CONTROL_LLENADO_VOLUMEN");
                                ...
                                <div class="large-12 medium-12 small-12 large-centered medium-centered small-centered columns" >
                                            ...
                                            <div class="row">
                                               <div class="large-12 medium-12 small-12 columns divHeaderClass" >
                                                       <label  class="inline">CONTROL DE LLENADO DE VOLUMEN</label>
                                                </div>
                                            </div>
                                            <div class="row" >
...
<div class="row"  style="margin-top:5px" >
            <div class="large-12 medium-12 small-12 large-centered medium-centered small-centered columns" >
                        ...
                        <div class="row">
                            <div class="large-10 medium-12 small-12 large-centered medium-centered small-centered columns" align="center">
                                <table style="width:60%;margin-top:2%;border:none" id="dataDespejeLinea" cellpadding="0px" cellspacing="0px">
                                ...
                                if(res.next())
                                    {
                                      ...
                                      <tr>
                                          <td>&nbsp;</td>
                                          <td class="tableCell" style="text-align:left;border-right:none;">
                                               <span class="textHeaderClassBody" style="font-weight:normal">Límites de aceptación</span>
                                           </td>
                                           <td class="tableCell" style="text-align:left;border-left:none;">
                                               <span class="textHeaderClassBody" style="font-weight:normal">No < <%=res.getDouble("VALOR_EXACTO")%>  &nbsp;&nbsp;&nbsp;ml</span>
                                           </td>
                                      </tr>
                                  <%
                                  }
                        ...
                        <table style="border:none;margin-top:4px;border-bottom:1px solid #a80077" id="dataMaquinariasLlenado" cellpadding="0px" cellspacing="0px">
                         ...
                         <%--div class="row">
                                  <div class="large-2 medium-6 small-12 small-centered medium-centered columns">
                                        <button class="small button succes radius buttonAction" <%=(administrador?"disabled":"")%> onclick="guardarMaquinariasLlenadoVolumen();">Guardar</button>
                                  </div>
                         </div--%>
                        ...
                        <div class="row">
                            <div class="large-12 medium-12 small-12 large-centered medium-centered small-centered columns">
                              ...
                              {
                                  cabeceraRegistros+="<td class='tableHeaderClass' style='text-align:center;'><span class='textHeaderClass'>Ampolla "+i+"</span></td>";
                              }
                              cabeceraRegistros+="<td class='tableHeaderClass'><span class='textHeaderClass'>OPERARIO</span></td></tr>";
                              String personal=UtilidadesTablet.operariosAreaProduccionAdminSelect(st, codAreaEmpresa, codPersonal, administrador);
                              int cont=0;
                              ...
                              if(administrador||permiso1ErTurno)
                              {
                                    out.println("<table style='border:none;width:100%;margin-top:4px;' id='dataPrimerTurno' class='0' cellpadding='0px' cellspacing='0px'><td></td>"+
                                                "<td class='tableHeaderClass' style='text-align:center;' colspan='6'><span class='textHeaderClass'>Volumen de Ampollas(1er Turno)</span></td></tr>"+cabeceraRegistros);
                              ...
                              if(administrador||permiso2doTurno)
                              {
                                        out.println("<table style=\"border:none;width:100%;margin-top:4px;\" id=\"dataSegundoTurno\" cellpadding=\"0px\" cellspacing=\"0px\"><tr><td></td>"+
                                                    " <td class='tableHeaderClass' style='text-align:center;' colspan=\"6\"><span class='textHeaderClass'>Volumen de Ampollas(2do Turno)</span></td>"+
                              ...
                              if(administrador||permiso3erTurno)
                              {
                                        out.println("<table style=\"border:none;width:100%;margin-top:4px\" id=\"dataTercerTurno\" cellpadding=\"0px\" cellspacing=\"0px\"><tr>"+
                                                    " <td></td><td class='tableHeaderClass' style='text-align:center;' colspan=\"6\"><span class='textHeaderClass'>Volumen de Ampollas(3er Turno)</span></td></tr>"+cabeceraRegistros);
                                        consulta="SELECT sclld.HORA_MUESTRA,ISNULL(sclld.VOLUMEN_AMPOLLA1,0) as VOLUMEN_AMPOLLA1,"+
                                                 " ISNULL(sclld.VOLUMEN_AMPOLLA2,0) as VOLUMEN_AMPOLLA2,ISNULL(sclld.VOLUMEN_AMPOLLA3,0) as VOLUMEN_AMPOLLA3,"+
                                                 " ISNULL(sclld.VOLUMEN_AMPOLLA4,0) as VOLUMEN_AMPOLLA4,ISNULL(sclld.VOLUMEN_AMPOLLA5,0) as VOLUMEN_AMPOLLA5,"+
                                                 " ISNULL(sclld.VOLUMEN_AMPOLLA6,0) as VOLUMEN_AMPOLLA6" +
    ...
    <script>loginHoja.verificarHojaCerrada('cerrado', admin,'codProgramaProd','codLoteSeguimiento',7,<%=(codEstadoHoja)%>);</script>
</html>
