...
<script type="text/javascript">
  ...
  <%
      //datos del lote
        ...
        String codSeguimientoMezclaSeco="";
        int codActividadMezclaSeco=0;
        out.println("<title>("+codLote+")Tamizado/Lubricado</title>");
        //formato numeros y fecha
        ...
        SimpleDateFormat sdfHoras=new SimpleDateFormat("HH:mm");
                try
                {
                    ...
                    String consulta="select pp.COD_COMPPROD,pp.COD_TIPO_PROGRAMA_PROD,cp.COD_FORMA,f.abreviatura_forma,"+
                                    " cp.nombre_prod_semiterminado,cp.NOMBRE_GENERICO,f.nombre_forma,cp.REG_SANITARIO,"+
                                    " ep.nombre_envaseprim,cp.VIDA_UTIL,pp.CANT_LOTE_PRODUCCION,pp.COD_FORMULA_MAESTRA,"+
                                    " ISNULL(smcl.COD_SEGUIMIENTO_MEZCLA_SECO_LOTE, 0) as COD_SEGUIMIENTO_MEZCLA_SECO_LOTE,"+
                                    " ISNULL(cp.VOLUMEN_ENVASE_PRIMARIO, '') as VOLUMEN_ENVASE_PRIMARIO,"+
                                    " ISNULL(smcl.COD_PERSONAL_SUPERVISOR, 0) AS COD_PERSONAL_SUPERVISOR, ISNULL(smcl.OBSERVACION, '') as OBSERVACION,"+
                                    " smcl.FECHA_CIERRE,smcl.COD_ESTADO_HOJA,ISNULL(dpff.PRECAUCIONES_TAMIZADO, '') as PRECAUCIONES_TAMIZADO,"+
                                    " isnull(dpff.CONDICIONES_GENERALES_TAMIZADO, '') as CONDICIONES_GENERALES_TAMIZADO, fmv.CANTIDAD_LOTE"+
                                    " from PROGRAMA_PRODUCCION pp inner join FORMULA_MAESTRA_VERSION fmv on fmv.COD_VERSION=pp.COD_FORMULA_MAESTRA_VERSION"+
                                    ...
                                    " left outer join SEGUIMIENTO_MEZCLA_SECO_LOTE smcl on smcl.COD_LOTE ="+
                                    " pp.COD_LOTE_PRODUCCION and smcl.COD_PROGRAMA_PROD = pp.COD_PROGRAMA_PROD"+
                                    " left outer join DESCRIPCION_PROCESOS_FORMA_FARMACEUTICA dpff on dpff.COD_FORMA = cp.COD_FORMA"+
                                    " left outer join ACTIVIDADES_FORMULA_MAESTRA afm on afm.COD_AREA_EMPRESA = 96 and afm.COD_ACTIVIDAD = 11 and afm.COD_FORMULA_MAESTRA ="+
                    ...
                    if(res.next())
                    {
                        ...
                        codSeguimientoMezclaSeco=res.getString("COD_SEGUIMIENTO_MEZCLA_SECO_LOTE");
                        cantidadProducto=res.getInt("CANT_LOTE_PRODUCCION");
                        %>
                                ...
                                <div class="large-12 medium-12 small-12 large-centered medium-centered small-centered columns" >
                                            ...
                                            <div class="row">
                                               <div class="large-12 medium-12 small-12 columns divHeaderClass" >
                                                       <label  class="inline">MEZCLA SECO</label>
                                                </div>
                                            </div>
                                            <div class="row" >
                                            ...
                                            <div  class="divContentClass large-12 medium-12 small-12 columns">
                                                   ...
                                                   <table style="width:96%;margin-top:2%" cellpadding="0px" cellspacing="0px">
                                                       ...
                                                       <tr >
                                                           ...
                                                           <td class="tableCell" style="text-align:center;">
                                                               <span class="textHeaderClassBody"><%=(cantidadProducto)%></span>
                                                           </td>
                                                           <td class="tableCell" style="text-align:center">
...
<div class="row"  style="margin-top:5px" >
            ...
            <%
                ...
                if(cantidadAsociada>0)prod1[1]=prod1[1]+rendimientoAsociado;
                 consulta="select pp.COD_PROCESO_PRODUCTO,pp.OPERARIO_TIEMPO_COMPLETO,pp.descripcion,pp.TIEMPO_PROCESO,pp.COD_PROCESO_PRODUCTO,pp.NRO_PASO,ap.NOMBRE_ACTIVIDAD_PREPARADO," +
                        ...
                        " where pp.COD_COMPPROD="+codCompProd+" and pp.COD_PROCESO_ORDEN_MANUFACTURA=9 order by pp.NRO_PASO";
    ...
    <div  id="formsuper"  class="formSuper" />
        ...
        <input type="hidden" id="codSeguimientoRepesada" value="<%=(codSeguimientoMezclaSeco)%>">
