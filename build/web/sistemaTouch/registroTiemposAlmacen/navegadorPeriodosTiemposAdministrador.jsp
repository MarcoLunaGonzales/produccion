    ...
    <html>
        ...
        <body>
         ...
         <center><img src="../reponse/img/load3.GIF"  style="z-index:6; "><%--margin-top:2%;position:fixed;--%>
            ...
            <%
            out.println("<iframe style=\"margin-top:4em;width:100%;height:92%\" src=\"registroAdministrador/navegadorOpciones.jsf?ca="+request.getParameter("ca")+"&data="+(new Date()).getTime()+"\"></iframe>");
            %>
