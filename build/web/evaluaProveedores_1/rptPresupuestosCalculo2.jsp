    ...
    public double redondear(double numero, int decimales) {
        ...
        <div align="center">
            ...
            <table width="50%">
                ...
                <tr>
                    ...
                    <td align="left" class="outputText2" width="90%" >
                        ...
                        %>
                        <b>Categorias Incentivos&nbsp;::&nbsp;</b><%=nombreCategoria%><br>
            ...
            for (int m = 0; m <= codCategoriaVector.length - 1; m++) {
                ...
                String codCategoriaFiltro = nombreCategoriaVector[m];
                System.out.println("codCategoriaFiltro:" + codCategoriaFiltro);

                String sql_areas = "select c.COD_AREA_EMPRESA from CATEGORIAS_INCENTIVOS_OTROS_AREAS c where c.COD_CATEGORIA_INCENTIVO="+codCategoriaFiltro+"";
                Statement st_areas = con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                ResultSet rs_areas = st_areas.executeQuery(sql_p);
                while (rs_areas.next()) {
                    codPeriodoGestion = codPeriodoGestion + "," + rs_p.getString(1);
                }
                codPeriodoGestion = codPeriodoGestionOriginal;
                ...
                sql_del += " and COD_AREA_EMPRESA='" + codAreaEmpresaF + "' AND COD_LINEA_COMISIONMKT='" + codLineaF + "'";
        ...
        <%--/tr--%>
            ...
            while (rsLinea.next()) {
                ...
                while (rs_00.next()) {
                    ...
                    sql_insertar += " COD_TIPO_INCENTIVO,COD_AREA_EMPRESA,COD_LINEA_COMISIONMKT,COD_PRESENTACION,NOMBRE_PRESENTACION,";
                    sql_insertar += " COD_CATEGORIA_PRESENTACION,NOMBRE_CATEGORIA_PRESENTACION,VENTAS_ANALISIS_BS,VENTAS_ANALISIS_UNID,";
                    ...
                    sql_insertar += " VALUES(" + cod_tipo_incentivo_regional + "," + codLineaFiltro + "," + codAreaEmpresaF + "," + codLineaF + ",";
        ...
        <%--td align="right" style="background-color:#FFFF99;border-left:1px solid #000000;border-top:1px solid #000000;border-right:1px solid #000000;color: red;"><b>TOTAL &nbsp;<%=nombreLineaFiltro%>&nbsp;</b></td--%>
                            <%
                                            /*String sql_eli = " delete from COMISIONES_PERSONAL_LINEASMKT where COD_TIPO_INCENTIVO_REGIONAL=" + cod_tipo_incentivo_regional + " and COD_AREA_EMPRESA=" + codAreaEmpresaF + " " +
                                            " and COD_LINEA_COMISIONMKT=" + codLineaF + " and COD_PRESENTACION=0 and COD_TIPO_INCENTIVO=" + codLineaFiltro + "";
                                            System.out.println("sql_eli:" + sql_eli);
                                            Statement st_eli = con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                                            int rs_eli = st_eli.executeUpdate(sql_eli);*/
                                            sql_insertar = "INSERT INTO COMISIONES_PERSONAL_LINEASMKT_OTROS (COD_TIPO_INCENTIVO_REGIONAL,";
                                            sql_insertar += " COD_TIPO_INCENTIVO,COD_AREA_EMPRESA,COD_LINEA_COMISIONMKT,COD_PRESENTACION,NOMBRE_PRESENTACION,";
                                            sql_insertar += " COD_CATEGORIA_PRESENTACION,NOMBRE_CATEGORIA_PRESENTACION,VENTAS_ANALISIS_BS,VENTAS_ANALISIS_UNID,";
                                            sql_insertar += " PRESUPUESTO_ANALISIS_BS,PRESUPUESTO_ANALISIS_UNID,CUMPLIMIENTO_BS,CUMPLIMIENTO_UNID,CRECIMIENTO_BS,CRECIMIENTO_UNID,MONTO_INCENTIVO)";
                                            sql_insertar += " VALUES(" + cod_tipo_incentivo_regional + "," + codLineaFiltro + "," + codAreaEmpresaF + "," + codLineaF + ",0,'" + nombreLineaFiltro + "',";
                                            sql_insertar += " 10,'Z',";
                            ...
                            <tr  class="tituloCampo">
                                ...
                                <%
                                            for (int k = 0; k < anteriorPeriodoVV.length; k++) {
                                                ...
                                                try {
                                                    sql_del = "delete from  TIPOS_INCENTIVO_REGIONAL_DETALLE where COD_TIPO_INCENTIVO_REGIONAL='" + cod_tipo_incentivo_regional + "'  ";
                                                    ...
                                                    sql += " COD_AREA_EMPRESA,COD_LINEA_VENTA,PORCENTAJE)values(";
                                                    sql += "'" + cod_tipo_incentivo_regional + "',";
                                                    sql += "'" + codTipo + "',";
                                                    sql += "'" + codAreaEmpresaF + "','" + codLineaF + "','" + form.format(crecimientoTotalVV) + "')";
                                ...
                                <%        }
                                            try {
                                                ...
                                                sql_upd += " MONTO=" + sumaTotalMontoIncentivo + " WHERE COD_TIPO_INCENTIVO_REGIONAL='" + cod_tipo_incentivo_regional + "' AND COD_AREA_EMPRESA='" + codAreaEmpresaF + "' AND COD_LINEA_VENTA='" + codLineaF + "' ";
