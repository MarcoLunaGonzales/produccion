        ...
        <head>
            ...
            <a4j:form id="form1"   >
                <div align="center" >
                    ...
                    <h:outputText value="#{ManagedProgramaProduccionSimulacion.cargarContenidoAgregarProgramaProduccionSimulacion}" />
                     ...
                     <h:panelGroup id="contenidoAgregarLote" >
                         <rich:panel headerClass="headerClassACliente" style="width:80%">
                            ...
                            <h:panelGrid columns="6">
                                ...
                                <h:outputText value="#{ManagedProgramaProduccionSimulacion.programaProduccionCabeceraAgregar.formulaMaestra.componentesProd.nombreProdSemiterminado}"  styleClass="outputText2"/>
                                <h:outputText styleClass="outputTextBold" value="Cantidad Lote"/>
                                <h:outputText styleClass="outputTextBold" value="::"/>
                                <h:outputText value="#{ManagedProgramaProduccionSimulacion.programaProduccionCabeceraAgregar.formulaMaestra.cantidadLote}" styleClass="outputText2" id="tamLoteOficial"/>
                                <h:outputText styleClass="outputTextBold" value="Cantidad Lotes"/>
                                <h:outputText styleClass="outputTextBold" value="::"/>
                                <h:inputText value="#{ManagedProgramaProduccionSimulacion.programaProduccionCabeceraAgregar.nroLotes}" id="cantidadLotes" styleClass="inputText"/>
                            </h:panelGrid>
                       ...
                       <rich:dataTable value="#{ManagedProgramaProduccionSimulacion.programaProduccionAgregarList}" var="data"
                                    id="dataProgramaProduccion"
                                    onRowMouseOut="this.style.backgroundColor='#FFFFFF';" 
                                    onRowMouseOver="this.style.backgroundColor='#DDE3E4';" 
                                    headerClass="headerClassACliente"
                                    style="margin-top:1em;" rowKeyVar="var"
                                    binding="#{ManagedProgramaProduccionSimulacion.programaProduccionAgregarDataTable}">
                        <f:facet name="header">
                            <rich:columnGroup>
                                <rich:column>
                                    <h:outputText value=""/>
                        ...
                        <rich:column>
                            <a4j:commandLink rendered="#{var != 0}" action="#{ManagedProgramaProduccionSimulacion.modificarProductoProgramaProduccionAgregar_action}"
                        ...
                        <rich:column>
                            <h:selectOneMenu value="#{data.tiposProgramaProduccion.codTipoProgramaProd}" styleClass="inputText" rendered="#{data.tiposProgramaProduccion.nombreTipoProgramaProd eq ''}">
                                ...
                                <a4j:support event="onchange"  action="#{ManagedProgramaProduccionSimulacion.cargarPresentacionesProductoSelect}" reRender="dataProgramaProduccion"/>
                            </h:selectOneMenu>
                        ...
                        <center>
                            <a4j:commandLink action="#{ManagedProgramaProduccionSimulacion.agregarProductoTipoProgramaProduccion_action}" reRender="dataProgramaProduccion" >
                                <h:graphicImage url="../img/mas.png"/>
                            </a4j:commandLink>
                            <a4j:commandLink action="#{ManagedProgramaProduccionSimulacion.menosProgramaProduccionAgregar_action}" reRender="dataProgramaProduccion" >
                    ...
                    <br>
                        ...
                        <a4j:commandButton styleClass="btn" oncomplete="window.location.href='navegadorProgramaProduccionSimulacion.jsf?codProgramaProd=#{ManagedProgramaProduccionSimulacion.programaProduccionbean.codProgramaProduccion}&cancel='+(new Date()).getTime().toString();" value="Cancelar" />
            </a4j:form>
