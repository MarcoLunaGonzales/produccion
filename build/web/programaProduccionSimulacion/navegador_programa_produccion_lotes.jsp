...
<body >
    ...
    <div  align="center" id="panelCenter">
        ...
        <h:outputText value="#{ManagedProgramaProduccionSimulacion.cargarProgramaProduccion2}"  />
        <h:outputText styleClass="outputTextTitulo"  value="Simulación de Programas de Producción " />                    
        <br>
        <br>

            
        <rich:dataTable value="#{ManagedProgramaProduccionSimulacion.programaProduccionLotesList}" var="data" id="dataFormula"
