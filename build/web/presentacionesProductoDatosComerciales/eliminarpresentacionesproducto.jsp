...
<f:view>
    <html>
        ...
        <body>
            <h:form id="form1"  >                
                <div align="center">                    
                    <h:panelGrid rendered="#{ManagedPresentacionesProducto.swEliminaSi}" columns="3" styleClass="panelgrid" headerClass="headerClassACliente">
                        <f:facet name="header" >
                    ...
                    <br><br>
                    <h:panelGrid rendered="#{ManagedPresentacionesProducto.swEliminaNo}" columns="3" styleClass="panelgrid" headerClass="headerClassACliente">
                        <f:facet name="header" >
