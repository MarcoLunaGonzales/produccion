        ...
        <head>
            ...
            <script>
                function getCodigo(codigo){
                   location='../presentacionesProductoDatosComerciales/navegadorPresentacionesProductoBuscarInstitucional.jsf?codLinea='+codigo;
                }
            </script>
        </head>
        <body >
            <h:form id="form1">               
                <div align="center">                    
                    <h3>Precios Institucionales<br>Ver por Linea</h3>
