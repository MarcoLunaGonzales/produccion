...
<f:view>
    <html>
        ...
        <body>
            <br><br>
            <h:form id="form1"  >
                <h:outputText value="#{ManagedCartonesCorrugados.codigoCartonesCorrugados}" styleClass="outputText2" />
                <div align="center">
                    <br>
                    <h:outputText value="Registrar Cartón Corrugado" styleClass="tituloCabezera1"    />
                    ...
                    <br>
                    <h:commandButton value="Guardar" styleClass="commandButton" action="#{ManagedCartonesCorrugados.guardarCartonesCorrugados}"   onclick="return validar();" />
