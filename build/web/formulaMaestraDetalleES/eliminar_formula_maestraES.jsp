        ...
        <body>
         <h:form id="form1"  >
                ...
                <div align="center" class="outputText2">
                  ...
                  <br><br>
            <rich:dataTable value="#{ManagedFormulaMaestraDetalleES.formulaMaestraDetalleESEliminarList}" var="data" id="dataAreasDependientes" 
                    ...
                    <br>
                    <h:commandButton value="Eliminar" styleClass="btn" action="#{ManagedFormulaMaestraDetalleES.guardarEliminarFormulaMaestraDetalleES}" />
