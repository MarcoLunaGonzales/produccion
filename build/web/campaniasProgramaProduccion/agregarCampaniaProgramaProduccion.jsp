            ...
            <script  type="text/javascript">
             ...
             <a4j:form id="form1">
                <div align="center">
                    ...
                    <h:outputText value="#{ManagedCampanasProgramaProduccion.cargarAgregarCampaniaProduccion}"  />
                    ...
                    <a4j:commandButton value="Guardar" action="#{ManagedCampanasProgramaProduccion.guardarCampaniaProgramaProduccion_action}" styleClass="btn"
                    oncomplete="if(#{ManagedCampanasProgramaProduccion.mensaje eq '1'}){alert('Se registro la campaña');window.location.href='navegadorLotesCampaniaProgramaProduccion.jsf?data='+(new Date()).getTime().toString();}
