...
<div align="center">
    <br>
    <h:outputText value="Agregar Proceso de Producción por Fórmula Maestra" styleClass="tituloCabezera1"    />
    <br> <br> <b></b> <h:outputText value="#{ManagedActividadesFormulaMaestra.nombreComProd}"   />
    <br><br>
    <rich:dataTable value="#{ManagedActividadesFormulaMaestra.actividadesFormulaMaestraAdicionarList}" var="data" id="dataCadenaCliente" 
    ...
    <br>
    <h:commandButton value="Guardar" styleClass="commandButton" action="#{ManagedActividadesFormulaMaestra.guardarActividadesFormulaMaestra}"   onclick="return validar();" />
