...
<html>
    <head>
        ...
        <script language="javascript">
            function actualizarStockHermes()
            {
                var peticion="actualizarStockHermesAjax.jsf?data="+(new Date()).getTime().toString();
                 ajax=creaAjax();
                 ...
                 ajax.setRequestHeader('content-type', 'application/x-www-form-urlencoded;charset=UTF-8');
                         ajax.onreadystatechange=function(){
                            if (ajax.readyState==4) {
                                ...
                                {
                                    alert('Se actualizo el stock hermes')
                                    return true;
                                }
                                else
                                {
            ...
            function calculoStockMateriales(f)
            {
                ...
                f.action="navegadorReporteCalculoStocks.jsf";
                f.submit();
            }
                ...
                <table border="0" class="tablaFiltroReporte" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td colspan="3" class="tdCenter">
                            ...
                            <a class="btn" onclick="actualizarStockHermes()">Actualizar stock</a>
