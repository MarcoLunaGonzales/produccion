...
<f:view>
    ...
    <html>
        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                    <h:outputText value="#{ManagedEspecificacionesControlCalidad.cargarFormasFarmaceuticasCc}"/>
                    <h:outputText styleClass="outputTextTitulo"  value="Registro de Especificaciones por Forma Farmaceútica" />
                    <br><br>
                    
                    <rich:dataTable value="#{ManagedEspecificacionesControlCalidad.formasFarmaceuticasList}"
                                    var="data"
                                    id="dataEspecificacionesQuimicasCc"
                                    onRowMouseOut="this.style.backgroundColor='#FFFFFF';"
                                    onRowMouseOver="this.style.backgroundColor='#DDE3E4';"
                                    headerClass="headerClassACliente" binding="#{ManagedEspecificacionesControlCalidad.formasFarmaceuticasDataTable}">
                        <h:column>
                            <f:facet name="header">
                                <h:outputText value=""  />
                            </f:facet>
                        ...
                        <h:column>
                            ...
                            <h:commandLink action="#{ManagedEspecificacionesControlCalidad.seleccionarFormaFarmaceutica_action}">
                    ...
                    <br>
                        ...
                        <a4j:commandButton value="Eliminar" styleClass="btn" onclick="if(confirm('Esta seguro de eliminar la equivalencia?')){if(editarItem('form1:dataEspecificacionesQuimicasCc')==false){return false;}}else{return false;}"  action="#{ManagedEspecificacionesControlCalidad.eliminarEspecificaciones_action}"
                        oncomplete="if(#{ManagedEspecificacionesControlCalidad.mensaje!=''}){alert('#{ManagedEspecificacionesControlCalidad.mensaje}');}else{alert('se elimino la unidad de medida');}" reRender="dataEspecificacionesQuimicasCc,controles"/--%>
