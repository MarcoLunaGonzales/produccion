        ...
        <body onload="visibilityPanel();carga();">            
            <a4j:form id="form1"  >                
                <div align="center">
                    ...
                    <h3>Editar Producto Combinado</h3>
                    ...
                    <h:commandButton value="Guardar" styleClass="commandButton"  action="#{ManagedBeanProductosCombinados.updatePresentacionesProducto}" onclick="return validar()" />
