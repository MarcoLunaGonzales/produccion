...
try{
    ...
    fechaInicio = fechaInicio.dayOfMonth().withMinimumValue();
    DateTime fechaFinal = new DateTime();
    fechaFinal = fechaFinal.dayOfMonth().withMaximumValue();
    String consulta = " select m.COD_MAQUINA,cp.COD_COMPPROD,m.NOMBRE_MAQUINA,cp.nombre_prod_semiterminado, pprc.COD_LOTE_PRODUCCION ,pprcd.FECHA_INICIO,pprcd.FECHA_FINAL" +
             ...
             " where pprcd.FECHA_INICIO >= '"+sdf1.format(fechaInicio.toDate())+" 00:00:00' " + //and '"+sdf1.format(fechaInicio.toDate())+" 23:59:59'
             " and pprcd.FECHA_FINAL <= '"+sdf1.format(fechaFinal.toDate())+" 23:59:59' "+ //and '"+sdf1.format(fechaFinal.toDate())+" 23:59:59'
                ...
                ajax.onreadystatechange=function(){
                    if (ajax.readyState==4) {
                       ...
                       // scheduler.clearAll();
                        ...
                        //alert("paso 2");
                          location = "reporteCronograma.jsp";
                        //divAddCargos.innerHTML=ajax.responseText;
...
<%--input type="button" name="show" value="Show" onclick="show()" style="right:400px;" /--%>
    ...
    <div id="scheduler_here" class="dhx_cal_container" style='height:80%;overflow:auto'>
