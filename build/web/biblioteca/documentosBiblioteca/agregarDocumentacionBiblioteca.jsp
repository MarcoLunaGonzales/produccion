   ...
   if(extension.toLowerCase().equals(".pdf"))
       {
           ...
           try{
               ...
               nombreImagen = nombreImagen +"-cd-"+codDocumento+"-v-1-f-"+sdf.format(new Date())+ extension;
               consulta="INSERT INTO DOCUMENTACION(COD_DOCUMENTO, NOMBRE_DOCUMENTO, CODIGO_DOCUMENTO,"+
                        " COD_TIPO_DOCUMENTO_BIBLIOTECA, COD_AREA_EMPRESA,COD_MAQUINA,NRO_PREGUNTAS_CUESTIONARIO,COD_COMPPROD)"+
                        " VALUES ('"+codDocumento+"','"+mrequest.getParameter("nombreDocumento")+"','"+mrequest.getParameter("codigoDocumento")+"',"+
                        " '"+mrequest.getParameter("codTipoDoc")+"','"+mrequest.getParameter("codNivel")+"',"+
                        " '"+mrequest.getParameter("codmaquina")+"','"+mrequest.getParameter("nroPreguntas")+"','"+mrequest.getParameter("codCompProd")+"')";
...
<html >
    ...
    <body style="border:none;" ><br><br>
        ...
        <table style="border-top:1px solid black;width:85%;border-left:1px solid black;margin-top:12px" cellpadding="0" cellspacing="0">
            ...
            <tr bgcolor="#9d5a9e" style="color:white;font-weight:bold;" >
            <td colspan="2" style="font-weight:bold;border-bottom:1px solid black;border-right:1px solid black;padding:4px;" class="outputText2">Tipo Documento</td>
            ...
            try
            {
                ...
                %>
                    ...
                    <select id="codTipoDocBpmISo" name="codTipoDocBpmISo" class="inputText">
                     <%
                     consulta="select tdb.COD_TIPO_DOCUMENTO_BPM_ISO,tdb.NOMBRE_TIPO_DOCUMENTO_BPM_ISO"+
                              " from TIPOS_DOCUMENTO_BPM_ISO tdb where tdb.COD_ESTADO_REGISTRO=1 order  by tdb.NOMBRE_TIPO_DOCUMENTO_BPM_ISO";
                     res=st.executeQuery(consulta);
                     while(res.next())
                     {
                         out.println("<option value='"+res.getString("COD_TIPO_DOCUMENTO_BPM_ISO")+"'> "+res.getString("NOMBRE_TIPO_DOCUMENTO_BPM_ISO")+"</option>");
                     }
                     %>
                    </select--%>
                    ...
                    <tr bgcolor="#9d5a9e" style="color:white;font-weight:bold;" >
                            ...
                            <td colspan="1" style="font-weight:bold;border-bottom:1px solid black;border-right:1px solid black;padding:4px;" class="outputText2">Nro Preguntas Cuestionario:</td>
                    ...
                    <tr>
                        ...
                        <td colspan="1" style="font-weight:bold;border-bottom:1px solid black;border-right:1px solid black;padding:4px;" align="center">
                            <input value="" type="text" id="nroPreguntas" name="nroPreguntas" size="4" class="inputText">
                    ...
                    <tr bgcolor="#9d5a9e" style="color:white;font-weight:bold;" >
                            <td colspan="3" style="font-weight:bold;border-bottom:1px solid black;border-right:1px solid black;padding:4px;" class="outputText2">Producto</td>
                    </tr>
                    <tr>
                        <td colspan="3" style="font-weight:bold;border-bottom:1px solid black;border-right:1px solid black;padding:4px;" align="center">
                         <select id="codCompProd" name="codCompProd">
                                <%
                                         consulta="select cp.COD_COMPPROD,cp.nombre_prod_semiterminado from COMPONENTES_PROD cp where cp.COD_ESTADO_COMPPROD=1"+
