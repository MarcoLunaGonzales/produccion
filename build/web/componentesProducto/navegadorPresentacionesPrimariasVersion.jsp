    ...
    <html>
        ...
        <body>
            ...
            <h:form id="form1"  >
                <div align="center">                    
                        <br><br>                
                    <h:outputText value="#{ManagedComponentesProducto.obtenerCodigoPresentacionesPrimariasVersion}"   />
                    ...
                    <h:commandButton value="Registrar" styleClass="commandButton"  action="#{ManagedComponentesProducto.registrarPresentacionesPrimariasVersion1}"/>
                    <h:commandButton value="Eliminar"  styleClass="commandButton"  action="#{ManagedComponentesProducto.actionEliminarPresentacionesPrimariasVersion}"  onclick="return eliminar('form1:dataPresenacionesPrimarias');"/>
