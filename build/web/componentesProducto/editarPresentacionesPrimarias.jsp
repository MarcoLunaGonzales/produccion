            ...
            <div style="text-align:center">                            
                <h:form id="form1"  >
                    ...
                    <div align="center">                
                        ...
                        <h:commandButton value="Guardar" styleClass="commandButton" onclick="return validarRegistro();" action="#{ManagedComponentesProducto.guardarEditarPresentacionesPrimarias_action}"  />
                        <h:commandButton value="Cancelar"  styleClass="commandButton" action="#{ManagedComponentesProducto.cancelarPresentacionesPrimarias1}"/>
                    </div>            
                </h:form>
            </div>    
        </body>
