            ...
            <a4j:form id="form1"  >
                <div style="text-align:center">
                    ...
                    <div align="center">
                        ...
                        <a4j:commandButton value="Guardar" styleClass="btn" action="#{ManagedComponentesProducto.guardarComponentesProdVersion1}" onclick="if(confirm('Esta seguro de agregar la version' && validar('form1:detalle')==false)==false){return false;}"  oncomplete="location = 'navegador_componentesProductoVersion.jsf'" />
