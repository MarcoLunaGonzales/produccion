...
<f:view>
    ...
    <html>
        ...
        <body >
            <a4j:form id="form1">               
                <div align="center">
                    <h:outputText value="#{ManagedMaquinaria.cargarAgregarPartesMaquinaria_action}"/>
                    <h:outputText styleClass="outputTextTituloSistema"  value="Registro de Nueva Parte Maquinaria" />    
                    ...
                    <rich:panel headerClass="headerClassACliente" style="width:80%">
                        <f:facet name="header">
                            <h:outputText value="Agregar Parte Maquinaria"/>
                        </f:facet>
                        <h:panelGrid columns="3">
                            <h:outputText value="Código" styleClass="outputTextBold"/>
                            <h:outputText value="::" styleClass="outputTextBold"/>
                            <h:inputText value="#{ManagedMaquinaria.partesMaquinariaAgregar.codigo}" id="codigoParteMaquinaria" style="width:30em" styleClass="inputText"/>
                            <h:outputText value="Nombre" styleClass="outputTextBold"/>
                            <h:outputText value="::" styleClass="outputTextBold"/>
                            <h:inputText value="#{ManagedMaquinaria.partesMaquinariaAgregar.nombreParteMaquina}" id="nombreParteMaquinaria" style="width:100%" styleClass="inputText"/>
                            <h:outputText value="Tipo De Maquinaria" styleClass="outputTextBold"/>
                            <h:outputText value="::" styleClass="outputTextBold"/>
                            <h:selectOneMenu value="#{ManagedMaquinaria.partesMaquinariaAgregar.tiposEquiposMaquinaria.codTipoEquipo}" styleClass="inputText">
                                <f:selectItems value="#{ManagedMaquinaria.tiposEquipoSelectList}"/>
                            </h:selectOneMenu>
                            <h:outputText value="Descripción" styleClass="outputTextBold"/>
                            <h:outputText value="::" styleClass="outputTextBold"/>
                            <h:inputTextarea value="#{ManagedMaquinaria.partesMaquinariaAgregar.obsParteMaquina}" styleClass="inputText" rows="4" style="width:100%">
                            </h:inputTextarea>
                            <h:outputText value="Material Asociado Almacen" styleClass="outputTextBold"/>
                            <h:outputText value="::" styleClass="outputTextBold"/>
                            <h:selectOneMenu value="#{ManagedMaquinaria.partesMaquinariaAgregar.materiales.codMaterial}" styleClass="inputText">
                                <f:selectItem itemValue='0' itemLabel="--No Aplica--"/>
                                <f:selectItems value="#{ManagedMaquinaria.materialesSelectList}"/>
                            </h:selectOneMenu>
                        </h:panelGrid>
                        <a4j:commandButton value="Guardar" onclick="if(!validarRegistro()){return false;}" styleClass="btn" action="#{ManagedMaquinaria.guardarAgregarPartesMaquinaria_action}"
