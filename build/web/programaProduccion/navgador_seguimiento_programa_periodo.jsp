                ...
                <table border="0" class="outputText2"  style="border:1px solid #000000"  width="95%" cellspacing="0" cellpadding="2" id="navegador">
                    ...
                    <tr>
                        <h2>
                            ...
                            <td>
                                &nbsp;&nbsp;<a href="../programaProduccion/navegador_seguimiento_programa_produccion.jsf?codProgramaProd=<%=COD_PROGRAMA_PROD%>" title="Click para ingresasar"><%=NOMBRE_PROGRAMA_PROD%></a>
                            </td>
