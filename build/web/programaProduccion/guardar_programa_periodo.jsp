...
try{
    ...
    String sql_1="insert into PROGRAMA_PRODUCCION_PERIODO (COD_PROGRAMA_PROD,NOMBRE_PROGRAMA_PROD,OBSERVACIONES,COD_ESTADO_PROGRAMA,fecha_inicio,fecha_final,COD_TIPO_PRODUCCION)";
    sql_1+=" values("+codProgramaPord+",'"+nombrePrograma+"','"+obs+"',1,'"+fechaInicio+"','"+fechaFinal+"',1)";
