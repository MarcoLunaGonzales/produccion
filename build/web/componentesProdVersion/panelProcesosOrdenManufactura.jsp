...
<rich:modalPanel id="modalDefinirProcesos" minHeight="330" headerClass="headerClassACliente"
       ...
       <a4j:form id="formProcesos">
           <center>
                        ...
                        <tr>
                            <td colspan="3" style="width:45%">
                                <div style="height:240px;overflow-y:auto;width:auto">
                                   <rich:dataTable value="#{ManagedComponentesProdVersion.componentesProdProcesoOrdenManufacturaDisponibleList}"
                                       ...
                                       <f:facet name="header">
                                        ...
                                        <rich:column>
                                            <a4j:commandLink styleClass="btn"  reRender="contenidoDefinirProcesos"
                                                             title="Agregar"
                                                            action="#{ManagedComponentesProdVersion.agregarProcesoOrdenManufacturaAction(data)}">
                            ...
                            <td colspan="3" style="width:55%">
                                <div style="height:240px;overflow-y:auto;width:auto">
                                   <rich:dataTable value="#{ManagedComponentesProdVersion.componentesProdProcesoOrdenManufacturaList}"
                                       ...
                                       <rich:column style="font-size:9px !important">
                                        ...
                                        <rich:column>
                                            <a4j:commandLink styleClass="btn" reRender="contenidoDefinirProcesos" rendered="#{index>0}"
                                                            action="#{ManagedComponentesProdVersion.adicionarOrdenProcesoOrdenManufacturaAction(index,-1)}">
                                               <h:outputText styleClass="icon-arrow-up"/>
                                           </a4j:commandLink>
                                           <a4j:commandLink styleClass="btn" reRender="contenidoDefinirProcesos" rendered="#{(index+1) ne ManagedComponentesProdVersion.componentesProdProcesoOrdenManufacturaList.size()}"
                                                             action="#{ManagedComponentesProdVersion.adicionarOrdenProcesoOrdenManufacturaAction(index,1)}">
                                        ...
                                        <rich:column>
                                            <a4j:commandLink styleClass="btn"  reRender="contenidoDefinirProcesos"
                                                            title="Quitar" action="#{ManagedComponentesProdVersion.eliminarProcesoOrdenManufacturaAction(data)}">
               ...
               <a4j:commandButton action="#{ManagedComponentesProdVersion.guardarComponentesProdProceosOrdenManufacturaAction}" 
