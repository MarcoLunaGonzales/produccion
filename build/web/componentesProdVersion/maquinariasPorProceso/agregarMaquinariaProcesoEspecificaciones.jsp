...
<f:view>
    ...
    <html>
        <head>
            ...
            <a4j:form id="form1">
                <div align="center">
                    <h:outputText value="#{ManagedComponentesProdVersion.cargarAgregarEspecificacionesMaquinariaProcesoProducto}"/>
                        ...
                        <rich:panel headerClass="headerClassACliente" style="width:50%">
                            ...
                            <h:panelGrid columns="3" headerClass="headerClassACliente">
                               ...
                               <h:outputText value="#{ManagedComponentesProdVersion.componentesProdVersionBean.forma.nombreForma} " styleClass="outputText2"/>
                                ...
                                <h:outputText value="::" styleClass="outputTextBold" />
                                <h:selectOneMenu value="#{ManagedComponentesProdVersion.componentesProdVersionMaquinariaProcesoBean.maquinaria.codMaquina}" styleClass="inputText chosen">
                                    <f:selectItems value="#{ManagedComponentesProdVersion.maquinariasSelectList}"/>
                                    <a4j:support event="onchange" action="#{ManagedComponentesProdVersion.codCompProdVersionMaquinariaProceso_action}" reRender="dataEspecificaciones"/>
                                </h:selectOneMenu>
                            </h:panelGrid>
                        </rich:panel>
                    
                    <rich:dataTable value="#{ManagedComponentesProdVersion.componentesProdVersionMaquinariaProcesoBean.especificacionesProcesosProductoMaquinariaList}"
                        ...
                        <div id="bottonesAcccion" class="barraBotones">
                            <a4j:commandButton value="Guardar" styleClass="btn" action="#{ManagedComponentesProdVersion.guardarAgregarComponentesProdVersionMaquinariaProceso_action}"
