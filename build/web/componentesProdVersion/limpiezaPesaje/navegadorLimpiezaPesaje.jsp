...
<f:view>
    ...
    <html>
        ...
        <body>
            <a4j:form id="form1">
                <div align="center">
                    <h:outputText value="#{ManagedComponentesProdVersion.cargarComponentesProdVersionLimpiezaPesajeList}"/>
                    ...
                    <h:panelGroup id="contenido">
                        ...
                        <rich:dataTable value="#{ManagedComponentesProdVersion.componentesProdVersionLimpiezaSeccionPesajeList}"
                            ...
                            <rich:subTable value="#{data.componentesProdVersionLimpiezaMaquinariaList}" var="subData" rowKeyVar="key">
                                ...
                                <rich:column rendered="#{key eq 0}" rowspan="#{data.componentesProdVersionLimpiezaMaquinariaListSize}">
                                    <a4j:commandButton value="Eliminar" styleClass="btn"
                                               action="#{ManagedComponentesProdVersion.eliminarComponentesProdVersionLimpiezaSeccionPesajeAction(data.codComponentesProdVersionLimpiezaSeccion)}"
