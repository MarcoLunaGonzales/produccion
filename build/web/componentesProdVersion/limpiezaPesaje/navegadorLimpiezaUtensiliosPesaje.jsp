...
<f:view>
    ...
    <html>
        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                    <h:outputText value="#{ManagedComponentesProdVersion.cargarComponentesProdVersionLimpiezaUtensiliosPesaje}"/>
                    ...
                    <h:panelGroup id="contenido">
                        ...
                        <rich:dataTable value="#{ManagedComponentesProdVersion.componentesProdVersionLimpiezaUtensilioPesajeList}"
                                                var="data" id="dataUtensilioLimpieza"
                            ...
                            <f:facet name="header">
                                ...
                                <rich:column>
                                    <a4j:commandButton value="Eliminar" styleClass="btn" 
                                               action="#{ManagedComponentesProdVersion.eliminarComponentesProdVersionLimpiezaUtensilioLimpiezaAction(data.codComponentesProdVersionLimpiezaMaquinaria)}"
                                               oncomplete="mostrarMensajeTransaccion()"
                                               reRender="dataUtensilioLimpieza"/>
                                </rich:column>
                        </rich:dataTable>
                        </h:panelGroup>
                        <div style='margin-top:1em'>
                            <a4j:commandButton value="Agregar" styleClass="btn" oncomplete="window.location.href='agregarLimpiezaUtensiliosPesaje.jsf?dataA='+(new Date()).getTime().toString();"/>
