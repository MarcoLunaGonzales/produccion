        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                    ...
                    <h:outputText value="#{ManagedProcesosPreparadoProducto.cargarEdicionSubProcesosPreparadoProducto}"/>
                    <rich:panel headerClass="headerClassACliente" style="width:70%">
                        ...
                        <h:panelGrid columns="3" id="contenidoEditarSubProceso">
                            ...
                            <h:panelGroup>
                                <h:outputText styleClass="outputText2" value="#{ManagedProcesosPreparadoProducto.procesosPreparadoProductoBean.nroPaso}."/>
                                <h:inputText value="#{ManagedProcesosPreparadoProducto.subProcesosPreparadoProductoEditar.nroPaso}" style="width:7em" styleClass="inputText" onblur="valorPorDefecto(this)"/>
                            </h:panelGroup>
                            <h:outputText styleClass="outputTextBold" value="Actividad"/>
                            <h:outputText styleClass="outputTextBold" value="::"/>
                            <h:selectOneMenu value="#{ManagedProcesosPreparadoProducto.subProcesosPreparadoProductoEditar.actividadesPreparado.codActividadPreparado}" styleClass="inputText chosen">
                            ...
                            <h:outputText styleClass="outputTextBold" value="::"/>
                            <h:inputTextarea value="#{ManagedProcesosPreparadoProducto.subProcesosPreparadoProductoEditar.descripcion}" cols="60" rows="4" styleClass="inputText">
                            </h:inputTextarea>
                            <h:outputText styleClass="outputTextBold" value="Tiempo proceso(min)"/>
                            <h:outputText styleClass="outputTextBold" value="::"/>
                            <h:inputText value="#{ManagedProcesosPreparadoProducto.subProcesosPreparadoProductoEditar.tiempoProceso}" styleClass="inputText"/>
                            <h:outputText styleClass="outputTextBold" value="Tolerancia(%)"/>
                            <h:outputText styleClass="outputTextBold" value="::"/>
                            <h:inputText value="#{ManagedProcesosPreparadoProducto.subProcesosPreparadoProductoEditar.toleranciaTiempo}" styleClass="inputText"/>
                            <h:outputText styleClass="outputTextBold" value="Operario Tiempo Completo"/>
                            <h:outputText styleClass="outputTextBold" value="::"/>
                            <h:selectBooleanCheckbox value="#{ManagedProcesosPreparadoProducto.subProcesosPreparadoProductoEditar.operarioTiempoCompleto}"/>
                            <h:outputText styleClass="outputTextBold" value="Proceso Destino"/>
                            <h:outputText styleClass="outputTextBold" value="::"/>
                            <h:selectOneMenu value="#{ManagedProcesosPreparadoProducto.subProcesosPreparadoProductoEditar.procesosPreparadoProductoDestino.codProcesoPreparadoProducto}" styleClass="inputText">
                   ...
                   <rich:panel headerClass="headerClassACliente" style="width:70%">
                                ...
                                <tr>
                                    <td>
                                        <div style="overflow-x:hidden;overflow-y:auto;height:200px;">
                                            <rich:dataTable value="#{ManagedProcesosPreparadoProducto.subProcesosPreparadoProductoEditar.procesosPreparadoProductoMaquinariaList}"
                    ...
                    <br>
                    <a4j:commandButton value="Guardar" action="#{ManagedProcesosPreparadoProducto.guardarEdicionSubProcesosPreparadoProducto_action}" styleClass="btn"
