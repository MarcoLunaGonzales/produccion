...
<html>
        ...
        <script>
            ...
            function editarPerfil(codPerfil)
            {
                ...
                ajax.send("codigosVentana="+codigosVentana+
                                "&codigosPermiso="+permisosHabilitados+
    ...
    <body> 
        <span class="outputTextTituloSistema">Edición de Perfil de Usuario</span>
                            ...
                            <td colspan="2" style="display:none">
                                <table style="width: 100%" class="tablaReporte" cellpading='0px' cellspacing='0px'>
                                    <thead>
                                        <tr>
                                            <td></td>
                                            <td class="outputText2">Permiso</br><input type='text' onkeyup='buscarCeldaAgregar(this,1)' class='inputText'/></td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <%
                                            consulta = new StringBuilder("select tpea.COD_TIPO_PERMISO_ESPECIAL_ATLAS,tpea.NOMBRE_TIPO_PERMISO_ESPECIAL_ATLAS,")
                                                                        .append("ppa.COD_PERFIL_PERMISO_ATLAS")
                                                                .append(" from TIPOS_PERMISOS_ESPECIALES_ATLAS tpea")
                                                                        .append(" left outer join PERFILES_PERMISOS_ATLAS ppa on ppa.COD_TIPO_PERMISO_ESPECIAL_ATLAS=tpea.COD_TIPO_PERMISO_ESPECIAL_ATLAS")
                                                                                .append(" and ppa.COD_PERFIL= ").append(codPerfil)
                                                                .append("order by tpea.NOMBRE_TIPO_PERMISO_ESPECIAL_ATLAS");
                                            System.out.println("consulta perfil permisos "+consulta.toString());
                                            res = st.executeQuery(consulta.toString());
                                            while(res.next()){
                                                out.println("<tr>");
                                                        out.println("<td><input type='checkbox'"+(res.getInt("COD_PERFIL_PERMISO_ATLAS") > 0 ? "checked" : "")+" name='checkPerfilPermiso' value='"+res.getInt("COD_TIPO_PERMISO_ESPECIAL_ATLAS")+"' id='checkPermiso"+res.getRow()+"'/></td>");
                    ...
                    <%
                        ...
                        consulta=new StringBuilder("select distinct va.ORDEN, va.COD_VENTANA,va.NOMBRE_VENTANA,va.URL_VENTANA,va.COD_VENTANAPADRE");
                                ...
                                consulta.append(" from VENTANAS_ATLAS va");
                                    consulta.append(" left outer join PERFIL_ACCESO_VENTANA_ATLAS pav on pav.COD_VENTANA=va.COD_VENTANA");
