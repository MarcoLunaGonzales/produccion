        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                    ...
                    <h:outputText value="#{ManagedFormasFarmaceuticasActividadesPreparado.cargarAgregarSubProcesoFormaFarActividad}"/>
                    ...
                    <rich:panel headerClass="headerClassACliente">
                        ...
                        <h:panelGrid columns="3">
                            ...
                            <h:outputText value="::" styleClass="outputTextBold"/>
                            <h:selectOneMenu value="#{ManagedFormasFarmaceuticasActividadesPreparado.subProcesoFormasFarmaceuticasActividadesPreparadoAgregar.actividadesPreparado.codActividadPreparado}" styleClass="inputText">
                            ...
                            <h:outputText value="::" styleClass="outputTextBold"/>
                            <h:selectBooleanCheckbox value="#{ManagedFormasFarmaceuticasActividadesPreparado.subProcesoFormasFarmaceuticasActividadesPreparadoAgregar.necesitaMateriales}"/>
                            <h:outputText value="Descripción" styleClass="outputTextBold"/>
                            <h:outputText value="::" styleClass="outputTextBold"/>
                            <h:inputTextarea value="#{ManagedFormasFarmaceuticasActividadesPreparado.subProcesoFormasFarmaceuticasActividadesPreparadoAgregar.descripcion}" styleClass="inputText" style="width:300px"/>
                        </h:panelGrid>
                    ...
                    <rich:panel headerClass="headerClassACliente">
                        ...
                        <div align="center"  style="width:80%;height:250px; overflow:auto;text-align:center">
                            <rich:dataTable value="#{ManagedFormasFarmaceuticasActividadesPreparado.subProcesoFormasFarmaceuticasActividadesPreparadoAgregar.maquinariasList}"
                                    var="data"
                                    id="dataMaquinaria"
                     ...
                     <rich:panel headerClass="headerClassACliente">
                        <f:facet name="header">
                         ...
                         <rich:dataTable value="#{ManagedFormasFarmaceuticasActividadesPreparado.subProcesoFormasFarmaceuticasActividadesPreparadoAgregar.especificacionesProcesosList}"
                                    var="data"
                    ...
                    <br>
                    <a4j:commandButton value="Guardar" action="#{ManagedFormasFarmaceuticasActividadesPreparado.guardarAgregarSubProcesoFormaFarActividad_action}" styleClass="btn"
                                       oncomplete="if(#{ManagedFormasFarmaceuticasActividadesPreparado.mensaje eq 1}){alert('se registro la actividad');window.location.href='navegadorSubProcesosFormaFar.jsf?date='+(new Date()).getTime().toString();}else{alert('#{ManagedFormasFarmaceuticasActividadesPreparado.mensaje}')}"/>
                    <a4j:commandButton value="Cancelar" styleClass="btn" oncomplete="window.location.href='navegadorSubProcesosFormaFar.jsf?date='+(new Date()).getTime().toString();" />
