        ...
        <head>
            ...
            function valNumero()
            {
                ...
                function verificarAutorizacion()
                {
                    ...
                    {*/
alert('cdcd');
                        window.location.href='editarVersionConcentracion.jsf?cod='+cod+"&al="+Math.random();
        ...
        <body >    
            <div style="text-align:center">
                <a4j:form id="form1"  >
                <h:outputText value="#{ManagedEspecificacionesControlCalidad.cargarVersionesConcentracionProducto}"/>
                        ...
                        <f:facet name="header">
                            <rich:columnGroup>
                                <rich:column colspan="7" >
                                    <h:outputText value="Versiones Concentracion" style='font-weight:bold;font-size:14px' />
                                </rich:column>
                         ...
                         <rich:column styleClass="#{data.versionActiva?'versionActiva':''}">
                            ...
                            <h:selectBooleanCheckbox value="#{data.checked}" rendered="#{data.versionActiva}" />
                ...
                <div style="margin-top:12px;">
                    <a4j:commandButton  value="Agregar" action="#{ManagedEspecificacionesControlCalidad.agregarNuevaVersionConcentracion_action}" styleClass="btn"/>
                    <a4j:commandButton onclick="if(!verificarAccionRegistro('form1:dataVersionesFisicas')){return false;}" action="#{ManagedEspecificacionesControlCalidad.editarVersionConcentracionProducto_action}"
                    oncomplete="var a=Math.random();window.location.href='editarVersionConcentracion.jsf?cod='+a;"  value="Editar Version" styleClass="btn" /><%--Richfaces.showModalPanel('panelAutorizacion'); reRender="contenidoAutorizacion"--%>
                ...
                <rich:modalPanel id="panelAutorizacionElimnar" minHeight="140"  minWidth="370"
                                ...
                                <h:panelGroup id="contenidoAutorizacionEliminar">
                                    ...
                                    <a4j:commandButton styleClass="btn" onclick="if(!verificarAutorizacionActivar()){return false;}" value="Activar Version" action="#{ManagedEspecificacionesControlCalidad.activarVersionConcentracionProducto_ation}"
