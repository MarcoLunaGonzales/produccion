    ...
    <html>
            ...
            function valNumero()
            {
                ...
                function verificarAutorizacion()
                {
                    ...
                    if(cod==document.getElementById("formRegistrar:autorizacion").value)
                    {
                        ...
                        window.location.href='editarVersionAnalisisFisico.jsf?cod='+cod+"&al="+Math.random();
                    }
                    else
                    {
        ...
        <body >    
            <div style="text-align:center">
                <h:outputText value="#{ManagedEspecificacionesControlCalidad.cargarVersionesFisicas}"/>
                <h:form id="form1"  >
                        ...
                        <f:facet name="header">
                            <rich:columnGroup>
                                <rich:column colspan="7" >
                                    <h:outputText value="Versiones Especificaciones Fisicas" style='font-weight:bold;font-size:14px' />
                                </rich:column>
                ...
                <div style="margin-top:12px;">
                    <a4j:commandButton  value="Agregar" action="#{ManagedEspecificacionesControlCalidad.agregarNuevaVersionFisica_action}" styleClass="btn"/>
                    <a4j:commandButton action="#{ManagedEspecificacionesControlCalidad.editarVersionEspecificacionFisicaProducto_action}" onclick="if(!verificarAccionRegistro('form1:dataVersionesFisicas')){return false;}"
                ...
                <rich:modalPanel id="panelAutorizacionElimnar" minHeight="140"  minWidth="370"
                                ...
                                <h:panelGroup id="contenidoAutorizacionEliminar">
                                    ...
                                    <a4j:commandButton styleClass="btn" onclick="if(!verificarAutorizacionActivar()){return false;}" value="Activar Version" action="#{ManagedEspecificacionesControlCalidad.activarVersionEspecificacionFisicaProducto_ation}"
