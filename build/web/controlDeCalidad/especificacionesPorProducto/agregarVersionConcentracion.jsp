    ...
    <html>
        ...
        <body >    
            <div style="text-align:center">                            
                <a4j:form id="form1"  >
                    <h:outputText value="#{ManagedEspecificacionesControlCalidad.cargarAgregarVersionConcentracionMaterialesProd}"/>
                    ...
                    <rich:panel headerClass="headerClassACliente" style="width:80%">
                            ...
                            <h:panelGrid columns="3">
                               ...
                               <h:outputText value=" : " styleClass="outputText2" style="font-weight:bold"/>
                               <h:outputText value="#{ManagedEspecificacionesControlCalidad.versionConcentracionProducto.observacion}" styleClass="outputText2"/>
                            </h:panelGrid>
                    </rich:panel>
                    <rich:panel headerClass="headerClassACliente" style="width:80%">
                            <f:facet name="header">
                   ...
                   <br>
                    ...
                    <a4j:commandButton value="Guardar" styleClass="btn" action="#{ManagedEspecificacionesControlCalidad.guardarNuevaVersionConcentracion_action}"
                    oncomplete="if(#{ManagedEspecificacionesControlCalidad.mensaje eq '1'}){alert('Se registro la nueva version ');var a =Math.random();window.location.href='navegador_componentesProducto.jsf?ad='+a;}
                    else{alert('#{ManagedEspecificacionesControlCalidad.mensaje}');}"/>
                    <a4j:commandButton value="Cancelar"  styleClass="btn" onclick="window.location.href='navegador_componentesProducto.jsf'"/>
                    </div>            
                </a4j:form>
