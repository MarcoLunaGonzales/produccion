    ...
    <html>
        ...
        <body >    
            <div style="text-align:center">                            
                <a4j:form id="form1"  >
                    <h:outputText value="#{ManagedEspecificacionesControlCalidad.cargarAgregarAnalisisQuimico}"/>
                   ...
                   <br>
                       <a4j:commandButton styleClass="btn" value="Materiales Principio Activo"
                        ...
                        oncomplete="if(#{ManagedEspecificacionesControlCalidad.mensaje eq '1'}){Richfaces.showModalPanel('ajaxLoadingModalBox',{width:100, top:100});window.location='navegador_componentesProducto.jsf';alert('Se registraron las especificaciones quimicas para el producto');}
                        else{alert('#{ManagedEspecificacionesControlCalidad.mensaje}')}" timeout="10000"/>
                        <h:commandButton value="Cancelar"  styleClass="btn" action="#{ManagedEspecificacionesControlCalidad.cancelar}"/>
                    </div>            
                </a4j:form>
