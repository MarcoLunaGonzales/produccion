            ...
            <div style="text-align:center">
                ...
                <rich:panel headerClass="headerClassACliente" style="width:60%">
                    ...
                    <rich:panel headerClass="headerClassACliente" style="width:80%">
                            ...
                            <h:panelGrid columns="3">
                               ...
                               <h:outputText value=" : " styleClass="outputText2" style="font-weight:bold"/>
                               <h:outputText value="#{ManagedEspecificacionesControlCalidad.versionEspecificacionesProductoFisico.observacion}" styleClass="outputText2"/>
                            </h:panelGrid>
                    </rich:panel>
                    <rich:panel headerClass="headerClassACliente" style="width:80%">
                            <f:facet name="header">
                ...
                <br>
                    ...
                    <rich:dataTable value="#{ManagedEspecificacionesControlCalidad.listaEspecificacionesFisicasProducto}" var="data" id="dataEspecificacionesFisicas"
                        ...
                        <a4j:commandButton value="Guardar" styleClass="btn" action="#{ManagedEspecificacionesControlCalidad.guardarVersionAnalisisFisico_Action}"
                        timeout="7200" oncomplete="if(#{ManagedEspecificacionesControlCalidad.mensaje eq '1'}){Richfaces.showModalPanel('ajaxLoadingModalBox',{width:100, top:100});var a=Math.random();window.location.href='navegadorVersionesAnalisisFisico.jsf?a='+a;alert('Se registraron las especificaciones fisicas para el producto');}
