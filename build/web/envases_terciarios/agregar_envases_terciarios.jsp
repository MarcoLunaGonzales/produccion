...
<f:view>
    <html>
        ...
        <body>
            ...
            <h:form id="form1"  >                
                <div align="center"><br>
                    <h:outputText value="Registrar Envase Terciario" styleClass="tituloCabezera1"    />
                    ...
                    <br>
                    <h:commandButton value="Guardar" styleClass="commandButton"  action="#{ManagedEnvasesTerciarios.saveEnvasesTerciarios}" onclick="return validar();" />
