                    ...
                    try{
                        ...
                        while(result1.next())
                        {
                         ...
                         while(result2.next())
                         {
                             ...
                             String consulta3="select spp.FECHA_INICIO,spp.FECHA_FINAL, p.AP_PATERNO_PERSONAL,p.AP_MATERNO_PERSONAL,p.NOMBRE_PILA,spp.HORAS_HOMBRE,spp.UNIDADES_PRODUCIDAS,ISNULL(spp.HORAS_EXTRA,0) AS HORAS_EXTRA,ISNULL(spp.UNIDADES_PRODUCIDAS_EXTRA,0) AS UNIDADES_PRODUCIDAS_EXTRA ";
                             ...
                             consulta3+=" order by spp.FECHA_INICIO";
                                   ...
                                   result3.absolute(0);
                                    ...
                                    <tr class="outputTextNormal">
                                        <th rowspan="<%=filas%>" class="outputTextNormal" style="border : solid #D8D8D8 1px"><%=nombreActividad%></th>
                                            ...
                                            if(result3.next())
                                            {
                                                if(result3.getString("FECHA_INICIO")!=null)
                                                {
                                                    ...
                                                    horaInicio1=horas.format(result3.getTimestamp("FECHA_INICIO"));
                                                }
                                                else
                                                    {
                                                    fechaInicio1="";
                                                ...
                                                if(result3.getString("FECHA_FINAL")!=null)
                                                {
                                                    ...
                                                    horaFinal1=horas.format(result3.getTimestamp("FECHA_FINAL"));
                                                }
                                                else
                                                    {
                                                    fechaFinal1="";
                                                ...
                                                %>
                                                    <th class="outputTextNormal" style="border : solid #D8D8D8 1px"><%=fechaInicio1%>&nbsp;<br><%=horaInicio1%></br></th>
                                                    <th class="outputTextNormal" style="border : solid #D8D8D8 1px"><%=fechaFinal1%>&nbsp;<br><%=horaFinal1%></br></th>
                                                    ...
                                                    <th class="outputTextNormal" style="border : solid #D8D8D8 1px"><%=horaspersonal%></th>
                                                     <th class="outputTextNormal" style="border : solid #D8D8D8 1px"><%=unidadesprod%></th>
                                                      ...
                                                      <th class="outputTextNormal" style="border : solid #D8D8D8 1px"><%=result3.getDouble("HORAS_EXTRA")%></th>
                                                     <th class="outputTextNormal" style="border : solid #D8D8D8 1px"><%=result3.getDouble("UNIDADES_PRODUCIDAS_EXTRA")%></th>
                                                <%
                                        ...
                                        while(result3.next())
                                        {
                                            ...
                                            %>
                                             <tr>
                                               <th class="outputTextNormal" style="border : solid #D8D8D8 1px" title="Fecha Inicio" ><%=fechaInicio1%>&nbsp;<br><%=horaInicio1%></br></th>
                                                    <th class="outputTextNormal" style="border : solid #D8D8D8 1px" title="Fecha Final"><%=fechaFinal1%>&nbsp;<br><%=horaFinal1%></br></th>
                                             <th class="outputTextNormal" style="border : solid #D8D8D8 1px" title="Operario"><%=nombrePersonal%></th>
                                               <th class="outputTextNormal" style="border : solid #D8D8D8 1px" title="Horas Hombre Personal"><%=horaspersonal%></th>
                                                     <th class="outputTextNormal" style="border : solid #D8D8D8 1px" title="Cantidad Producida Personal"><%=unidadesprod%></th>
                                                      <th class="outputTextNormal" style="border : solid #D8D8D8 1px" title="Productividad Personal"><%=formato.format(productividad)%></th>
                                                    <th class="outputTextNormal" style="border : solid #D8D8D8 1px" title="Horas Extra Personal"><%=result3.getDouble("HORAS_EXTRA")%></th>
                                                     <th class="outputTextNormal" style="border : solid #D8D8D8 1px" title="Unidades Producidas Horas Extra"><%=result3.getDouble("UNIDADES_PRODUCIDAS_EXTRA")%></th>
                                            ...
                                            <%
                                            horasExtra+=result3.getDouble("UNIDADES_PRODUCIDAS_EXTRA");
                                            unidadesExtra+=result3.getDouble("UNIDADES_PRODUCIDAS_EXTRA");
                                        }
                                        %>
                                    <%
