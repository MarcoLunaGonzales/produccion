...
<html>
    <head>
       ...
       //sacar el valor del multiple
        ...
        f.action="reporteProgramaProduccionEstados.jsf";
        f.submit();
            }
        ...
        <form method="post" action="reporteProgramaProduccionEstados.jsp" target="_blank" name="form1">
           ...
           try {
            ...
            ResultSet rs = st.executeQuery(sql);
                        %>
                        <td class="">
                            <select name="codProgramaProdPeriodo" id="codProgramaProdPeriodo" class="outputText3"  multiple="true" style="height:200px"> <%-- onchange="ajaxArea(form1);" --%>
                                <%
