...
<html>
  ...
  function verReporteDiferenciaFechas(f){
        ...
        f.action="reporteFechasCCAcondApt.jsf";
    ...
    <body><br><br>
        <h3 align="center">Reporte de Comparacion de Fechas de CC,Acond y APT</h3>
           ...
           String sql = "SELECT PP.COD_PROGRAMA_PROD,PP.NOMBRE_PROGRAMA_PROD,PP.OBSERVACIONES";
            ...
            ResultSet res = st.executeQuery(sql);
                    ...
                    <tr class="outputText3" >
                        ...
                        <td class="">
                            <select name="codComprod" id="codComprod" class="outputText3" >
                                <option value="0">--TODOS--</option>
                            <%
                            sql="select cp.COD_COMPPROD,cp.nombre_prod_semiterminado from COMPONENTES_PROD cp where cp.COD_TIPO_PRODUCCION=1 order by cp.nombre_prod_semiterminado";
