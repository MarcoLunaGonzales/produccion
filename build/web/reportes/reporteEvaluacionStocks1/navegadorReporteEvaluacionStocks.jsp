    ...
    <body>
        ...
        <form>
            ...
            <table  align="center" width="90%" class="outputText2" style="border : solid #f2f2f2 1px;" cellpadding="0" cellspacing="0">
                ...
                <%
                try{
                String consulta = " SELECT top 1 M.COD_MATERIAL, M.NOMBRE_MATERIAL FROM MATERIALES M  WHERE M.COD_ESTADO_REGISTRO =1 AND M.COD_GRUPO = "+codGrupo+" "; //AND M.COD_MATERIAL IN (38,117,130,134,137,151,168,169,172,177,200,204,5014)
