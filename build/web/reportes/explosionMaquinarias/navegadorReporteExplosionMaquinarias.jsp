        ...
        <form>
            ...
            <table  align="center" width="60%" class="outputText2" style="border : solid #f2f2f2 1px;" cellpadding="0" cellspacing="0">
                ...
                <tr class="tablaFiltroReporte">
                    ...
                    <td  align="center" class="bordeNegroTd"><b>Dias Habiles</b></td>
                    <td  align="center" class="bordeNegroTd"><b>Dias Mes</b></td>
                    <td  align="center" class="bordeNegroTd"><b>Horas Habiles</b></td>
                    <td  align="center" class="bordeNegroTd"><b>Horas Mes</b></td>
                    <td  align="center" class="bordeNegroTd"><b>Nro de Turnos a cumplir</b></td>
                    <td  align="center" class="bordeNegroTd"><b>Nro de Turnos a cumplir del mes</b></td>
                </tr>
                ...
                while (rs.next()){
                    ...
                    out.print("<td class='bordeNegroTd' align='left'>"+format.format(diasHabiles)+"</td>");
                    out.print("<td class='bordeNegroTd' align='left'>"+format.format(diasMes)+"</td>");
                    ...
                    out.print("<td class='bordeNegroTd' align='left'></td>");
                    out.print("<td class='bordeNegroTd' align='left'>"+format.format(diasHabilesTotal)+"</td>");
                    out.print("<td class='bordeNegroTd' align='left'>"+format.format(diasMesTotal)+"</td>");
