   ...
   String cantidadExtraProceso,String sopap,String sopam,String soct,String soctm)
{
      ...
      resultado.append("<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>").append(sumaCantidadProceso).append("</b></th>");
      resultado.append("<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>").append(rendimiento1).append("</b></th>");
                ...
                <tr class="">
                    ...
                    try{
                      ...
                      StringBuilder consulta=new StringBuilder("select pp.COD_LOTE_PRODUCCION,pp.COD_COMPPROD,ae.COD_AREA_EMPRESA,");
                                                    ...
                                                    consulta.append(" ae.NOMBRE_AREA_EMPRESA,ap.NOMBRE_ACTIVIDAD +' '+ISNULL('('+tpp1.ABREVIATURA+')','') as NOMBRE_ACTIVIDAD,spp.HORAS_HOMBRE AS HORAS_HOMBRE_ACTIVIDAD," );
                                                ...
                                                consulta.append(" from PROGRAMA_PRODUCCION pp");
                                                    ...
                                                    consulta.append(" left outer join personal_temporal pt on pt.cod_personal = sppp.cod_personal ")
                                                            .append(" left outer join TIPOS_PROGRAMA_PRODUCCION tpp1 on tpp1.COD_TIPO_PROGRAMA_PROD = afm.COD_TIPO_PROGRAMA_PROD");
                                                ...
                                                consulta.append(" order by pp.COD_LOTE_PRODUCCION,pp.COD_COMPPROD,pp.COD_TIPO_PROGRAMA_PROD,case when afm.COD_AREA_EMPRESA =76 then 1 when afm.COD_AREA_EMPRESA =97 then 2");
                                                    ...
                                                    consulta.append(" when afm.COD_AREA_EMPRESA =102 then 9 else 10 END,afm.ORDEN_ACTIVIDAD,afm.COD_ACTIVIDAD_FORMULA,sppp.FECHA_INICIO,spp.FECHA_FINAL,p.AP_MATERNO_PERSONAL,p.AP_PATERNO_PERSONAL,p.NOMBRES_PERSONAL");
