...
" and cast(ra.COD_COMPROD as varchar)+'$'+ra.COD_LOTE not in(select cast(isnull(cpc.COD_COMPPROD,0) as varchar)+'$'+cpc.LOTE from CERTIFICADOS_PDF_CCC cpc)";
if(!lote.equals(""))
    {
...
while(rs.next())
{
    out.println("<tr>" +
            ...
            "<td style='border-bottom: solid #666666 1px; border-left: solid #666666 1px;;padding:5px' bgcolor='#f2f2f2' class='outputText2'><input type='hidden' value='"+rs.getString("COD_PROD")+"'/>"+sdf.format(rs.getTimestamp("FECHA_VENC"))+"</td>" +
...
System.out.println("certificados pdf "+consulta);
