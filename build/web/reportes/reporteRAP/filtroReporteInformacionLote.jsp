...
<html>
    <head>
        ...
        function onchangeCodEstadoProgramaProd()
        {
            ...
            if(parseInt(document.getElementById("codEstadoProgramaProd").value)==6||parseInt(document.getElementById("codEstadoProgramaProd").value)==7)
        ...
        {
            document.getElementById("inputCheckFechaCambio").checked=false;
            document.getElementById("codEstadoProgramaProd").value=2;
        }
        </script>
                    ...
                    <tbody>
                        ...
                        <tr class="outputText3">
                            ...
                            <td class="">
                                ...
                                <%
                                    consulta = new StringBuilder("select e.COD_ESTADO_PROGRAMA_PROD,e.NOMBRE_ESTADO_PROGRAMA_PROD");
                                                    consulta.append(" from ESTADOS_PROGRAMA_PRODUCCION e where e.COD_ESTADO_PROGRAMA_PROD NOT IN (3,9,4)");
                                    res= st.executeQuery(consulta.toString());
                                    while(res.next()) 
                                    {
                                        out.print("<option value="+res.getInt("COD_ESTADO_PROGRAMA_PROD")+">"+res.getString("NOMBRE_ESTADO_PROGRAMA_PROD")+"</option>");
                                    }
                                }
