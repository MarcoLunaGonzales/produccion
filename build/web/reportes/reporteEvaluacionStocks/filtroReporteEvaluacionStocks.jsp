        ...
        try {
            ...
            ResultSet rs = st.executeQuery(sql);
                    ...
                    <tr class="outputText3">
                        ...
                        <td>&nbsp;&nbsp;<b>::</b>&nbsp;&nbsp;</td>
                        <td>
                            <input type="text" class="outputText3" size="16"  value="<%=fechaActual%>" name="fechaRegistro" id="fechaRegistro" >
                            ...
                            <DLCALENDAR tool_tip="Seleccione la Fecha"
                                        ...
                                        input_element_id="fechaRegistro" click_element_id="imagenFecha2">
                            </DLCALENDAR>
