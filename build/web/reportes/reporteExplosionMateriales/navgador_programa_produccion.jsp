...
<html>
    ...
    <body>
        ...
        <form method="post" action="navegador_programa_produccion.jsf"  name="form1">
            <br>
            <div align="center">
                <%
        try {
                ...
                <table border="0" class="outputText2"  style="border:1px solid #000000"  width="95%" cellspacing="0" cellpadding="2" id="navegador">
                    ...
                    <tr>
                        <h2>
                            ...
                            <td>
                                &nbsp;&nbsp;<a onclick="enviarForm(form1)" href="navegador_programa_produccion.jsf?codProgramaProd=<%=COD_PROGRAMA_PROD%>&codTiposMaterial=<%=codTiposMaterial%>&codTodoTipoMaterial=<%=codTodoTipoMaterial%>" title="Click para ingresasar"><%=NOMBRE_PROGRAMA_PROD%></a>
                            </td>
