    ...
    <html>
        ...
        <body>
            ...
            <h:form id="form1"  >                
                <div align="center">
                    <br>
                     <h:outputText value="Registrar Tipo de Mercadería" styleClass="tituloCabezera1" />     
                    <br><br>
                    ...
                    <h:commandButton value="Guardar" styleClass="commandButton"  action="#{ManagedTiposmercaderia.saveTipoMercaderia}" onclick="return validar()" />
