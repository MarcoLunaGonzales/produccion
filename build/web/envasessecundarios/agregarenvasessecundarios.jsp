...
<f:view>
    <html>
        ...
        <body>
            ...
            <h:form id="form1"  >                
                <div align="center"><br>
                    <h:outputText value="Registrar Envase Secundario" styleClass="tituloCabezera1"    />
                    ...
                    <h:panelGrid columns="3" styleClass="navegadorTabla" headerClass="headerClassACliente" style="border:1px solid #0A5B99;">
                        ...
                        <h:inputText  styleClass="inputText" id="nombre" size="40"  onkeypress="valMAY();" value="#{ManagedEnvasessecundarios.envasesSecundarios.nombreEnvaseSec}" style='text-transform:uppercase;'/>
                    ...
                    <br>
                    <h:commandButton value="Guardar" styleClass="commandButton"  action="#{ManagedEnvasessecundarios.saveEnvasesSecundarios}" onclick="return validar();" />
