    ...
    <html>
        ...
        <body>
            <h:form id="form1"  >
                ...
                <div align="center">
                    <h:outputText value="#{ManagedVersionesFormulaMaestra.cargarEditarPresentacionPrimaria}"/>
                    <rich:panel headerClass="headerClassACliente" style="width:60%;margin-top:0.3em">
                        ...
                        <rich:panel headerClass="headerClassACliente" style="width:60%;margin-top:0.3em">
                            ...
                            <h:panelGrid columns="3">
                                ...
                                <h:selectOneMenu value="#{ManagedVersionesFormulaMaestra.presentacionesPrimariasEditar.tiposProgramaProduccion.codTipoProgramaProd}" styleClass="inputText">
                                ...
                                <h:outputText value="::" styleClass="outputTextBold"/>
                                <h:selectOneMenu value="#{ManagedVersionesFormulaMaestra.presentacionesPrimariasEditar.envasesPrimarios.codEnvasePrim}" styleClass="inputText">
                                ...
                                <h:outputText value="::" styleClass="outputTextBold"/>
                                <h:inputText styleClass="inputText" id="cantidad" value="#{ManagedVersionesFormulaMaestra.presentacionesPrimariasEditar.cantidad}" onkeyup="calcularCantidadPresentaciones();" onkeypress="valNum(event)" />
                                <h:outputText value="Cantidad De Presentaciones" styleClass="outputTextBold"/>
                                <h:outputText value="::" styleClass="outputTextBold"/>
                                <h:outputText value="#{ManagedVersionesFormulaMaestra.formulaMaestraVersionaBean.componentesProd.tamanioLoteProduccion/ManagedVersionesFormulaMaestra.presentacionesPrimariasEditar.cantidad}" styleClass="outputText2" id="cantidadPresentaciones">
                                    <f:convertNumber pattern="####.##"/>
                                </h:outputText>
                            </h:panelGrid>
                        </rich:panel>

                    <rich:dataTable value="#{ManagedVersionesFormulaMaestra.presentacionesPrimariasEditar.formulaMaestraDetalleEPList}"
                    ...
                    <div id="bottonesAcccion" class="barraBotones" >
                        ...
                        action="#{ManagedVersionesFormulaMaestra.guardarEdicionFormulaMaestraDetalleEpVersion_action}"
                        oncomplete="if(#{ManagedVersionesFormulaMaestra.mensaje eq '1'}){alert('Se guardo la edicion de los materiales');redireccionar('navegadorFormulaMaestraEP.jsf');}
