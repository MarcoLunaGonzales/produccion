            ...
            <h:form id="form1"  >
                ...
                <div align="center">
                    ...
                    <div id="bottonesAcccion" class="barraBotones" >
                        ...
                        onclick="if(!validadRegistroCantidad()){return false;}" oncomplete="if(#{ManagedFormulaMaestraEsVersion.mensaje eq '1'}){alert('Se registro la edición la presentacion y materiales de empaque secundario para el producto');
