        ...
        <body >
            <h:form id="form1"  >
                <div align="center" >
                    ...
                    <rich:dataTable value="#{ManagedVersionesFormulaMaestra.formulaMaestraDetalleMPEditarList}"
                    ...
                    <div id="bottonesAcccion" class="barraBotones" >
                        <a4j:commandButton  value="Guardar" styleClass="btn"  action="#{ManagedVersionesFormulaMaestra.guardarEdicionFormulaMaestraDetalleMp_action}"
