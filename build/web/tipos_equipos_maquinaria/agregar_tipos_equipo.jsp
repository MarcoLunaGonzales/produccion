    ...
    <html>
        ...
        <body>
            ...
            <h:form id="form1"  >                
                <div align="center">
                    <br>
                    <h:outputText value="Registrar Tipo de Maquinaria" styleClass="tituloCabezera1" />     
                    <br><br>
                    <h:panelGrid columns="3" styleClass="navegadorTabla" headerClass="headerClassACliente" style="border:1px solid #0A5B99;">
                        ...
                        <h:outputText styleClass="outputText2" value="::"  />
                        <h:inputText  styleClass="inputText" size="40" disabled="true" value="ACTIVO"/>                                
                    </h:panelGrid>
                    <br> 
                    
                    <h:commandButton value="Guardar" styleClass="commandButton"  action="#{ManagedTiposEquipo.saveTipoEquipo}" onclick="return validar()" />
