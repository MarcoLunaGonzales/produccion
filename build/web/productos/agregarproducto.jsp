        ...
        <body>
            <h:form id="form1"  >
                <div align="center">
                    <br>
                    <br>
                    <h3>  <h:outputText value="Registrar Nombre Comercial" styleClass="tituloCabezera1" />     </h3>
                    <br>
                    <br>
                    <h:panelGrid columns="3" styleClass="navegadorTabla" headerClass="headerClassACliente" style="border:1px solid #0A5B99;">
                        ...
                        <h:outputText value="::" styleClass="outputText2"  />
                        <h:selectOneMenu styleClass="inputText" disabled="true" value="#{productos.productoBean.estadoProducto.codEstadoProducto}" >
                    ...
                    <br>
                    <h:commandButton styleClass="btn" value="Guardar"  action="#{productos.guardarProducto}" onclick="return validar();"  />
