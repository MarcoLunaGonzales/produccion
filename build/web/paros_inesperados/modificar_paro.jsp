    ...
    <html>
        ...
        <body>
            ...
            <h:form id="form1"  >                
                <div align="center">
                    <br>
                    <h:outputText value="Editar Paro Inesperado" styleClass="tituloCabezera1"    />
                    ...
                    <h:panelGrid columns="3" styleClass="panelgrid" headerClass="headerClassACliente">
                        ...
                        <h:outputText  styleClass="outputText2" value="::"/>                                
                        <h:selectOneMenu styleClass="inputText" value="#{ManagedParosInesperadosProd.parosInesperadosProdbean.estadoReferencial.codEstadoRegistro}" >
                            <f:selectItems value="#{ManagedParosInesperadosProd.estadoRegistro}"  />
                        </h:selectOneMenu>          
                    </h:panelGrid>
                    
                    <br>
                    <h:commandButton value="Guardar" styleClass="commandButton" action="#{ManagedParosInesperadosProd.modificarParoInesperado}"   onclick="return validar();" />
