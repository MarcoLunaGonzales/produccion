...
<f:view>
    ...
    <html>
        <head>
            ...
            <a4j:form id="form1">
                <div align="center">
                    <h:outputText value="#{ManagedProductosDesarrolloVersion.cargarEditarEspecificacionesMaquinariaProcesoProducto}"/>
                    ...
                    <br/>
                        <rich:panel headerClass="headerClassACliente" style="width:50%">
                            ...
                            <h:panelGrid columns="3" headerClass="headerClassACliente">
                                ...
                                <h:outputText value="::" styleClass="outputTextBold" />
                                <h:outputText value="#{ManagedProductosDesarrolloVersion.componentesProdVersionMaquinariaProceso.maquinaria.nombreMaquina}"   styleClass="outputText2"/>
                                <h:outputText value="Código Maquinaria" styleClass="outputTextBold"  />
                                <h:outputText value="::" styleClass="outputTextBold" />
                                <h:outputText value="#{ManagedProductosDesarrolloVersion.componentesProdVersionMaquinariaProceso.maquinaria.codigo}"   styleClass="outputText2"/>
                            </h:panelGrid>
                        </rich:panel>
                    
                    <rich:dataTable value="#{ManagedProductosDesarrolloVersion.componentesProdVersionMaquinariaProceso.especificacionesProcesosProductoMaquinariaList}"
                        ...
                        <f:facet name="header">
                            <rich:columnGroup>
                                ...
                                <rich:column rendered="#{ManagedProductosDesarrolloVersion.componentesProdVersionMaquinariaProceso.procesosOrdenManufactura.aplicaTipoEspecificacion}">
                        ...
                        <div id="bottonesAcccion" class="barraBotones">
                                <a4j:commandButton value="Guardar" styleClass="btn" action="#{ManagedProductosDesarrolloVersion.editarComponentesProdVersionMaquinariaProcesoAction()}"
