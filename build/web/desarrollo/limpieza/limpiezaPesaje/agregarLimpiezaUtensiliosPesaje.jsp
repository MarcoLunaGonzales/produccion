...
<f:view>
    ...
    <html>
        <head>
            ...
            <a4j:form id="form1">
                <div align="center">
                    <h:outputText value="#{ManagedProductosDesarrolloVersion.cargarAgregarLimpiezaUtensiliosPesaje}"/>
                    ...
                    <rich:dataTable value="#{ManagedProductosDesarrolloVersion.limpiezaUtensilioPesajeAgregarList}"
                        ...
                        <f:facet name="header">
                            <rich:columnGroup>
                               ...
                               <rich:column>
                                   <h:selectBooleanCheckbox value="#{data.checked}" id="checkMaquinaria" onchange="seleccionarRegistro(this)"/>
                                </rich:column>
                                <rich:column>
                                    <h:outputLabel value="#{data.maquinaria.nombreMaquina}" for="checkMaquinaria"/>
                                </rich:column>
                                <rich:column>
                        ...
                        <div id="bottonesAcccion" class="barraBotones">
                            <a4j:commandButton value="Guardar" styleClass="btn" action="#{ManagedProductosDesarrolloVersion.guardarLimpiezaUtensiliosPesajeAction()}"
                            ...
                            <a4j:commandButton value="Cancelar"  styleClass="btn" oncomplete="redireccionar('navegadorLimpiezaUtensiliosPesaje.jsf')"/>
                        </div>   
