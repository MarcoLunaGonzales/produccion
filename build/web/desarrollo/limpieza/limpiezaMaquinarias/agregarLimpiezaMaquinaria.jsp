...
<f:view>
    ...
    <html>
        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                    <h:outputText value="#{ManagedProductosDesarrolloVersion.cargarAgregarLimpiezaMaquinaria}"/>
                    ...
                    <rich:dataTable value="#{ManagedProductosDesarrolloVersion.limpiezaMaquinariaAgregarList}"
                        ...
                        <f:facet name="header">
                            <rich:columnGroup>
                               ...
                               <rich:column>
                                   <h:selectBooleanCheckbox value="#{data.checked}" id="checkMaquinaria"/>
                                </rich:column>
                                <rich:column>
                        ...
                        <div id="bottonesAcccion" class="barraBotones">
                            <a4j:commandButton value="Guardar" styleClass="btn" action="#{ManagedProductosDesarrolloVersion.guardarLimpiezaMaquinariaAction()}"
