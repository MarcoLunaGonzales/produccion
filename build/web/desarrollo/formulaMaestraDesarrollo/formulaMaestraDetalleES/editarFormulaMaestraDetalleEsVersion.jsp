...
<f:view>
    <html>
        ...
        <body >
            <h:form id="form1"  >
                <span class="outputTextTituloSistema">Edición de Presentación y Material de Empaque Secundario</span>
                <div align="center">
                    <h:outputText value="#{ManagedProductosDesarrolloVersion.cargarEditarComponentesPresProdVersionAction}"/>
                    <rich:panel headerClass="headerClassACliente" style="width:50%;margin-top:0.3em">
                        ...
                        <rich:panel headerClass="headerClassACliente" style="min-width:50%;max-width:90%" id="datosPresentacion">
                            ...
                            <h:panelGrid columns="3">
                                <h:outputText value="Presentación Producto" styleClass="outputTextBold" style="font-weight:bold"/>
                                <h:outputText value="::" styleClass="outputTextBold" style="font-weight:bold"/>
                                <h:outputText value="#{ManagedProductosDesarrolloVersion.componentesPresProdVersion.presentacionesProducto.nombreProductoPresentacion}" styleClass="outputText2"/>
                                <h:outputText value="Tipo Programa Produccion" styleClass="outputTextBold" />
                                <h:outputText value="::" styleClass="outputTextBold"/>
                                <h:outputText value="#{ManagedProductosDesarrolloVersion.componentesPresProdVersion.tiposProgramaProduccion.nombreTipoProgramaProd}" styleClass="outputText2"/>
                                <h:outputText value="Cantidad" styleClass="outputText2" style="font-weight:bold"/>
                                <h:outputText value="::" styleClass="outputText2" style="font-weight:bold"/>
                                <h:inputText value="#{ManagedProductosDesarrolloVersion.componentesPresProdVersion.cantCompProd}" styleClass="inputText" onblur="valorPorDefecto(this)" id="cantidadProducto"/>
                                <h:outputText value="Estado" styleClass="outputTextBold" />
                                <h:outputText value="::" styleClass="outputTextBold"/>
                                <h:selectOneMenu value="#{ManagedProductosDesarrolloVersion.componentesPresProdVersion.estadoReferencial.codEstadoRegistro}" styleClass="inputText">
                        ...
                        <rich:dataTable value="#{ManagedProductosDesarrolloVersion.componentesPresProdVersion.formulaMaestraDetalleESList}"  
                    ...
                    <div id="bottonesAcccion" class="barraBotones" >
                        <a4j:commandButton  value="Guardar" styleClass="btn"  action="#{ManagedProductosDesarrolloVersion.editarComponentesPresProdVersionAction}"
                        onclick="if(!validadRegistroCantidad()){return false;}"
                        oncomplete="if(#{ManagedProductosDesarrolloVersion.mensaje eq '1'}){alert('Se registro la presentación y materiales para el producto');
