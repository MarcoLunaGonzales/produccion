        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                    ...
                    <h:outputText value="#{ManagedProductosDesarrolloVersion.cargarEdicionProcesosPreparadoProducto}"/>
                    <rich:panel headerClass="headerClassACliente" style="width:70%">
                        ...
                        <h:panelGrid columns="3">
                            ...
                            <h:inputText value="#{ManagedProductosDesarrolloVersion.procesosPreparadoProducto.nroPaso}" styleClass="inputText" onblur="valorPorDefecto(this)"/>
                            ...
                            <h:outputText styleClass="outputTextBold" value="::"/>
                            <h:selectOneRadio styleClass="outputText2" value="#{ManagedProductosDesarrolloVersion.procesosPreparadoProducto.procesoSecuencial}">
                   ...
                   <rich:panel headerClass="headerClassACliente" style="width:70%">
                    ...
                    <br>
                    <a4j:commandButton value="Guardar" action="#{ManagedProductosDesarrolloVersion.editarProcesosPreparadoProductoAction}" styleClass="btn"
                                       oncomplete="mostrarMensajeTransaccionEvento(function(){redireccionar('navegadorProcesosPreparadoProducto.jsf');})"/>
