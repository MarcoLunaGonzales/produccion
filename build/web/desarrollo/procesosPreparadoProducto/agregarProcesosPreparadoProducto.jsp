        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                    ...
                    <h:outputText value="#{ManagedProductosDesarrolloVersion.cargarAgregarProcesosPreparadoProducto}"/>
                   ...
                   <rich:panel headerClass="headerClassACliente" style="width:70%">
                    ...
                    <br>
                    <a4j:commandButton value="Guardar" action="#{ManagedProductosDesarrolloVersion.guardarProcesosPreparadoProductoAction}" styleClass="btn"
