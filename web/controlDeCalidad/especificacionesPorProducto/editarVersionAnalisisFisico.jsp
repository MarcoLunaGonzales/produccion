    ...
    <html>
        ...
        <body >    
            <div style="text-align:center">
                <h:outputText value="#{ManagedEspecificacionesControlCalidad.cargarEditarVersionAnalisisFisico_action}"/>
                <h:form id="form1"  >
                <rich:panel headerClass="headerClassACliente" style="width:60%">
                    ...
                    <rich:panel headerClass="headerClassACliente" style="width:80%">
                            <f:facet name="header">
                                <h:outputText value="Datos de version"/>
                            </f:facet>
                            <h:panelGrid columns="3">
                                <h:outputText value="Nro Version" styleClass="outputText2" style="font-weight:bold"/>
                               <h:outputText value=" : " styleClass="outputText2" style="font-weight:bold"/>
                               <h:outputText value="#{ManagedEspecificacionesControlCalidad.versionEspecificacionesProductoFisico.nroVersionEspecificacionProducto}" styleClass="outputText2" />
                               <h:outputText value="Fecha Cargado" styleClass="outputText2" style="font-weight:bold"/>
                               <h:outputText value=" : " styleClass="outputText2" style="font-weight:bold"/>
                               <h:outputText value="#{ManagedEspecificacionesControlCalidad.versionEspecificacionesProductoFisico.fechaCreacion}" styleClass="outputText2">
                                   <f:convertDateTime pattern="dd/MM/yyyy HH:mm"/>
                                   </h:outputText>
                               <h:outputText value="Observacion" styleClass="outputText2" style="font-weight:bold"/>
                               <h:outputText value=" : " styleClass="outputText2" style="font-weight:bold"/>
                               <h:inputTextarea cols="60" value="#{ManagedEspecificacionesControlCalidad.versionEspecificacionesProductoFisico.observacion}" styleClass="inputText"/>
                ...
                <br>
                    ...
                    <rich:dataTable value="#{ManagedEspecificacionesControlCalidad.listaEspecificacionesFisicasProducto}" var="data" id="dataEspecificacionesFisicas"
                        ...
                        <a4j:commandButton value="Guardar" styleClass="btn" action="#{ManagedEspecificacionesControlCalidad.guardarEdicionVersionAnalisisFisico_Action}"
                        timeout="7200" oncomplete="if(#{ManagedEspecificacionesControlCalidad.mensaje eq '1'}){Richfaces.showModalPanel('ajaxLoadingModalBox',{width:100, top:100});var a=Math.random();window.location.href='navegadorVersionesAnalisisFisico.jsf?a='+a;alert('Se guardo la edicion de  las especificaciones fisicas para la version del producto');}
                        else{alert('#{ManagedEspecificacionesControlCalidad.mensaje}');}"/>
                        <a4j:commandButton value="Cancelar"  styleClass="btn" action="#{ManagedEspecificacionesControlCalidad.cancelar}"/>
                    </div>            
                </h:form>
