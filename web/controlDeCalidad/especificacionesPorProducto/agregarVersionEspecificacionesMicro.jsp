    ...
    <html>
        ...
        <body >    
            <div style="text-align:center">                            
                <h:form id="form1"  >
                    <h:outputText value="#{ManagedEspecificacionesControlCalidad.cargarAgregarVersionMicrobiologicaProducto}"/>
                    ...
                    <rich:panel headerClass="headerClassACliente" style="width:80%">
                            ...
                            <h:panelGrid columns="3">
                               ...
                               <h:outputText value=" : " styleClass="outputText2" style="font-weight:bold"/>
                               <h:outputText value="#{ManagedEspecificacionesControlCalidad.versionEspecificacionesProductoMicrobiologico.observacion}" styleClass="outputText2"/>
                            </h:panelGrid>
                    </rich:panel>
                    <rich:panel headerClass="headerClassACliente" style="width:80%">
                            <f:facet name="header">
                ...
                <br>
                    ...
                    <div style="text-align:center;margin-top:12px;">
                        <a4j:commandButton value="Guardar" styleClass="btn" action="#{ManagedEspecificacionesControlCalidad.guardarVersionAnalisisMicrobiologico_Action}"
                        oncomplete="if(#{ManagedEspecificacionesControlCalidad.mensaje eq '1'}){alert('Se registro la version de especificaciones microbiologicas'); var a=Math.random();window.location.href='navegadorVersionesAnalisisMicrobiologico.jsf?cod='+a;}
