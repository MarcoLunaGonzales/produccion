    ...
    <html>
            ...
            function valNumero()
            {
                ...
                function verificarAutorizacion()
                {
                    ...
                    if(cod==document.getElementById("formRegistrar:autorizacion").value)
                    {
                        ...
                        window.location.href='editarVersionEspecificacionesQuimicas.jsf?cod='+cod+"&al="+Math.random();
                    }
                    else
                    {
        ...
        <body >    
            <div style="text-align:center">
                <h:form id="form1"  >
                <h:outputText value="#{ManagedEspecificacionesControlCalidad.cargarVersionesQuimicasProducto}"/>
                        ...
                        <f:facet name="header">
                            <rich:columnGroup>
                                <rich:column colspan="7" >
                                    <h:outputText value="Versiones Especificaciones Quimicas" style='font-weight:bold;font-size:14px' />
                                </rich:column>
                ...
                <div style="margin-top:12px;">
                    <a4j:commandButton  value="Agregar" action="#{ManagedEspecificacionesControlCalidad.agregarNuevaVersionQuimica_action}" styleClass="btn"/>
                    <a4j:commandButton onclick="if(!verificarAccionRegistro('form1:dataVersionesFisicas')){return false;}" action="#{ManagedEspecificacionesControlCalidad.editarVersionEspecificacionQuimicaProducto_action}"
                    oncomplete="Richfaces.showModalPanel('panelAutorizacion');" value="Editar Version" styleClass="btn"  reRender="contenidoAutorizacion"/>
                ...
                <rich:modalPanel id="panelAutorizacionElimnar" minHeight="140"  minWidth="370"
                                ...
                                <h:panelGroup id="contenidoAutorizacionEliminar">
                                    ...
                                    <a4j:commandButton styleClass="btn" onclick="if(!verificarAutorizacionActivar()){return false;}" value="Activar Version" action="#{ManagedEspecificacionesControlCalidad.activarVersionEspecificacionQuimicaProducto_ation}"
