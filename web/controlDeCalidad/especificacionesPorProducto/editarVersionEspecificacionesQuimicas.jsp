    ...
    <html>
        ...
        <body >    
            <div style="text-align:center">                            
                <a4j:form id="form1"  >
                    <h:outputText value="#{ManagedEspecificacionesControlCalidad.cargarEditarVersionAnalisisQuimico}"/>
                  <rich:panel headerClass="headerClassACliente" style="width:60%">
                    ...
                    <rich:panel headerClass="headerClassACliente" style="width:80%">
                            ...
                            <h:panelGrid columns="3">
                               ...
                               <h:outputText value=" : " styleClass="outputText2" style="font-weight:bold"/>
                               <h:inputTextarea cols="60" value="#{ManagedEspecificacionesControlCalidad.versionEspecificacionesProductoQuimica.observacion}" styleClass="inputText"/>
                   ...
                   <br>
                    ...
                    <a4j:commandButton value="Guardar" styleClass="btn" action="#{ManagedEspecificacionesControlCalidad.guardarEdicionVersionAnalisisQuimico_Action}"
