                ...
                <div align="center">
                    ...
                    <table  class="table2"  >
                        ...
                        <tr>
                            ...
                            <td><h:outputText value="::" styleClass="outputText2"/></td>   
                            <td><h:selectOneMenu styleClass="inputText" value="#{ManagedFormasFarmaceuticas.formaFarmaceutica.estadoReferencial.codEstadoRegistro}" >
                                    <f:selectItems value="#{ManagedFormasFarmaceuticas.estadoRegistroList}"  />
                                </h:selectOneMenu>
                            </td>
                        </tr>                              
                    </table>   
                    <br>
                    <h:commandButton value="Guardar" styleClass="commandButton"  action="#{ManagedFormasFarmaceuticas.editFormasFarmaceuticas}" onclick="return validar();" />
                    <h:commandButton value="Cancelar"  styleClass="commandButton" action="#{ManagedFormasFarmaceuticas.actionCancelar}" />
