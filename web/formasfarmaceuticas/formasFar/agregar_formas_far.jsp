...
<f:view>
    <html>
        ...
        <body>
            ...
            <h:form id="form1"  >                
                <div align="center">
                     <h:outputText value="#{ManagedFormasFar.codigoCliente}" styleClass="outputText2" />
                    ...
                    <br>
                    <h:commandButton value="Guardar" styleClass="commandButton"  action="#{ManagedFormasFar.guardarFormasFar}" onclick="return validar();" />
