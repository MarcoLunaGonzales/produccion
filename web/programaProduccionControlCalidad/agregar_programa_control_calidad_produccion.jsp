    ...
    <html>
        <head>
            ...
            function openPopup(celda){
                ...
                url="reporteDetalleMaterialesReactivos1.jsf?al="+Math.random()+'&codFormula='+document.getElementById("form1:codFormulaMaestra").value+
                    "&codTipoMaterial=0"+
                    "&cantidadDisolucion=0"+
            ...
            {
                if(document.getElementById('form1:codFormulaMaestra').value=='')
                    {
                        alert('Debe seleccionar un programa de produccion para el registro');
                        return false;
                    }
        ...
        <body >
            <h:form id="form1"  >
                    ...
                    <center>
                        <h:outputText value="#{ManagedProgramaProduccionControlCalidad.cargarAgregarProgramaControlCalidad}"/>
                                 <rich:panel headerClass="headerClassACliente" style="width:50%;align:center">
                                        <f:facet name="header">
                                                <h:outputText value="Datos del Programa de Estabilidad"/>
                                        </f:facet>
                ...
                <rich:panel  headerClass="headerClassACliente"   style="width:70%;margin-top:12px">
                    <f:facet name="header">
                        <h:outputText value="Datos Analisis Estabilidad"/>
                    </f:facet>
                        <rich:panel headerClass="headerClassACliente" id="panelCabecera" style="width:70%;margin-top:12px">
                            ...
                            <h:panelGrid columns="6">
                                ...
                                <h:outputText value="::" styleClass="outputText2"style="font-weight:bold"/>
                                <h:outputText value="#{ManagedProgramaProduccionControlCalidad.programaProduccionControlCalidadAgregar.componentesProd.nombreProdSemiterminado}" styleClass="outputText2"/>
                                <h:outputText value="Lote" styleClass="outputText2" style="font-weight:bold;"/>
                                <h:outputText value="::" styleClass="outputText2"style="font-weight:bold"/>
                                <h:outputText value="#{ManagedProgramaProduccionControlCalidad.programaProduccionControlCalidadAgregar.codLoteProduccion}" styleClass="outputText2"/>
                                <h:outputText value="Tipo Programa Produccion" styleClass="outputText2" style="font-weight:bold"/>
                                <h:outputText value="::" styleClass="outputText2"style="font-weight:bold"/>
                                <h:outputText value="#{ManagedProgramaProduccionControlCalidad.programaProduccionControlCalidadAgregar.tiposProgramaProduccion.nombreTipoProgramaProd}" styleClass="outputText2"/>
                                
                                <h:outputText value="Cantidad Lote" styleClass="outputText2"  style="font-weight:bold;"/>
                                <h:outputText value="::" styleClass="outputText2"style="font-weight:bold"/>
                                <h:outputText value="#{ManagedProgramaProduccionControlCalidad.programaProduccionControlCalidadAgregar.cantLoteProduccion}" styleClass="outputText2"/>
                                <h:outputText value="Programa Produccion" styleClass="outputText2"  style="font-weight:bold;"/>
                                <h:outputText value="::" styleClass="outputText2"style="font-weight:bold"/>
                                <h:outputText value="#{ManagedProgramaProduccionControlCalidad.programaProduccionControlCalidadAgregar.programaProduccionPeriodoLoteProduccion.nombreProgramaProduccion}" styleClass="outputText2"/>
                           </h:panelGrid>
                           <h:inputHidden value="#{ManagedProgramaProduccionControlCalidad.programaProduccionControlCalidadAgregar.formulaMaestra.codFormulaMaestra}" id="codFormulaMaestra"/>
                        ...
                        <h:panelGrid columns="6">
                                ...
                                <h:outputText value="::" styleClass="outputText2"style="font-weight:bold"/>
                                <h:inputText onkeypress="valEnteros();" value="#{ManagedProgramaProduccionControlCalidad.programaProduccionControlCalidadAgregar.cantidadMuestras}" id="cantidadMuestras" styleClass="outputText2"/>
                                <h:outputText value="Almacen Muestra" styleClass="outputText2" style="font-weight:bold;margin-left:16px"/>
                                <h:outputText value="::" styleClass="outputText2"style="font-weight:bold"/>
                                 <h:selectOneMenu value="#{ManagedProgramaProduccionControlCalidad.programaProduccionControlCalidadAgregar.almacenesMuestra.codAlmacenMuestra}" styleClass="inputText" id="dataAlamacen" >
                                ...
                                <h:outputText value="::" styleClass="outputText2"style="font-weight:bold"/>
                                <h:selectOneMenu value="#{ManagedProgramaProduccionControlCalidad.programaProduccionControlCalidadAgregar.tiposEstudioEstabilidad.codTipoEstudioEstabilidad}" styleClass="inputText"  >
                                    ...
                                    <a4j:support action="#{ManagedProgramaProduccionControlCalidad.tipoEstudioEstabilidad_change}" event="onchange" reRender="tiempoEstudio,dataAnalisis"/>
                                </h:selectOneMenu>

                                <h:outputText value="Tiempo Estudio" styleClass="outputText2"  style="font-weight:bold;margin-left:16px"/>
                                <h:outputText value="::" styleClass="outputText2"style="font-weight:bold"/>
                                <h:outputText id="tiempoEstudio" value="#{ManagedProgramaProduccionControlCalidad.programaProduccionControlCalidadAgregar.tiempoEstudio}" styleClass="outputText2"/>
                           ...
                           <a4j:commandButton value="Generar Analisis" action="#{ManagedProgramaProduccionControlCalidad.generaraCronogramaAnalisis_action}" disabled="#{ManagedProgramaProduccionControlCalidad.programaProduccionControlCalidadAgregar.componentesProd.nombreProdSemiterminado eq ''}"
                           id="buttonReplace" styleClass="btn" reRender="dataAnalisis"/>
                 </rich:panel>
                 
                 <rich:dataTable value="#{ManagedProgramaProduccionControlCalidad.programaProduccionControlCalidadAnalisisAgregarList}" var="data" id="dataAnalisis"
                                    onRowMouseOut="this.style.backgroundColor='#FFFFFF';"
                                    onRowMouseOver="this.style.backgroundColor='#DDE3E4';"
                                    headerClass="headerClassACliente" style="margin-top:12px"
                                    binding= "#{ManagedProgramaProduccionControlCalidad.programaProduccionControlCalidadAnalisisDataTable}" >
                                        <rich:column>
                                            <f:facet name="header">
                    ...
                    <div style="margin-top:6px;">
                            <a4j:commandButton timeout="10000" value="Guardar" onclick="if(validarRegistro()==false){return false;}" styleClass="btn"  action="#{ManagedProgramaProduccionControlCalidad.guardarProgramaProduccionControl2_action}"
                    oncomplete="if(#{ManagedProgramaProduccionControlCalidad.mensaje eq '1'}){alert('Se registro el Programa Produccion de Control de Calidad');window.location='navegador_programa_produccion_control_calidad.jsf';}else{alert('#{ManagedProgramaProduccionControlCalidad.mensaje}')}" />
                                 ...
                                 <h:panelGroup id="contenidoSeleccionarProgramaProduccion">
                                     <rich:panel headerClass="headerClassACliente" style="widht:80%" >
                                        ...
                                        <h:panelGrid columns="7">
                                            ...
                                            <h:outputText value="::" styleClass="outputText2" style="font-weight:bold"/>
                                            <h:inputText id="loteProduccion" value="#{ManagedProgramaProduccionControlCalidad.programaProduccionBuscar.codLoteProduccion}" styleClass="inputText"/>
                                            <a4j:commandButton timeout="10000" onclick="if(valBuscador()==false){return false;}" value="Buscar" action="#{ManagedProgramaProduccionControlCalidad.buscarProgramaProduccionAgregarAction}"
                                    ...
                                    headerClass="headerClassACliente"  >
                                                ...
                                                <rich:column  >
                                                    ...
                                                    <a4j:commandLink timeout="10000" reRender="panelCabecera,buttonReplace" action="#{ManagedProgramaProduccionControlCalidad.seleccionarProgramaProduccion_action}"
        ...
        <rich:modalPanel id="panelMateriales"  minHeight="300"  minWidth="400"
                        ...
                        <a4j:form id="form1X">
                                 <h:panelGroup id="contenidoMateriales">
                                  ...
                                  <input type="button" value="Cancelar" class="btn" onclick="javascript:Richfaces.hideModalPanel('panelMateriales')" />
