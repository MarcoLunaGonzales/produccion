        ...
        <%--<body onLoad="window.defaultStatus='Hola, yo soy la barra de estado.';">--%>
            ...
            <a4j:form id="form1">
                <div align="center">
                    ...
                    <h:outputText value="#{ManagedProgramaProduccion.cargarSeguimientoProgramaProduccion1}"  />
                    ...
                    <br> <br>
                        ...
                        <rich:column rendered="#{ManagedProgramaProduccion.usuario.codAreaEmpresaGlobal=='80' || ManagedProgramaProduccion.usuario.codAreaEmpresaGlobal=='81' || ManagedProgramaProduccion.usuario.codAreaEmpresaGlobal=='82' || ManagedProgramaProduccion.usuario.codAreaEmpresaGlobal=='95'}">
                            ...
                            <h:commandLink action="#{ManagedProgramaProduccion.verActividadesProduccion_action1}" >
                        ...
                        <rich:column rendered="#{ManagedProgramaProduccion.usuario.codAreaEmpresaGlobal=='97' || ManagedProgramaProduccion.usuario.codAreaEmpresaGlobal=='82'}">
                            <f:facet name="header">
                        ...
                        <rich:column rendered="#{ManagedProgramaProduccion.usuario.codAreaEmpresaGlobal=='76'}">
                            <f:facet name="header">
                        ...
                        <rich:column rendered="#{ManagedProgramaProduccion.usuario.codAreaEmpresaGlobal=='84'}">
                            <f:facet name="header">
                        ...
                        <rich:column>
                            ...
                            <a4j:commandLink action="#{ManagedProgramaProduccion.verReporteEtiquetasAcond_action}" oncomplete="openPopup('reporteEtiquetasAcond.jsp')">
