        ...
        <form>
            ...
            <table width="90%" align="center" class='outputText0' style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                <tr class='bordeNegroTd'>
                    <th  class='bordeNegroTd'>Codigo<br>Producto</th>
                ...
                com.cofar.web.ManagedProgramaProduccion managedProgramaProduccion1 = new com.cofar.web.ManagedProgramaProduccion();
                try{
                    ...
                    while(rs.next()){
                        String codProgramaProd = rs.getString("cod_programa_prod");
                        ...
                        com.cofar.bean.ProgramaProduccion programaProduccion1 = new com.cofar.bean.ProgramaProduccion();
                        programaProduccion1.setCodProgramaProduccion(codProgramaProd);
                        ...
                        programaProduccion1.getFormulaMaestra().getComponentesProd().setVidaUtil(rs.getString("vida_util"));
                        fechaVencimiento = managedProgramaProduccion1.calculaFechaVencimiento(programaProduccion1);
                        ...
                        out.print("<tr >");
                        out.print("<td  class='bordeNegroTd' align='left'>"+rs.getInt("cod_compprod")+"</td>");
