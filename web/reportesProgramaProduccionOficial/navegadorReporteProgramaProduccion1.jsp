            ...
            <table width="90%" align="center" class='outputText0' style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                try{
                    String consulta = " select pp.cod_programa_prod,fm.cod_formula_maestra,pp.cod_lote_produccion, " +
                            ...
                            " cp.VIDA_UTIL,(select top 1 s.FECHA_INICIO from SEGUIMIENTO_PROGRAMA_PRODUCCION s where s.COD_PROGRAMA_PROD=pp.COD_PROGRAMA_PROD and s.COD_LOTE_PRODUCCION = pp.COD_LOTE_PRODUCCION " +
                            " and s.COD_COMPPROD = pp.COD_COMPPROD and s.COD_FORMULA_MAESTRA= pp.COD_FORMULA_MAESTRA " +
                            " and s.COD_ACTIVIDAD_PROGRAMA in ( select afm.COD_ACTIVIDAD_FORMULA from ACTIVIDADES_FORMULA_MAESTRA afm  " +
                            " where afm.COD_FORMULA_MAESTRA = s.COD_FORMULA_MAESTRA and afm.COD_ACTIVIDAD = 76 )  order by s.COD_SEGUIMIENTO_PROGRAMA desc ) fecha_inicio_pesaje," +
                            ...
                            " and s.COD_COMPPROD = pp.COD_COMPPROD and s.COD_FORMULA_MAESTRA= pp.COD_FORMULA_MAESTRA " +
                            " and s.COD_ACTIVIDAD_PROGRAMA in ( select afm.COD_ACTIVIDAD_FORMULA from ACTIVIDADES_FORMULA_MAESTRA afm  " +
                            " where afm.COD_FORMULA_MAESTRA = s.COD_FORMULA_MAESTRA and afm.COD_ACTIVIDAD = 76 )  order by s.COD_SEGUIMIENTO_PROGRAMA desc ) horas_hombre_pesaje," +
                            ...
                            " and s.COD_COMPPROD = pp.COD_COMPPROD and s.COD_FORMULA_MAESTRA= pp.COD_FORMULA_MAESTRA " +
                            " and s.COD_ACTIVIDAD_PROGRAMA in ( select afm.COD_ACTIVIDAD_FORMULA from ACTIVIDADES_FORMULA_MAESTRA afm  " +
                            " where afm.COD_FORMULA_MAESTRA = s.COD_FORMULA_MAESTRA and afm.COD_ACTIVIDAD = 76 )  order by s.COD_SEGUIMIENTO_PROGRAMA desc ) horas_maquina_pesaje  " +
                            ...
                            " and tp.COD_TIPO_PROGRAMA_PROD = pp.COD_TIPO_PROGRAMA_PROD and pp.cod_estado_programa in (2,5,6,7)  " +
                    ...
                    if(!fechaInicialP.equals("") && !fechaFinalP.equals("")){
                        ...
                        consulta = consulta + " and cast(pp.COD_PROGRAMA_PROD as varchar)+','+cast(pp.COD_COMPPROD as varchar)+','+CAST(pp.COD_FORMULA_MAESTRA as varchar)+','+pp.COD_LOTE_PRODUCCION in " +
                                ...
                                " on sppr.COD_ACTIVIDAD_PROGRAMA = afm.COD_ACTIVIDAD_FORMULA where afm.COD_ACTIVIDAD = 76 " +
                    ...
                    while(rs.next()){
                        ...
                        String horasMaquinaPesaje = rs.getString("horas_maquina_pesaje");
                         ...
                         out.print("<td class='bordeNegroTd' align='left'>"+format.format(cantLote)+"</td>");
                        ...
                        // out.print("<td class='bordeNegroTd' align='left'>"+(fechaFinal!=null?sdf.format(fechaFinal):"")+"</td>");
                         out.print("<td class='bordeNegroTd' align='left'>"+horasHombrePesaje+"</td>");
                         out.print("<td class='bordeNegroTd' align='left'>"+horasMaquinaPesaje+"</td>");
