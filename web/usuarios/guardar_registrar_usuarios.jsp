...
arraydecodigos[m]="";
    ...
    System.out.println("arraydecodigos.length:"+arraydecodigos.length);
    for(int i=0;i<=arraydecodigos.length-1;i++){
        try{
            System.out.println("arraydecodigos["+i+"]:"+arraydecodigos[i]);
    ...
    String sql="insert into usuarios_modulos(";
    
    sql+="cod_personal,cod_modulo,nombre_usuario,contrasena_usuario) values(";
    ...
    sql+="'"+usuario+"',";
    sql+="'"+contrasena+"')";
    System.out.println("Insertar usuario"+sql);
