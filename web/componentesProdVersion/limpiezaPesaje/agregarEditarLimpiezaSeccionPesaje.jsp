...
<f:view>
    ...
    <html>
        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                    <h:outputText value="#{ManagedComponentesProdVersion.cargarAgregarComponentesProdVersionLimpiezaPesaje}"/>
                    ...
                    <br/>
                        <rich:panel headerClass="headerClassACliente" style="width:50%">
                            ...
                            <h:panelGrid columns="3" headerClass="headerClassACliente">
                               ...
                               <h:outputText value=":" styleClass="outputText2" style="font-weight:bold"/>
                               <h:selectOneMenu value="#{ManagedComponentesProdVersion.componentesProdVersionLimpiezaPesaje.seccionesOrdenManufactura.codSeccionOrdenManufactura}" styleClass="inputText">
                                   <f:selectItems value="#{ManagedComponentesProdVersion.seccionesOrdenManufacturaSelectList}"/>
                               </h:selectOneMenu>
                            </h:panelGrid>
                        </rich:panel>
                    
                    <rich:dataTable value="#{ManagedComponentesProdVersion.componentesProdVersionLimpiezaPesaje.componentesProdVersionLimpiezaMaquinariaList}"
                        ...
                        <div id="bottonesAcccion" class="barraBotones">
                            <a4j:commandButton value="Guardar" styleClass="btn" action="#{ManagedComponentesProdVersion.guardarComponentesProdVersionLimpiezaPesajeAction}"
                            ...
                            <a4j:commandButton value="Cancelar"  styleClass="btn" oncomplete="window.location.href='navegadorLimpiezaPesaje.jsf?dontsave='+(new Date()).getTime().toString()"/>
                         </div>   
