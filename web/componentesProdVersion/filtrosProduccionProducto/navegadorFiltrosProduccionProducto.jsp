        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                    ...
                    <h:outputText styleClass="outputTextTituloSistema"   value="Filtros de Producción asociados al producto" />
                    <h:panelGroup id="contenido">
                        ...
                        <rich:dataTable value="#{ManagedComponentesProdVersion.componentesProdVersionFiltroProduccionList}"
                            ...
                            <f:facet name="header">
                                ...
                                <rich:column>
                                    <h:outputText value="#{data.filtrosProduccion.presionAprobación}"/>
                                </rich:column>
                                <rich:column>
                        ...
                        <div style='margin-top:1em'>
                            ...
                            <a4j:commandButton value="Eliminar" styleClass="btn" onclick="if(!editarItem('form1:dataFiltrosProduccion')){return false;}"
                                               ...
                                               oncomplete="if(#{ManagedComponentesProdVersion.mensaje eq '1'}){alert('Se elimino el filtro de producción');}else{alert('#{ManagedComponentesProdVersion.mensaje}');}"
