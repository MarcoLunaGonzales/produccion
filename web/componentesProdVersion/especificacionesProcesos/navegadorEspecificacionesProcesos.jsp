...
<f:view>
    <html>
        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                    <h:outputText value="#{ManagedComponentesProdVersion.cargarComponentesProdVersionEspecificacionProceso}"/>
                    ...
                    <rich:dataTable value="#{ManagedComponentesProdVersion.procesosOrdenManufacturaList}"
                                     ...
                                     <rich:dropDownMenu >
                                        ...
                                        <rich:menuItem  submitMode="none" iconClass="icon-pencil2" value="Editar" >
                                            <a4j:support event="onclick" oncomplete="redireccionar('agregarModificarEspecificacionesProcesos.jsf')" >
                                                <f:setPropertyActionListener target="#{ManagedComponentesProdVersion.procesoEspecificacionBean}"
                                                                             value="#{data}"/>
                                            </a4j:support>
                                        </rich:menuItem>
                                        <rich:menuItem  submitMode="none" iconClass="icon-cross" value="Eliminar" >
                                            <a4j:support event="onclick" reRender="dataEspecificacionesProcesos"
                                                         ...
                                                         action="#{ManagedComponentesProdVersion.eliminarComponentesProdVersionEspecificacionProceso_action(data.codProcesoOrdenManufactura)}" >
                                            </a4j:support>
                                        </rich:menuItem>
                                    </rich:dropDownMenu>
                                </rich:column>
                        ...
                        <div style='margin-top:1em'>
                            <a4j:commandButton value="Agregar" styleClass="btn" action="#{ManagedComponentesProdVersion.agregarComponentesProdVersionEspecificacionesProceso}"
