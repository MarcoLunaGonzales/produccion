...
<f:view>
    ...
    <html>
        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                    <h:outputText value="#{ManagedComponentesProdVersion.cargarAgregarEditarEspecificacionesProcesos}"/>
                    ...
                    <br/>
                        <rich:panel headerClass="headerClassACliente" style="width:50%">
                            ...
                            <h:panelGrid columns="3" headerClass="headerClassACliente" >
                                ...
                                <h:outputText value="#{ManagedComponentesProdVersion.procesoEspecificacionBean.nombreProcesoOrdenManufactura}"
                                              rendered="#{ManagedComponentesProdVersion.procesoEspecificacionBean.nombreProcesoOrdenManufactura ne ''}"
                                              styleClass="outputText2" />
                                <h:panelGroup rendered="#{ManagedComponentesProdVersion.procesoEspecificacionBean.nombreProcesoOrdenManufactura eq ''}">
                                    <h:selectOneMenu required="true" id="codProcesosOrdenManufactura" requiredMessage="Debe Seleccionar una opción" validatorMessage="Debe Seleccionar una opción"
                                            value="#{ManagedComponentesProdVersion.procesoEspecificacionBean.codProcesoOrdenManufactura}" >
                                            <f:selectItem itemLabel="--Seleccione una opción--" itemValue='0'/>
                                            <f:selectItems value="#{ManagedComponentesProdVersion.procesosOrdenManufaturaSelectList}"/>
                                            <a4j:support event="onchange" action="#{ManagedComponentesProdVersion.codProcesoOrdenManufacturaEspecificacion_change}" reRender="dataEspecificaciones"/>
                    ...
                    <rich:dataTable value="#{ManagedComponentesProdVersion.procesoEspecificacionBean.componentesProdVersionEspecificacionProcesoList}"
                            ...
                            <rich:columnGroup>
                                ...
                                <rich:column >
                                    <h:selectOneMenu value="#{data.tiposDescripcion.codTipoDescripcion}" styleClass="inputText">
                                            ...
                                            <a4j:support event="onchange" immediate="true" reRender="dataEspecificaciones">
                                                <a4j:actionparam name="type2" value="this.value" 
                                                        assignTo="#{data.tiposDescripcion.codTipoDescripcion}" 
                                                        noEscape="true"/>
                                            </a4j:support>
                                    </h:selectOneMenu>
                                </rich:column>
                        ...
                        <div style='margin-top:1em'>
                            <a4j:commandButton reRender="form1" value="Guardar" styleClass="btn" action="#{ManagedComponentesProdVersion.guardarAgregarEditarEspecificacionesProcesos_action}"
