    ...
    <rich:modalPanel id="panelMostrarConsumoMaterial" minHeight="320"  minWidth="720"
               ...
               <h:panelGroup id="contenidoMostrarConsumoMaterial">
                   <rich:panel headerClass="headerClassACliente">
                       ...
                       <center>
                           <h:panelGrid columns="6">
                               ...
                               <h:outputText styleClass="outputText2" value="#{ManagedProcesosPreparadoProducto.procesosPreparadoProductoMaterial.procesosPreparadoProductoPadre.nroPaso}.#{ManagedProcesosPreparadoProducto.procesosPreparadoProductoMaterial.nroPaso}"/>
                               <h:outputText styleClass="outputTextBold" value="Actividad"/>
                               <h:outputText styleClass="outputTextBold" value="::"/>
                               <h:outputText styleClass="outputText2" value="#{ManagedProcesosPreparadoProducto.procesosPreparadoProductoMaterial.actividadesPreparado.nombreActividadPreparado}"/>
                               <h:outputText styleClass="outputTextBold" value="Combinación Resultante" rendered="#{ManagedProcesosPreparadoProducto.sustanciaResultanteHabilitada}"/>
                               <h:outputText styleClass="outputTextBold" value="::" rendered="#{ManagedProcesosPreparadoProducto.sustanciaResultanteHabilitada}"/>
                               <h:inputText styleClass="inputText" value="#{ManagedProcesosPreparadoProducto.procesosPreparadoProductoMaterial.sustanciaResultante}" rendered="#{ManagedProcesosPreparadoProducto.sustanciaResultanteHabilitada}"/>
                           </h:panelGrid>
                       </center>
                   </rich:panel>
                   ...
                   <center>
                           ...
                           <tr>
                                <td colspan="3" style="width:50%">
                                    <div style="height:200px;overflow-y:auto;width:auto">
                                        <rich:dataTable value="#{ManagedProcesosPreparadoProducto.procesosPreparadoProductoConsumoList}"
                                            ...
                                            <rich:columnGroup styleClass="#{data.procesosPreparadoProducto.nroPaso eq 0?'':'noValido'}">
                                                <rich:column style="text-align:center">
                                                    <a4j:commandLink styleClass="btn"  reRender="contenidoMostrarConsumoMaterial"
                                                                     ...
                                                                     action="#{ManagedProcesosPreparadoProducto.agregarProcesoPreparadoProductoConsumoMaterialSeleccionado(data,false)}">
                                                ...
                                                <rich:column>
                                                    <a4j:commandLink styleClass="btn" reRender="contenidoMostrarConsumoMaterial"
                                                                     ...
                                                                     action="#{ManagedProcesosPreparadoProducto.agregarProcesoPreparadoProductoConsumoMaterialSeleccionado(data,true)}">
                                                        <h:outputText styleClass="icon-checkmark"/>
                                                    </a4j:commandLink>
                                                </rich:column>
                                            </rich:columnGroup>
                                ...
                                <td colspan="3" style="width:50%">
                                    <div style="height:200px;overflow-y:auto;width:auto">
                                        <rich:dataTable value="#{ManagedProcesosPreparadoProducto.procesosPreparadoProductoConsumoSeleccionadoList}"
                                                ...
                                                <rich:columnGroup styleClass="#{data.materialTransitorio?'materialTransitorio':''}">
                                                   ...
                                                   <rich:column>
                                                       <a4j:commandLink styleClass="btn" reRender="dataProcesosProductoSelecccionado" rendered="#{index>0}"
                                                                        action="#{ManagedProcesosPreparadoProducto.adicionarOrdenConsumoMaterialSeleccionado(index, -1)}">
                                                           <h:outputText styleClass="icon-arrow-up"/>
                                                       </a4j:commandLink>
                                                       <a4j:commandLink styleClass="btn" reRender="dataProcesosProductoSelecccionado" rendered="#{(index+1) ne ManagedProcesosPreparadoProducto.procesosPreparadoProductoConsumoSeleccionadoList.size()}"
                                                                         action="#{ManagedProcesosPreparadoProducto.adicionarOrdenConsumoMaterialSeleccionado(index,1)}">
                                                    ...
                                                    <rich:column>
                                                        <a4j:commandLink styleClass="btn" reRender="contenidoMostrarConsumoMaterial"
                                                                         action="#{ManagedProcesosPreparadoProducto.eliminarProcesoPreparadoProductoConsumoMaterialSeleccionado(data)}">
                    ...
                    <br/>
                    <div align="center">
                        <a4j:commandLink styleClass="btn"  action="#{ManagedProcesosPreparadoProducto.guardarProcesoPreparadoProductoConsumoMaterial_action}"
                                         reRender="form1"
