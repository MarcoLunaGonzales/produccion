                ...
                <div align="center">
                    ...
                    <h:outputText styleClass="outputTextTitulo"  value="Permisos Acceso Documento" />
                                 ...
                                 <h:panelGrid columns="6"  styleClass="navegadorTabla" headerClass="headerClassACliente" style="border:1px solid #0A5B99;" id="datosSolicitudMantenimiento">
                                        ...
                                        <h:outputText value="Nivel Organizacional" styleClass="outputText2" style="font-weight:bold"/>
                                        <h:outputText value="::" styleClass="outputText2" style="font-weight:bold"/>
                    ...
                    <br> <br>
                     ...
                     <a4j:commandButton value="Guardar" action="#{ManagedDocumentosBiblioteca.guardarPermisosPersonal_Action}"
                     oncomplete="if(#{ManagedDocumentosBiblioteca.mensaje eq '1'}){if(confirm('Se registraron los permisos,desea continuar?')==false){var a=Math.random();window.location.href='navegadorDocumentosBiblioteca.jsf?a='+a;}}
                     else{alert('#{ManagedDocumentosBiblioteca.mensaje}')}"
                     styleClass="btn"/>
                     <a4j:commandButton value="Cancelar" oncomplete="var a=Math.random();window.location.href='navegadorDocumentosBiblioteca.jsf?a='+a;"
                     styleClass="btn"/>
