...
<html>
    ...
    <body>
        ...
        for (int i = 0; i < tamanio; i++) {
            ...
            try {
                sql2 = " update programa_produccion_periodo set cod_estado_programa = '10' where cod_programa_prod = '"+codProgramaPeriodo+"'";
                System.out.println("sql2" + sql2);
                con = Util.openConnection(con);
                Statement st2 = con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                st2.executeUpdate(sql2); //int rs2 = 
...
<script language="JavaScript">
    location.href="navgador_programa_periodo.jsf";
</script>
