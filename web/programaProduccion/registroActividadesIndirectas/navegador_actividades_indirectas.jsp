    ...
    <html>
        <head>
           ...
           function getNumeroDehoras(fechaIni,fechaFin)
           {
            ...
            function registrarTiemposIndirectos(codProgramaProd,codActividadPrograma,codAreaEmpresa)
            {
                window.location.href='registroActividadesIndirectas.jsf?codProgramaProd='+codProgramaProd+
                                     '&codActividadPrograma='+codActividadPrograma+
                ...
                <div align="center">
                    ...
                    <br> <br>
                        ...
                        <rich:column>
                            ...
                            <a4j:commandLink styleClass="outputText2" onclick="registrarTiemposIndirectos('#{ManagedProgramaProduccion.programaProduccionPeriodoIndirectas.codProgramaProduccion}','#{data.actividadesProgramaProduccionIndirecto.actividadesProduccion.codActividad}','#{data.actividadesProgramaProduccionIndirecto.areasEmpresa.codAreaEmpresa}');"  timeout="10000" >
                    ...
                    <br>
                        <center><h:outputText value="#{ManagedProgramaProduccion.mensaje}" style="color:red;font-size:14px;" styleClass="outputText2" /></center>
                    <%--<h:commandButton value="Guardar" action="#{ManagedProgramaProduccion.guardarSeguimientoProd_action}"  styleClass="btn"  />--%>
                    <button class="btn" onclick="window.location.href='../navegador_seguimiento_programa_produccion.jsf'">Aceptar</button>
