    ...
    <html>
        ...
        <body>
            <h:form id="form1"  >                
                <div align="center">
                    <br>
                    <h:outputText value="Registrar Envase Primario" styleClass="tituloCabezera1"    />
                    ...
                    <h:panelGrid columns="3" styleClass="panelgrid" headerClass="headerClassACliente" style="border:1px solid #0A5B99;">
                        ...
                        <h:outputText styleClass="outputText2" value="::"  />
                        <h:inputText  styleClass="inputText"  size="52" value="ACTIVO"  disabled="true"/>
                    ...
                    <h:commandButton value="Guardar" styleClass="commandButton"   action="#{ManagedEnvasesPrimarios.saveEnvasesPrimarios}"  onclick="return validar();"  />
