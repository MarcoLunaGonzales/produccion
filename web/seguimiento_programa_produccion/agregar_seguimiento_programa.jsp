...
<div align="center">
    ...
    <br>
    <h:commandButton value="Guardar" styleClass="commandButton" action="#{ManagedActividadesProgramaproduccion.guardarActividadesFormulaMaestra}"   onclick="return validar();" />
