        ...
        <form name="form1" action="">
            ...
            for(int i=0; i<tamanio; i++){
                   ...
                   try {
                    ...
                    sql2=" delete from PERIODOS_EVALUACION_PROVEEDORES";
                    sql2+=" where COD_PERIODO_EVALUACION='"+cod_tipo_incentivo_regional+"'";
                    System.out.println("sql2"+sql2);
                    Statement st2=con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
                    int rs2=st2.executeUpdate(sql2);
                    
                    sql3=" delete from EVALUACION_PROVEEDORES_MATERIAL ";
                    sql3+=" where COD_PERIODO_EVALUACION='"+cod_tipo_incentivo_regional+"'";
...
<script language="JavaScript">
	location.href="navegadorPeriodosEvalucionProveedor.jsf";
</script>
