    ...
    <html>
        ...
        <body>
            ...
            <h:form id="form1"  >                
                <div align="center">
                    <br>
                    <h:outputText value="Editar Color Presentación " styleClass="tituloCabezera1"    />
                    ...
                    <h:panelGrid columns="3" styleClass="panelgrid" headerClass="headerClassACliente" style="border:1px solid #0A5B99;">
                        ...
                        <h:outputText  styleClass="outputText2" value="::"/>                                
                        <h:selectOneMenu styleClass="inputText" value="#{ManagedColoresPresentacion.colorPresentacionbean.estadoReferencial.codEstadoRegistro}" >
                            <f:selectItems value="#{ManagedColoresPresentacion.estadoRegistro}"  />
                        </h:selectOneMenu>          
                    </h:panelGrid>

                    <br>
                    <h:commandButton value="Guardar" styleClass="commandButton" action="#{ManagedColoresPresentacion.modificarColoresPresentacion}"   onclick="return validar();" />
