                    ...
                    if(res.next())
                    {
                       ...
                       if(res.next())
                       {
                        ...
                        out.println("<tr ><th colspan='2' rowspan='3'><center><img src='../../../img/cofar.png'></center></th>" +
                                ...
                                "</tr>" +
                                "<tr>" +
                                "<th colspan='3'  align='center' rowspan='2'><span class='bold'><b>CONTROL DE LLENADO DE VOLUMEN</b></span></th>" +
                                ...
                                "<tr><th bgcolor='#cccccc' colspan='9' align='center' class='ultCol'><span class='bold' style='font-size:12px;'>CONTROL DE LLENADO DE VOLUMEN</span></th></tr>" +
                                "<tr><th colspan='9' align='left' class='ultCol ultFil'><span class='bold'>NOTA:</span><span class='normal'>"+preindicacionesControlDosificado+"</span>" +
                                "<table  align='center' class='outputText0'  cellpadding='0' cellspacing='0' >" +
                                "<tr><th style='border-right:none !important'><span class='bold' >Limites de aceptación</span></th><th><span class='normal'>No < "+limiteAceptacion+"  &nbsp;&nbsp;&nbsp;ml</span></th></tr>" +
                                "</table>");
                        ...
                        int contDetalle=0;
                         out.println(" <table style='margin-top:2em' align='center' class='outputText0'  cellpadding='0' cellspacing='0' >" +
                                     "<tr>"+innerCabeceraPersonal+"<th bgcolor='#cccccc' align='center' colspan='2'><span class='bold' >Maquina Dosificadora</span></th></tr>");
                        ...
                        out.println(" <table width='80%' style='margin-top:0.5em' align='center' class='outputText0'  cellpadding='0' cellspacing='0' >" +
                                ...
                                "<th bgcolor='#cccccc' align='center'><span class='bold'>Ampolla 1</span></th>" +
                                "<th bgcolor='#cccccc' align='center'><span class='bold'>Ampolla 2</span></th>" +
                                "<th bgcolor='#cccccc' align='center'><span class='bold'>Ampolla 3</span></th>" +
                                "<th bgcolor='#cccccc' align='center'><span class='bold'>Ampolla 4</span></th>" +
