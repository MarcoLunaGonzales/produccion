                ...
                int cantidadFrascosLavados=0;
                  try
                  {
                    ...
                    String consulta="select pp.cod_formula_maestra,f.cod_forma,pp.COD_FORMULA_MAESTRA,cp.COD_COMPPROD,f.abreviatura_forma,p.nombre_prod,cp.NOMBRE_GENERICO,f.nombre_forma,cp.REG_SANITARIO,"+
                                    ...
                                    " ,isnull(cpr.COD_RECETA_LAVADO, 0) as cod_receta_lavado" +
                    ...
                    if(res.next())
                    {
                       ...
                       if(res.next())
                       {
                        ...
                        out.println("<table width='80%' style='margin-top:1em' align='center' class='outputText0'  cellpadding='0' cellspacing='0' >" +
                                    ...
                                    "<tr><th align='left'>");
                       out.println("<span class='bold'>Encargado de Recepción:</span><span class='normal'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;..........................................................................................................</span><br>" +
                                    "<span class='bold'>Fecha:</span><span class='normal'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;........./....../.......................</span><br>"+
                                    "<span class='bold'>Hora Inicio:</span><span class='normal'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;...................</span><br>"+
                                    "<span class='bold'>Hora Inicio:</span><span class='normal'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;...................</span>");
                        ...
                        out.println("<table width='80%' style='margin-top:0.5em' align='center' class='outputText0'  cellpadding='0' cellspacing='0' >" +
                            ...
                            out.println("<tr>" +
                                        "<th><span class='normal'>Frascos</span></th>" +
                                        "<th><span class='normal'>&nbsp;</span></th>" +
                                         "<th><span class='normal'>&nbsp;</span></th>" +
                                         "<th><span class='normal'>&nbsp;</span></th>" +
                                         "</tr>");
                             out.println("<tr>" +
                                        "<th><span class='normal'>Tapas</span></th>" +
                                        "<th><span class='normal'>&nbsp;</span></th>" +
                                         "<th><span class='normal'>&nbsp;</span></th>" +
                                         "<th><span class='normal'>&nbsp;</span></th>" +
                                         "</tr>");
                              out.println("<tr>" +
                                        "<th><span class='normal'>Tapones</span></th>" +
                                        "<th><span class='normal'>&nbsp;</span></th>" +
                                         "<th><span class='normal'>&nbsp;</span></th>" +
                                         "<th><span class='normal'>&nbsp;</span></th>" +
                                         "</tr>");
                        ...
                        for(int i=0;i<5;i++)
                        {
                                out.println("<tr><th><span class='normal'>"+(1+i)+"</span></th>" +
                                            "<th><span class='normal'>&nbsp;</span></th>"+
                                            "<th><span class='normal'>&nbsp;</span></th>"+
                                            "<th><span class='normal'>&nbsp;</span></th>"+
                                            "<th><span class='normal'>&nbsp;</span></th>"+
                        ...
                        out.println("</table></th></tr></table></div><div class='pagina'><table width='80%' align='center' class='outputText0'  cellpadding='0' cellspacing='0' ><tr><th class='ultCol ultFil' align='left'>" +
                                    ...
                                    "<tr><th align='left' style='border:none'><span class='normal'>Cantidad de frascos recibidos</span></th><th style='border:none'>&nbsp&nbsp&nbsp&nbsp</th><th align='left' style='border-bottom:none'><span class='normal'>.....................</span></th></tr>" +
                                    "<tr><th align='left' style='border:none'><span class='normal'>Cantidad de tapas recibidas</span></th><th style='border:none'>&nbsp&nbsp&nbsp&nbsp</th><th align='left' style='border-bottom:none'><span class='normal'>.....................</span></th></tr>" +
                                    "<tr><th align='left' style='border:none'><span class='normal'>Cantidad de tapones recibidos</span></th><th style='border:none'>&nbsp&nbsp&nbsp&nbsp</th><th align='left' style='border-bottom:none'><span class='normal'>.....................</span></th></tr>" +
                                    "<tr><th align='left' style='border:none'><span class='normal'>Cantidad de frascos lavados</span></th><th style='border:none'>&nbsp&nbsp&nbsp&nbsp</th><th align='left' style='border-bottom:none'><span class='normal'>.....................</span></th></tr>" +
                                    "<tr><th align='left' style='border:none'><span class='normal'>Cantidad de Frascos frv</span></th><th style='border:none'>&nbsp&nbsp&nbsp&nbsp</th><th align='left' style='border-bottom:none'><span class='normal'>.....................</span></th></tr>" +
                                    "<tr><th align='left' style='border-right:none'><span class='normal'>Rendimiento Final</span></th><th style='border-right:none'>&nbsp&nbsp&nbsp&nbsp</th><th align='left'><span class='normal'>.....................</span></th></tr></table>");
                        if(!loteAsociado.equals(""))tamanoLote+=cantAsociado;
                        
                        
                         out.println("<br><br><span class='bold'>NOMBRE DEL SUPERVISOR:&nbsp;&nbsp;&nbsp;</span><span class='normal'>.....................................................................................................................</span>" +
