                  ...
                  try
                  {
                       ...
                       if(res.next())
                       {
                        ...
                        while(res.next())
                        {
                            out.println("<tr><th bgcolor='#cccccc' align='center' colspan='6'><span class='bold' >"+res.getString("NOMBRE_TIPO_PROGRAMA_PROD")+"</span></th></tr>" +
                                        "<tr>" +
                                        "<th><span class='bold' >Limites de aceptación<br>Teórico en gramos</span></th><th><span class='normal'>....................</span></th>" +
                                        "<th><span class='bold' >Limites de aceptación<br>Máximo en gramos</span></th><th><span class='normal'>....................</span></th>" +
                                        "<th><span class='bold' >Limites de aceptación<br>Mínimo en gramos</span></th><th><span class='normal'>....................</span></th>" +
                                        "</tr>");
                        }
                        out.println("</table>");
                        ...
                        for(int i=0;i<11;i++)
                        {
                            out.println("<tr>" +
                                        ...
                                        "<th><span class='normal'>&nbsp;</span></th>" +
                                        "<th><span class='normal'>&nbsp;</span></th>" +
                                        "<th><span class='normal'>&nbsp;</span></th></tr>");
                    ...
                    for(int i=0;i<11;i++)
                     ...
                     out.println("<br><br><span class='bold'>NOMBRE DEL SUPERVISOR:&nbsp;&nbsp;&nbsp;</span><span class='normal'>.....................................................................................................</span>" +
                                ...
                                "<br><br><span class='bold'>OBSERVACIONES:&nbsp;&nbsp;&nbsp;</span><br><span class='normal'>..................................................................................................................s</span>" +
                                "<br><br><br><br><br><br>" +
                                "</th></tr>");
                        res.close();
                        con.close();
