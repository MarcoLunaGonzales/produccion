            ...
            <table width="80%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                 <%
                  try
                  {
                    ...
                    String consulta="select isnull(cpr.COD_RECETA_ESTERILIZACION_CALOR, 0) as COD_RECETA_ESTERILIZACION_CALOR,f.cod_forma,pp.COD_FORMULA_MAESTRA,cp.COD_COMPPROD,f.abreviatura_forma,p.nombre_prod,cp.NOMBRE_GENERICO,f.nombre_forma,cp.REG_SANITARIO,"+
                                    ...
                                    " ,dpff.PRECAUCIONES_ESTERILIZACION_CALOR_HUMEDO,dpff.INDICACIONES_ETAPA_ESTERILIZACION_CALOR_HUMEDO,dpff.POST_INDICACIONES_ETAPA_ESTERILIZACION_CALOR_HUMEDO" +
                                    " ,dpff.CANTIDAD_REGISTROS_LOTES_ESTERILIZAR,dpff.CANTIDAD_REGISTROS_AMPOLLAS_ESTERILIZAR"+
                    ...
                    String precaucionesEsterilizacionCalorHumedo="";
                    String indicacionesEsterilizacionCalorHumedo="";
                    String postInidicacionesCalorHumedo="";
                    int cantidadLotesEsterilizar=0;
                    int cantidadAmpollasEsterilizar=0;
                    if(res.next())
                    {
                        cantidadLotesEsterilizar=res.getInt("CANTIDAD_REGISTROS_LOTES_ESTERILIZAR");
                        cantidadAmpollasEsterilizar=res.getInt("CANTIDAD_REGISTROS_AMPOLLAS_ESTERILIZAR");
                        postInidicacionesCalorHumedo=res.getString("POST_INDICACIONES_ETAPA_ESTERILIZACION_CALOR_HUMEDO");
                        precaucionesEsterilizacionCalorHumedo=res.getString("PRECAUCIONES_ESTERILIZACION_CALOR_HUMEDO");
                        indicacionesEsterilizacionCalorHumedo=res.getString("INDICACIONES_ETAPA_ESTERILIZACION_CALOR_HUMEDO");
                    ...
                    consulta="select m.NOMBRE_CCC,cpc.CANTIDAD,um.ABREVIATURA,cpc.UNIDAD_PRODUCTO" +
                        ...
                        out.println("<tr ><th colspan='2' style='border-bottom: solid #000000 1px;border-right : solid #000000 1px' rowspan='3'><center><img src='../../../img/cofar.png'></center></th>" +
                            ...
                            out.println("<tr>" +
                                "<th bgcolor='#cccccc' colspan='9' style='padding:5px;font-size:16px;border-bottom: solid #000000 1px;' align='center'><span class='outputText2' style='font-size:14px;'>ESTERILIZACION CALOR HUMEDO</span></th>" +
                                "</tr><tr>" +
                                "<th colspan='9' style='padding:5px;font-size:16px;border-bottom: solid #000000 1px;line-height:18px' align='left'><span class='outputText2'>Precauciones</span><br>" +
                                "<span class='outputText2' style='font-weight:normal'>"+precaucionesEsterilizacionCalorHumedo+"</span>" +
                                "<br><span class='outputText2'>Consideraciones Generales</span><br>" +
                                "<center><table cellpadding='0' cellspacing='0' style='line-height:14px;border-top:1px solid black;border-left:1px solid black;' class='outputText2'><tr bgcolor='#cccccc'>" +
                                "<td style='padding-left:18px;padding-right:18px;border-bottom:1px solid black;;'>NUMERO DE LOTE A<br> ESTERILIZAR</td><td style='border:1px solid black;border-top:none;padding-left:18px;padding-right:18px;'>NUMERO DE BANDEJAS<br> DE CADA LOTE</td></tr>");
                                for(int i=0;i<cantidadLotesEsterilizar;i++)
                                {
                                    out.println("<td style='padding-left:18px;padding-right:18px;border-bottom:1px solid black;'>&nbsp;</td><td style='border:1px solid black;border-top:none;padding-left:18px;padding-right:18px;'>&nbsp;</td></tr>");
                                }
                                out.println("</table></center><span class='outputText2' style='font-weight:normal'>"+indicacionesEsterilizacionCalorHumedo+"</span></th>" +
                                "</tr>");
                           consulta="select ep.COD_TIPO_ESPECIFICACION_PROCESO,ep.RESULTADO_NUMERICO,ep.COD_ESPECIFICACION_PROCESO,ep.NOMBRE_ESPECIFICACIONES_PROCESO,"+
                             " isnull(um.ABREVIATURA,'') as NOMBRE_UNIDAD_MEDIDA," +
                             ...
                             " where ep.COD_FORMA='"+codForma+"' and ep.COD_PROCESO_ORDEN_MANUFACTURA=4"+
                        ...
                        out.println("<tr style='background-color:#cccccc' >"+
                                            "<td class='outputText2' style='border-bottom: solid #000000 1px;border-right:solid #000000 1px;font-weight:bold;padding:6px;' colspan='3'>EQUIPO</td>" +
                                            "<td class='outputText2' style='border-bottom: solid #000000 1px;border-right:solid #000000 1px;font-weight:bold;padding:6px;' colspan='2'>ESPECIFICACIONES DE LA ETAPA</td>" +
                                            "<td class='outputText2' style='border-bottom: solid #000000 1px;border-right:solid #000000 1px;font-weight:bold;padding:6px;' colspan='2'>EQUIPO</td>" +
                                            "<td class='outputText2' style='border-bottom: solid #000000 1px;font-weight:bold;padding:6px;' colspan='2'>CONDICIONES DE LA OPERACION</td></tr>");
                        while(res.next())
                        {

                            valor=(res.getInt("RESULTADO_NUMERICO")>0?((res.getInt("valorExacto")<0?"(-)":"")+String.valueOf(Math.abs(res.getInt("valorExacto")))):res.getString("valorTexto"));
                            ...
                            out.println("<tr><td align='left' class='outputText2' colspan='3' style='padding:4px;border-bottom: solid #000000 1px;border-right:solid #000000 1px'>"+nombreEspecificacion+"</td>" +
                                    "<td class='outputText2' style='padding:4px;border-bottom: solid #000000 1px;border-right:solid #000000 1px' "+(unidadMedida.equals("")?"colspan='2'":"")+">&nbsp;"+valor+"</td>" +
                                    (unidadMedida.equals("")?"":"<td class='outputText2'  style='padding:4px;border-bottom: solid #000000 1px;border-right:solid #000000 1px'>"+unidadMedida+"</td>") +
                                    ...
                                    "<td class='outputText2' style='padding:4px;border-bottom: solid #000000 1px;"+(unidadMedida.equals("")?"":"border-right:solid #000000 1px")+"' "+(unidadMedida.equals("")?"colspan='2'":"")+">&nbsp;</td>" +
                                    (unidadMedida.equals("")?"":"<td class='outputText2' style='padding:4px;border-bottom: solid #000000 1px;'>"+unidadMedida+"</td>")+"</tr>");

                        }
                        out.println("<tr >" +
                                "<th colspan='9' style='padding-bottom:14px;font-size:16px;line-height:18px' align='left'>"+
                                "<center><table cellpadding='0' cellspacing='0' style='margin-bottom:8px;line-height:14px;border-left:1px solid black;border-top:1px solid black;margin-top:10px;' class='outputText2'><tr bgcolor='#cccccc'>" +
                                "<td style='padding-left:18px;padding-right:18px;border-bottom:1px solid black;border-right:1px solid black;' align='center'>Número de ampollas x<br> recipiente</td>" +
                                "<td style='padding-left:18px;padding-right:18px;border-bottom:1px solid black;border-right:1px solid black;'>No de Recipientes</td>" +
                                "<td style='padding-left:18px;padding-right:18px;border-bottom:1px solid black;'>Indicador</td>" +
                                "<td style='border:1px solid black;border-top:none;padding-left:18px;padding-right:18px;'>Nombre del Obrero</td></tr>");
                                for(int i=0;i<cantidadAmpollasEsterilizar;i++)
                                {
                                    out.println("<tr><td style='padding-left:18px;padding-right:18px;border-bottom:1px solid black;border-right:1px solid black;'>&nbsp;</td>" +
                                            "<td style='padding-left:18px;padding-right:18px;border-bottom:1px solid black;border-right:1px solid black;'>&nbsp;</td>" +
                                            "<td style='padding-left:18px;padding-right:18px;border-bottom:1px solid black;'>&nbsp;</td>" +
                                            "<td style='border:1px solid black;border-top:none;padding-left:18px;padding-right:18px;'>&nbsp;</td></tr>");
                                }
                                out.println("</table></center><span style='padding-left:5px;margin-top:16px;' class='outputText2'>Observación:   ........................................................................" +
                                        "..............................................................................................................</span>" +
                                        "<br><span class='outputText2' style='padding-left:5px;font-weight:normal'>"+postInidicacionesCalorHumedo+"</span></th>" +
                                "</tr>");

                        out.println("<tr><td colspan='4' class='outputText2' style='font-weight:bold;padding:5px;background-color:#cccccc;border-top:1px solid black;border-right:1px solid black;'>JEFE DE PRODUCCION</td></tr>" +
