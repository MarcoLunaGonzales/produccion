                ...
                int codActividadEnvasado=0;
                  try
                  {
                    ...
                    String consulta="select pp.cod_formula_maestra,f.cod_forma,pp.COD_FORMULA_MAESTRA,cp.COD_COMPPROD,f.abreviatura_forma,p.nombre_prod,cp.NOMBRE_GENERICO,f.nombre_forma,cp.REG_SANITARIO,"+
                                    ...
                                    " ,scdl.COD_SEGUIMIENTO_CONTROL_DOSIFICADO_LOTE,scdl.FECHA_CIERRE"+
                                    ...
                                    " ,scdl.OBSERVACION,afm.COD_ACTIVIDAD_FORMULA as actividadEnvasado"+
                                    ...
                                    " INNER JOIN SEGUIMIENTO_CONTROL_DOSIFICADO_LOTE scdl on scdl.COD_PROGRAMA_PROD=pp.COD_PROGRAMA_PROD"+
                                    " and scdl.COD_LOTE=pp.COD_LOTE_PRODUCCION"+
                                    " inner join personal per on per.COD_PERSONAL=scdl.COD_PERSONAL_SUPERVISOR" +
                                    " left outer join ACTIVIDADES_FORMULA_MAESTRA afm on afm.COD_AREA_EMPRESA =96 " +
                                    " and afm.COD_ACTIVIDAD = 29 and afm.COD_FORMULA_MAESTRA =pp.COD_FORMULA_MAESTRA and afm.COD_PRESENTACION = 0" +
                    ...
                    if(res.next())
                    {
                        codActividadEnvasado=res.getInt("actividadEnvasado");
                        observacion=res.getString("OBSERVACION");
                        codSeguimiento=res.getInt("COD_SEGUIMIENTO_CONTROL_DOSIFICADO_LOTE");
                        ...
                        if(res.getString("COD_FORMA").equals("81"))
                        {
                       ...
                       if(res.next())
                       {
                        ...
                        out.println("<tr ><th colspan='2' rowspan='3'><center><img src='../../../img/cofar.png'></center></th>" +
                                ...
                                "<th  align='center'><input type='text' size='3' value='8' style='text-align:center;border:none;background-color:#ffffff'></th>" +
                                ...
                                "</tr>" +
                                "<tr>" +
                                "<th colspan='3'  align='center' rowspan='2'><span class='bold'><b>CONTROL DE DOSIFICADO</b></span></th>" +
                                ...
                                "<tr><th bgcolor='#cccccc' colspan='9' align='center' class='ultCol'><span class='bold' style='font-size:12px;'>CONTROL DE DOSIFICADO</span></th></tr>" +
                                "<tr><th colspan='9' align='left' class='ultCol ultFil'><span class='bold'>" +
                                " <table width='90%' style='margin-top:2em' align='center' class='outputText0'  cellpadding='0' cellspacing='0' >" +
                                "<tr><th bgcolor='#cccccc'  align='center'><span class='bold'>N°</span></th>" +
                                "<th bgcolor='#cccccc'  align='center'><span class='bold'>Personal</span></th>" +
                                "<th bgcolor='#cccccc'  align='center'><span class='bold'>N° de Frascos<br> Envasados</span></th>" +
                                "<th bgcolor='#cccccc'  align='center'><span class='bold'>N° de Frascos<br> para C.C.</span></th>" +
                                "<th bgcolor='#cccccc'  align='center'><span class='bold'>N° de Frascos<br> FRV</span></th>" +
                                "<th bgcolor='#cccccc'  align='center'><span class='bold'>N° de Frascos<br>Faltantes</span></th>" +
                                "<th bgcolor='#cccccc'  align='center'><span class='bold'>Fecha</span></th>" +
                                "<th bgcolor='#cccccc'  align='center'><span class='bold'>Hora Inicio</span></th>" +
                                "<th bgcolor='#cccccc'  align='center'><span class='bold'>Hora Final</span></th>" +
                                "<th bgcolor='#cccccc'  align='center'><span class='bold'>Horas Hombre</span></th>" +
                                "</tr>"
                                
                                );
                        if(!loteAsociado.equals(""))tamanoLote+=cantAsociado;
                        consulta="SELECT srdlp.CANT_AMPOLLAS_ACOND,srdlp.CANT_AMPOLLAS_CARBONES,srdlp.CANT_AMPOLLAS_CC,"+
                                 " srdlp.CANT_AMPOLLAS_ROTAS,srdlp.CANT_AMPOLLAS_FALTANTES,sppp.FECHA_INICIO,sppp.FECHA_FINAL,sppp.HORAS_HOMBRE,"+
                                 " (p.AP_PATERNO_PERSONAL+' '+p.AP_MATERNO_PERSONAL+' '+p.NOMBRES_PERSONAL+' '+p.nombre2_personal)as nombrePersonal"+
                                 " FROM SEGUIMIENTO_CONTROL_DOSIFICADO_LOTE_PERSONAL srdlp inner join SEGUIMIENTO_PROGRAMA_PRODUCCION_PERSONAL sppp on"+
                                 " srdlp.COD_PERSONAL = sppp.COD_PERSONAL and srdlp.COD_REGISTRO_ORDEN_MANUFACTURA = sppp.COD_REGISTRO_ORDEN_MANUFACTURA"+
                                 " inner join PERSONAL p on p.COD_PERSONAL=srdlp.COD_PERSONAL"+
                                 " where (sppp.COD_LOTE_PRODUCCION = '"+codLoteProduccion+"' and sppp.COD_PROGRAMA_PROD = '"+codProgramaProd+"' and"+
                                 " sppp.COD_FORMULA_MAESTRA = '"+codFormulaMaestra+"' and  sppp.COD_ACTIVIDAD_PROGRAMA = '"+codActividadEnvasado+"'" +
                                 " and sppp.COD_TIPO_PROGRAMA_PROD = '"+codTipoprogramaProd+"' and srdlp.COD_SEGUIMIENTO_CONTROL_DOSIFICADO_LOTE is null) or"+
                                " (srdlp.COD_SEGUIMIENTO_CONTROL_DOSIFICADO_LOTE = '"+codSeguimiento+"' and sppp.COD_LOTE_PRODUCCION is NULL) or"+
                                " (sppp.COD_LOTE_PRODUCCION = '"+codLoteProduccion+"' and sppp.COD_PROGRAMA_PROD = '"+codProgramaProd+"'" +
                                " and sppp.COD_FORMULA_MAESTRA = '"+codFormulaMaestra+"' and sppp.COD_ACTIVIDAD_PROGRAMA = '"+codActividadEnvasado+"'" +
                                " and sppp.COD_TIPO_PROGRAMA_PROD = '"+codTipoprogramaProd+"' and srdlp.COD_SEGUIMIENTO_CONTROL_DOSIFICADO_LOTE = '"+codSeguimiento+"')" +
                        ...
                        {
                            out.println("<tr>" +
                                       "<th><span class='normal'>"+res.getRow()+"</span></th>"+
                                       "<th><span class='normal'>"+res.getString("nombrePersonal")+"</span></th>" +
                                       "<th><span class='normal'>"+res.getInt("CANT_AMPOLLAS_ACOND")+"</span></th>"+
                                       "<th><span class='normal'>"+res.getInt("CANT_AMPOLLAS_CC")+"</span></th>"+
                                       "<th><span class='normal'>"+res.getInt("CANT_AMPOLLAS_ROTAS")+"</span></th>"+
                                       "<th><span class='normal'>"+res.getInt("CANT_AMPOLLAS_FALTANTES")+"</span></th>"+
                                       ...
                                       "<th align='center'><span class='normal'>"+(format.format(res.getDouble("HORAS_HOMBRE")))+"</span></th>" +
                                       "</tr>");
