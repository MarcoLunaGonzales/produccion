                    ...
                    if(res.next())
                    {
                       ...
                       if(res.next())
                       {
                        ...
                        out.println("<tr ><th colspan='2' rowspan='3'><center><img src='../../../img/cofar.png'></center></th>" +
                                ...
                                "<th bgcolor='#cccccc'  align='center'><span class='bold'>N° Amp. Envasadas</span></th>" +
                                "<th bgcolor='#cccccc'  align='center'><span class='bold'>N° Amp. para C.C.</span></th>" +
                                "<th bgcolor='#cccccc'  align='center'><span class='bold'>N° Amp.<br> con Globos,<br> negras y carbones</span></th>" +
                                "<th bgcolor='#cccccc'  align='center'><span class='bold'>N° Amp. Rotas</span></th>" +
                        ...
                        consulta="SELECT srdlp.CANT_AMPOLLAS_ACOND,srdlp.CANT_AMPOLLAS_CARBONES,srdlp.CANT_AMPOLLAS_CC,"+
                                 "srdlp.CANT_AMPOLLAS_ROTAS,sppp.FECHA_INICIO,sppp.FECHA_FINAL,sppp.HORAS_HOMBRE,"+
                        ...
                        while(res.next())
                        {
                            out.println("<tr>" +
                                       ...
                                       "<th><span class='normal'>"+res.getInt("CANT_AMPOLLAS_CARBONES")+"</span></th>"+
