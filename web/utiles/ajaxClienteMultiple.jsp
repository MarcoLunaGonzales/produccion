...
if(sw.equals("1")){
    ...
    sql="select cod_cliente,nombre_cliente from clientes where cod_cliente<>0 and cod_tipocliente in ("+codigo+") and cod_area_empresa="+sw;
}
...
out.println("<select id='codcliente' name='codcliente' size=\"10\" class=\"inputText3\" onchange='validarCliente(this);' multiple >");
while(rs.next()){
