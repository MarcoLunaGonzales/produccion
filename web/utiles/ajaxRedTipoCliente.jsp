...
sql+=" from REDES_AGENCIA ra,clientes cl";
sql+=" where ra.COD_REDCLIENTE = cl.cod_redcliente and ra.COD_ESTADO_REGISTRO = 1 AND ra.COD_AREA_EMPRESA = "+codAreaEmpresa;
sql+=" and cl.cod_tipocliente in ("+codTipoCliente+") group by ra.COD_REDCLIENTE";
