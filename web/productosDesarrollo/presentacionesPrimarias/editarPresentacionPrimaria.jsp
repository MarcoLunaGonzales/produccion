        ...
        <body >
            ...
            <a4j:form id="form1"  >
                <center>
                        ...
                        <h3>Editar Presentacion Primaria</h3>
                    ...
                    <h:panelGrid columns="6">
                        ...
                        <h:panelGrid columns="3" styleClass="panelgrid" headerClass="headerClassACliente" style="width:70%;border:1px solid #cccccc;margin-top:9px">
                            ...
                            <h:inputText styleClass="inputText" size="50" value="#{ManagedProductosDesarrollo.presentacionesPrimariaEditar.cantidad}" onkeypress="valNum()"  id="cantidadPresentacion" />
                            <h:outputText value="Envase" styleClass="outputText2 negrita" />
                            <h:outputText  styleClass="outputText2 negrita"  value="::"/>
                            <h:selectOneMenu styleClass="inputText" value="#{ManagedProductosDesarrollo.presentacionesPrimariaEditar.envasesPrimarios.codEnvasePrim}" id="codEnvasePrimario" >
                            ...
                            <h:outputText  styleClass="outputText2 negrita"  value="::"/>
                            <h:selectOneMenu styleClass="inputText" value="#{ManagedProductosDesarrollo.presentacionesPrimariaEditar.tiposProgramaProduccion.codTipoProgramaProd}" id="tipoPrograma" >
                        ...
                        <a4j:commandButton value="Guardar" onclick="if(!validarGuardar()){return false;}" styleClass="btn" action="#{ManagedProductosDesarrollo.guardarEdicionPresentacionPrimaria_action}"
                        oncomplete="if(#{ManagedProductosDesarrollo.mensaje eq '1'}){alert('Se guardo la edicion de la presentacion primaria');window.location.href='navegadorPresentacionesPrimarias.jsf?codA='+(new Date()).getTime().toString();}
