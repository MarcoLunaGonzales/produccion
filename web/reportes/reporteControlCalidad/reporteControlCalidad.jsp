...
<html>
    ...
    <body>
        <form>
                   ...
                   DecimalFormatSymbols simbolo1=new DecimalFormatSymbols();
                    ...
                    try{
                        ...
                        consulta="select  pr.nombre_prod,ra.FECHA_EMISION,ae.COD_AREA_EMPRESA,ae.NOMBRE_AREA_EMPRESA,"+
                                     ...
                                     ",ra.COD_PERSONAL_ANALISTA,ra.COD_PERSONAL_APRUEBA_CCC"+
                        ...
                        int codVersion=0;
                        int codPersonalAnalista=0;
                        int codPersonalApruebaCC=0;
                        if(res.next())
                        {
                            codPersonalAnalista=res.getInt("COD_PERSONAL_ANALISTA");
                            codPersonalApruebaCC=res.getInt("COD_PERSONAL_APRUEBA_CCC");
                            ...
                            fechaElaboracion=res.getDate("fecha")!=null?sdt.format(res.getDate("fecha")):"";
             ...
             %>
             <center><img src="../../img/nuevoLogoCofar.jpg" style="height: 70px;"></center>
            ...
            <table width="100%" align="center">
                ...
                <tr>
                    <td align='center'><img src="getfirmaCertificadoCC.jsf?codPersonal=<%=(codPersonalAnalista)%>"></td>
                    <td align='center'><img src="getfirmaCertificadoCC.jsf?codPersonal=<%=(codPersonalApruebaCC)%>"></td>
                </tr>
                 <tr>
