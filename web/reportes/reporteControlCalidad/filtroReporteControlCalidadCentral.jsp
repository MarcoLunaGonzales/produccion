...
<html>
    <head>
        ...
        <script>
            ...
            function buscarLote()
            {
                ...
                ajax.open("GET","ajaxLotesCentral.jsf?lote="+lote.value+"&codComprod="+codComprod+"&alea="+Math.random(),true);
            ...
            {
                openPopup('reporteControlCalidad.jsf?codForma='+codForma+'&codProd='+codProd+'&codLote='+codLote);
    ...
    <body>
        <h3 align="center">Reporte Control de Calidad(Central)</h3>
            ...
            <div align="center">
                <table border="0"  border="0" class="tablaFiltroReporte" width="50%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            String consulta="select cp.COD_COMPPROD,cp.nombre_prod_semiterminado"+
                                            " from COMPONENTES_PROD cp where cp.COD_ESTADO_COMPPROD=1 and  cp.COD_COMPPROD in (select ra.COD_COMPROD from RESULTADO_ANALISIS ra where ra.COD_ESTADO_RESULTADO_ANALISIS = 1)" +
                    ...
                    <tr class="outputText3">
                        <td colspan="3"><div id="divLotes"></div>
                        </td>
                    </tr>
