                           ...
                           if(!cabeceraLote.equals(cabeceraAux))
                           {
                               if(!cabeceraLote.equals(""))
                               {
                                   ...
                                   if(codAreaEmpresaProceso==84){sumaCantidadProceso=cantidadEnviadaApt;}
                                    ...
                                    out.println("<tr><td class='cellArea'>"+codLoteProduccion+"</td><td class='cellArea'>"+nombreProducto+"</td><td class='cellArea'>"+areaProceso+"</td>" +
                                   ...
                                   out.println("<tr><td class='cellLote'>"+codLoteProduccion+"</td><td class='cellLote'>"+nombreProducto+"</td><td class='cellLote'>&nbsp;</td>" +
