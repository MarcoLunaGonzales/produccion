    ...
    <body>
        ...
        <form method="post" action="reporteDeTiempos.jsp" target="_blank" style="top:1px" name="form1">
                ...
                <table border="0"  border="0" class="border" >
                    ...
                    <tr class="outputText3">
                       ...
                       try {
                        ...
                        %>
                        <td class="">
                            <select name="codProgramaProdPeriodo" id="codProgramaProdPeriodo" class="outputText3" multiple onchange="ajaxArea(form1);">
                                <%
                    ...
                    <tr class="outputText3" >
                        ...
                        <td class="">
                            <div id="div_area">                            
                                <select name="codAreaEmpresaProducto" size="4" class="inputText" multiple onchange="ajaxProductos(form1)">
                    ...
                    <tr id="rowLote" class="outputText3">
                        ...
                        <td class="">
                            ...
                            <a onclick="buscarLote(form1)" class="btn2">Buscar</a>
                        </td>
                    </tr>
                    ...
                    <tr id="rowLotesEncontrado" class="outputText3" >
                        ...
                        <td class="">
                            ...
                            <a class="btn2" onclick="adicionarProducto(form1)">(˅)Adicionar Lotes</a>
                            <a class="btn2" onclick="quitarLotes(form1)">(˄) Quitar Lotes</a>
            ...
            String sql = " select ae.COD_AREA_EMPRESA,ae.NOMBRE_AREA_EMPRESA"+
                        ...
                        " inner join AREAS_ACTIVIDAD_PRODUCCION ap on ae.COD_AREA_EMPRESA=ap.COD_AREA_EMPRESA"+ 
            ...
            ResultSet rs = st.executeQuery(sql);
                    ...
                    <tr class="outputText2">
                     <td colspan="4">
                        <input type="checkbox" onclick="verificarIngresoAcond(this)"  name="chkfechas1" id="chkfechas1">
                        <label for="chkfechas1">Reporte con fecha de ingresos acondicionamiento</label>
                    ...
                    <tr class="outputText2" id="rowFechaInicioAcond" style="display:none">
                        ...
                        <td >::</td>
                        <td >
                            <input type="text"  size="12"  value="<%=fechaInicio%>" name="fecha_inicio" id="fecha_inicio" class="inputText">
                    ...
                    <tr class="outputText2" id="rowFechaFinalAcond" style="display:none">
                        ...
                        <td >::</td>
                        <td>
                            <input type="text"  size="12"  value="<%=fechaFinal%>" name="fecha_final" id="fecha_final" class="inputText">
                     ...
                     <tr class="outputText2">
                     <td colspan="4">
                        <input type="checkbox"  name="chkfechasPer" id="chkfechasPer" onclick="verificarFechaPersona(this)">
                        <label for="chkfechasPer"> Reporte con fechas de personal</label>
                     </td>
                    </tr>
                    <tr class="outputText2" id="rowFechaInicioPersonal" style="display:none">
                        ...
                        <td >::</td>
                        <td >
                            <input type="text"  size="12"  value="<%=fechaInicioper%>" name="fecha_inicioPer" id="fecha_inicioPer" class="inputText">
                    ...
                    <tr class="outputText2" id="rowFechaFinalPersonal" style="display:none">
                        ...
                        <td >::</td>
                        <td>
                            <input type="text"  size="12"  value="<%=fechaFinalper%>" name="fecha_finalPer" id="fecha_finalPer" class="inputText">
