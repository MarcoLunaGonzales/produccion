...
<html>
    <head>
       ...
       if(f.codTipoReporteDetallado.value=='2')
        {
            f.action="reporteDefectosResumido.jsf";
        }
        else
        {
            f.action="reporteDefectosDetallado.jsf";
        }
        f.submit();
            }
    ...
    <body><br><br>
        <h3 align="center">Reporte de Defectos Encontrados</h3>

        <form method="post" action="reporteDeTiempos.jsp" target="_blank" name="form1">
            <div align="center">
           ...
           try {
            ...
            ResultSet rs = st.executeQuery(sql);
                    ...
                    <tr class="outputText2">
                       <td colspan="4"><input type="checkbox"  name="reporteConFech">Reporte con fechas de Registro Personal</td>
                    </tr>
                    <tr class="outputText2">
                        <td >De fecha de Registro Personal:
                        </td>
                        <td >::</td>
                        <td >
                    ...
                    <tr class="outputText2">
                        <td>A fecha de registro Personal:
                        </td>
                        <td >::</td>
                        <td>
