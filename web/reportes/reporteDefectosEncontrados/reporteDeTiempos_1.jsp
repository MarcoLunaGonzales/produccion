...
package reportes.reporteTiempos;
                ...
                <tr class="">
                    ...
                    try{
                        String consulta="select ISNULL((select cp.nombre_prod_semiterminado from COMPONENTES_PROD cp where cp.COD_COMPPROD=pr.COD_COMPPROD),'')as producto, ";
                               ...
                               consulta+=" from PROGRAMA_PRODUCCION_INGRESOS_ACOND pria inner join INGRESOS_ACOND ia on ia.COD_INGRESO_ACOND=pria.COD_INGRESO_ACOND where ia.fecha_ingresoacond BETWEEN '"+fechaInicioFormato+"'and '"+fechaFinalFormato+"')";
                               }
...
*/
                         ...
                         %>
                           ...
                           <th class="outputTextNormal" style="border : solid #D8D8D8 1px" bgcolor="#f2f2f2" ><b><%=formato.format(sumUnidPer)%></b></th>
