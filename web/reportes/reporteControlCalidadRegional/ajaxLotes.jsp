...
String consulta ="select era.NOMBRE_ESTADO_RESULTADO_ANALISIS,datosPrograma.COD_FORMA,era.COD_ESTADO_RESULTADO_ANALISIS,ra.COD_LOTE,cp.nombre_prod_semiterminado,cp.COD_PROD from RESULTADO_ANALISIS ra inner join COMPONENTES_PROD cp"+
...
" outer apply( select TOP 1 cpv.COD_FORMA from PROGRAMA_PRODUCCION p  inner join COMPONENTES_PROD_VERSION cpv on cpv.COD_COMPPROD=p.COD_COMPPROD"+
