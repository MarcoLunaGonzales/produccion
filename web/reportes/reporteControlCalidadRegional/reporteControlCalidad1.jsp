        ...
        <form>
             <%
                    ...
                    try{
                        ...
                        String consulta="select ra.FECHA_REVISION,ae.NOMBRE_AREA_EMPRESA,isnull(ra.NRO_ANALISIS_MICROBIOLOGICO,'') as NRO_ANALISIS_MICROBIOLOGICO, ra.NRO_ANALISIS,cp.VIDA_UTIL,cp.nombre_prod_semiterminado,cp.COD_COMPPROD,"+
                                        ...
                                        " (select top 1 cast(ep.nombre_envaseprim as varchar)+'-'+cast(ppcp.CANTIDAD as varchar)"+
                                        " from PRESENTACIONES_PRIMARIAS ppcp inner join ENVASES_PRIMARIOS ep on "+
                                        " ep.cod_envaseprim=ppcp.COD_ENVASEPRIM where ppcp.COD_COMPPROD=cpp.COD_COMPPROD and ppcp.COD_TIPO_PROGRAMA_PROD=1) as presentacionPrimaria"+
                        ...
                        if(res.next())
                        {
                            fechaEmision=(res.getTimestamp("FECHA_REVISION")==null?(new Date()):res.getTimestamp("FECHA_REVISION"));
                            ...
                            String presenPrimaria=res.getString("presentacionPrimaria").split("-")[0];
                            String cantidadPresenPrimaria=res.getString("presentacionPrimaria").split("-")[1];
