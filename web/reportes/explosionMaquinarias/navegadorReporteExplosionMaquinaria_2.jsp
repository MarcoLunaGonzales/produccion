        ...
        <form>
            ...
            <table  align="center" width="60%" class="outputText2" style="border : solid #f2f2f2 1px;" cellpadding="0" cellspacing="0">
                ...
                while(i.hasNext()){
                    ...
                    consulta = consulta + " select maq.CODIGO,maq.NOMBRE_MAQUINA,m.COD_MAQUINA,m.HORAS_HOMBRE,m.HORAS_MAQUINA" +
                            " from formula_maestra fm inner join " +
                            " ACTIVIDADES_FORMULA_MAESTRA afm on fm.cod_formula_maestra = afm.cod_formula_maestra " +
                            ...
                            " and fm.COD_COMPPROD = '"+programaProduccion.getFormulaMaestra().getComponentesProd().getCodCompprod()+"'" +
                            " union all ";
                }
