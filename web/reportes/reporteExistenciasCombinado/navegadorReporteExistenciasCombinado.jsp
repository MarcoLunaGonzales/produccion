...
public void hallaSaldoAlmacen(String codPresentacion,String fechaInicio,String almacenQuintanilla,float cantPresentacion,JspWriter out){
try{
                    ...
                    float saldoCantidadUnitariasPresentacion=0;
                                ...
                                ResultSet rsSalidasPresentacion=stSalidasPresentacion.executeQuery(consultaSalidasPresentacion);
                                        if(rsSalidasPresentacion.next()){
                                            ...
                                            saldoCantidadPresentacion = ingresosPresentacion-salidasPresentacion;
                                            saldoCantidadUnitariasPresentacion = ingresosUnitariosPresentacion- salidasUnitariasPresentacion;
                                            ...
                                            out.print("<td class='bordeNegroTd' align='right'>"+saldoCantidadPresentacion+"</td>");
                                            out.print("<td class='bordeNegroTd' align='right'>"+saldoCantidadUnitariasPresentacion+"</td>");
...
<html>
    ...
    <body>
        <h3 align="center">Reporte Combinado de Existencias</h3>
        <br>
        <form>
            <table align="center" width="90%">
                ...
                double cantidadProduccion=0.0d;
                    ...
                    float diferenciaCaja =0;
                    float diferenciaUnidad=0;
                    float saldoCantidadPresentacion = 0;
                    float saldoCantidadUnitariasPresentacion = 0;


                    int cantPresentacion = 0;
                    String codAnteriorPresentacion = "";
                    float stockMinimoPresentacion =0;
                    float stockReposicionPresentacion = 0;
                    float stockMaximoPresentacion = 0;
                    ...
                    //    fechaInicio=aux;
                    //}
                    String codAlmacenesVenta = "27,28,31,32,54";
                    codAlmacenesVenta=request.getParameter("codAlmacenVentaArray");
                    String[] arrayCodAlmacenesVentas =codAlmacenesVenta.split(",");
            ...
            <table  align="center" width="90%" class="outputText2" style="border : solid #f2f2f2 1px;" cellpadding="0" cellspacing="0">
                ...
                <tr class="tablaFiltroReporte">
                    ...
                    <td align="center" class="bordeNegroTd"><b>ACONDICIONAMIENTO&nbsp;</b></td>
                    <td align="center" class="bordeNegroTd" colspan="2"><b>&nbsp;</b></td>
                    
                    <%
                    try{

                        for(int i=0;i<arrayCodAlmacenesVentas.length;i++){
                        String sqlNombreAlmacen="select nombre_almacen_venta from almacenes_ventas " +
                                "where cod_estado_registro=1 and cod_almacen_venta="+arrayCodAlmacenesVentas[i]+"" ;
                        Statement st=con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
                        ResultSet rs=st.executeQuery(sqlNombreAlmacen);
                        if(rs.next()){
                            agenciaVenta="";
                            agenciaVenta=rs.getString(1);                    
                            out.println("<td align='center' bgcolor='#F5FBEF' class='bordeNegroTd' colspan='2'><b>"+agenciaVenta+"</b></td>");
                        }
                        }
                    ...
                    <td align="center" class="bordeNegroTd" colspan="6" >&nbsp;</td>
                    <td align="center" class="bordeNegroTd" colspan="2" bgcolor='#EFF5FB'><b>DIFERENCIA (ALMACENES - STOCK DE REPOSICION)&nbsp;</b></td>
                    <td align="center" class="bordeNegroTd" colspan="2" bgcolor='#EFF5FB'><b>DIFERENCIA (ALMACENES + ACONDICIONAMIENTO - STOCK DE REPOSICION)&nbsp;</b></td>
                ...
                <tr class="tablaFiltroReporte">
                    ...
                    <td  align="center" class="bordeNegroTd"><b>Cantidad Unitaria</b></td> <%--cantidad en Acondicionamiento--%>
                    ...
                    <%
                    for(int i=0;i<arrayCodAlmacenesVentas.length;i++){
                    out.print("<td  align='center' class='bordeNegroTd' bgcolor='#F5FBEF'><b>Cantidad Caja</b></td> ");
                    out.print("<td  align='center' class='bordeNegroTd' bgcolor='#F5FBEF'><b>Cantidad Unitaria</b></td> ");
                    }
                    ...
                    <td  align="center" class="bordeNegroTd"><b>Stock Minimo Caja</b></td>
                    <td  align="center" class="bordeNegroTd"><b>Stock Minimo Unidad</b></td>

                    <td  align="center" class="bordeNegroTd" bgcolor="#FBF5EF"><b>Stock Reposicion Caja</b></td>
                    <td  align="center" class="bordeNegroTd" bgcolor="#FBF5EF"><b>Stock Reposicion Unidad</b></td>

                    <td  align="center" class="bordeNegroTd"><b>Stock Maximo Caja</b></td>
                    <td  align="center" class="bordeNegroTd"><b>Stock Maximo Unidad</b></td>

                    <td  align="center" class="bordeNegroTd" bgcolor='#EFF5FB'><b>Diferencia Caja</b></td>
                    <td  align="center" class="bordeNegroTd" bgcolor='#EFF5FB'><b>Diferencia Unidad</b></td>
                    <td  align="center" class="bordeNegroTd" bgcolor='#EFF5FB'><b>Diferencia Unidad</b></td>
                ...
                while (rs.next()){
                    ...
                    String consultaPresentaciones =" select cod_presentacion, cantidad_presentacion, nombre_producto_presentacion, cod_anterior  , " +
                            ...
                            " COD_PROD from presentaciones_producto p where cod_tipomercaderia="+tipoMercaderia+" and p.cod_presentacion in ("+codPresentacion+")  " +
                     ...
                     ResultSet rsPresentaciones=stPresentaciones.executeQuery(consultaPresentaciones);
                                ...
                                cantPresentacion = rsPresentaciones.getInt("cantidad_presentacion");
                                codAnteriorPresentacion = rsPresentaciones.getString("cod_anterior");
                                stockMinimoPresentacion = rsPresentaciones.getFloat("stock_minimo");
                                stockReposicionPresentacion = rsPresentaciones.getFloat("stock_reposicion");
                                stockMaximoPresentacion = rsPresentaciones.getFloat("stock_maximo");
                    ...
                    if(rsIngresosAcondicionamiento.next()){
                        ...
                        out.print("<td class='bordeNegroTd' align='right'>"+form.format(saldoCantidadUnitariaAcond)+"</td>");
                                ...
                                */
                                saldoCantPresentacion=0;
                                saldoCantUnitariaPresentacion=0;
                                //hallar Unidades en Stock de Presentacion
                                for(int i=0;i<arrayCodAlmacenesVentas.length;i++){
                                String consultaIngresosPresentacion="select sum(id.cantidad) cantidad,sum(id.cantidad_unitaria) cantidadUnitaria " +
                                " from ingresos_detalleventas id,ingresos_ventas iv,PRESENTACIONES_PRODUCTO pp " +
                                ...
                                " and iv.fecha_ingresoventas<='"+fechaInicio+ " 23:59:59'" +
                                " and pp.cod_presentacion=id.cod_presentacion and iv.cod_estado_ingresoventas<>2 " +
                                " and iv.cod_almacen_venta="+arrayCodAlmacenesVentas[i]+" ";
                                System.out.println("SQL INGRESOS:    "+consultaIngresosPresentacion);
                                ...
                                " and sa.fecha_salidaventa<='"+fechaInicio+ " 23:59:59' " +
                                " and pp.cod_presentacion=sd.cod_presentacion and sa.cod_estado_salidaventa<>2 " +
                                " and sa.cod_almacen_venta="+arrayCodAlmacenesVentas[i]+" ";
                                System.out.println("SQL SALIDAS:   "+consultaSalidasPresentacion);
                                Statement stSalidasPresentacion=con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
                                ResultSet rsSalidasPresentacion=stSalidasPresentacion.executeQuery(consultaSalidasPresentacion);
                                        if(rsSalidasPresentacion.next()){
                                            ...
                                            saldoCantPresentacion+=saldoCantidadPresentacion;
                                            out.print("<td class='bordeNegroTd' bgcolor='#F5FBEF' align='right'>"+form.format(saldoCantidadPresentacion)+"</td>");
                                            out.print("<td class='bordeNegroTd' bgcolor='#F5FBEF' align='right'>"+form.format(saldoCantidadUnitariasPresentacion)+"</td>");
                                            //out.print("<td class='bordeNegroTd' align='right'>"+saldoCantidadUnitariaPresentacion+"</td>");
                             ...
                             //hallar la diferencia entre almacen y reposicion en cajas y unidades
                                            
                                            out.print("<td class='bordeNegroTd' align='right'>"+form.format(stockMinimoPresentacion)+"</td>");
                                            out.print("<td class='bordeNegroTd' align='right'>"+form.format(stockMinimoPresentacion*cantPresentacion)+"</td>");
                            ...
                            //hallar cantidades de reposicion
                                //form.format(cantidadUnitariaReposicion)
                                            ...
                                            out.print("<td class='bordeNegroTd' align='right' bgcolor='#FBF5EF'>"+form.format(stockReposicionPresentacion)+"</td>");
                                            out.print("<td class='bordeNegroTd' align='right' bgcolor='#FBF5EF'>"+form.format(cantidadUnitariaReposicion)+"</td>");
                                            out.print("<td class='bordeNegroTd' align='right'>"+form.format(stockMaximoPresentacion)+"</td>");
                                            out.print("<td class='bordeNegroTd' align='right'>"+form.format(stockMaximoPresentacion*cantPresentacion)+"</td>");

                                            
                                            out.print("<td class='bordeNegroTd' align='right' bgcolor='#EFF5FB'>"+form.format(saldoCantPresentacion-stockReposicionPresentacion)+"</td>");


                                            float diferenciaUnidades = (saldoCantPresentacion*cantPresentacion)-cantidadUnitariaReposicion;
                                            diferenciaUnidades = saldoCantUnitariaPresentacion-cantidadUnitariaReposicion;

                                            out.print("<td class='bordeNegroTd' align='right' bgcolor='#EFF5FB'>"+form.format(diferenciaUnidades)+"</td>");
                                            out.print("<td class='bordeNegroTd' align='right' bgcolor='#EFF5FB'>"+form.format(diferenciaUnidades+saldoCantidadUnitariaAcond)+"</td>");
