...
<html>
    <head>
       ...
       function verEspecificacionesProductpo(f){
        var codforma=parseInt(f.codForma.value);
        f.action=(codforma==1?"reporteEspecificacionesProductoComprimidos.jsf":"");
        alert(f.action);
        f.submit();
       }
    ...
    <body><br><br>
        ...
        <form method="post" action="navegadorReporteProgramaProduccion.jsp" target="_blank" name="form1">
            <div align="center">
                <table border="0"  border="0" class="border" width="50%">
                    ...
                    <tr class="outputText3">
                        ...
                        <td class="">
                            <div>
                            <select name="codForma" class="outputText3" style="height:150px" >
                                <%
            ...
            <br>
            <center>
                <input type="button" class="btn"  value="Ver Reporte" name="reporte" onclick="verEspecificacionesProductpo(form1)">
