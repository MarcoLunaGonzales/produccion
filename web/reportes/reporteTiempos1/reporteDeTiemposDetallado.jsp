           ...
           String horasPer,String cantPer,String produc,String hExtra,String cantExtra)
{
      ...
      " <th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right' id='"+idRend+"'><span>"+produc+"</span></th>" +
...
public String generarCeldaActividad(int cont,String nombreAct,String primFila,double hhAct,String maq,double hmAct,double hhStand,double hmStand,String demasCeldas)
{
    return
    "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' rowspan='"+cont+"'>"+nombreAct+"</th>"+primFila+
    "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' rowspan='"+cont+"'>"+formato.format(hhAct)+"</th>"+
    "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' rowspan='"+cont+"'>"+maq+"</th>"+
    "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' rowspan='"+cont+"'>"+formato.format(hmAct)+"</th>"+
    "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' rowspan='"+cont+"'>"+formato.format(hhStand)+"</th>"+
    "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' rowspan='"+cont+"'>"+formato.format(hmStand)+"</th></tr>"+demasCeldas;
}

public String generarCeldaAreaProceso(int cont,String proceso,String actividades,String ultimaAct,int codProceso,
   String cabeceraLote,String codCompProd)
{
    
     String[] datos=cabeceraLote.split("<br></br>");
    if(codProceso==84){sumaCantidadProceso=this.enviadosAPT(datos[1].split(": ")[1], codCompProd);}
    if(codProceso==96){sumaCantidadProceso=this.enviadosAcond(datos[1].split(": ")[1], codCompProd);}
      String resultado= "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' rowspan='"+cont+"'>"+proceso+"</th>"+actividades+
         (actividades.equals("")?"":"<tr class='outputTextNormal'>")+ultimaAct+
        ...
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>"+formato.format(sumaHorasProceso)+"</b></th>"+
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>"+entero.format(sumaCantidadProceso)+"</b></th>"+
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>"+formato.format(sumaCantidadProceso/sumaHorasProceso)+"</b></th>"+
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>"+formato.format(sumaHorasExtraProceso)+"</b></th>"+
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>"+entero.format(sumaCantidadExtraProceso)+"</b></th>"+
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>"+formato.format(sumahorasProcesoActividadPersonal)+"</b></th>"+
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' >&nbsp;</th>" +
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>"+formato.format(sumahorasProcesoActividadMaquina)+"</b></th>"+
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>"+formato.format(sumahorasProcesoActividadStandardHombre)+"</b></th>"+
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>"+formato.format(sumahorasProcesoActividadStandardMaquina)+"</b></th>"+
        "</tr>";
...
public String generarCeldaLote(String codCompProd,int cont,String datosLote,String datosProceso,String ultProces)
{
     ...
     double enviadosAPT=this.enviadosAPT(datos[1].split(": ")[1], codCompProd);
     String resultado= "<tr class='outputTextNormal'>" +
        ...
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>"+formato.format(sumaLoteHorasPer)+"</b></th>"+
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>"+entero.format(enviadosAPT)+"</b></th>"+
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>"+formato.format(enviadosAPT/sumaLoteHorasPer)+"</b></th>"+
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>"+formato.format(sumaLoteHorasExtraPer)+"</b></th>"+
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>"+entero.format(sumaLoteCanExtraPer)+"</b></th>"+
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>"+formato.format(sumaLoteHorHomAct)+"</b></th>"+
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' >&nbsp;</th>" +
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>"+formato.format(sumaLoteHorMaqAct)+"</b></th>"+
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>"+formato.format(sumaLoteHorHomStand)+"</b></th>"+
        "<th class='outputTextNormal' style='border : solid #D8D8D8 1px' align='right'><b>"+formato.format(sumaLoteHorMaqStand)+"</b></th>"+
        "</tr>";
    sumaLoteHorasPer=0d;
                ...
                <tr class="">
                    ...
                    try{
                      ...
                      String consulta="select pp.COD_LOTE_PRODUCCION,pp.COD_COMPPROD,ae.COD_AREA_EMPRESA,"+
                                    ...
                                    " sppp.HORAS_HOMBRE, sppp.UNIDADES_PRODUCIDAS, ISNULL(sppp.HORAS_EXTRA, 0) AS HORAS_EXTRA,"+
                      ...
                      if(res.getDate("FECHA_INICIO")!=null)
                           ...
                           if(!cabeceraLote.equals(cabeceraAux))
                           {
                               ...
                               resultadoFinal+=cabeceraLote.equals("")?"":generarCeldaLote(codCompProd,contLote,cabeceraLote,celdaProceso,
                                      generarCeldaAreaProceso(contProceso,cabeceraProceso,celdaActividad,
                                            generarCeldaActividad(contActividad,cabeceraActividad,primeraCeldaPersonal,horasHombreActividad,nombreMaquina,
                                            horasMaquinaActividad,horasHombreStandard,horasMaquinaStandard,celdaPersonal),codAreaEmpresaProceso,cabeceraLote,codCompProd));
                             ...
                             if(!cabeceraProceso.equals(""))
                              {
                                    ...
                                    celdaProceso+=((celdaProceso.equals("")?"":"<tr class='outputTextNormal'>")+generarCeldaAreaProceso(contProceso,cabeceraProceso,celdaActividad,
                                            generarCeldaActividad(contActividad,cabeceraActividad,primeraCeldaPersonal,horasHombreActividad,nombreMaquina,horasMaquinaActividad,horasHombreStandard,horasMaquinaStandard,celdaPersonal)
                                            ,codAreaEmpresaProceso,cabeceraLote,codCompProd));
                          ...
                          if(primeraCeldaPersonal.equals(""))
                          {
                                      ...
                                      idMenor=idRend;
                                      idmayor=idRend;
                                      primeraCeldaPersonal=generarCeldaPersonal(format.format(fechaIni),horas.format(fechaIni),format.format(fechaFin),horas.format(fechaFin),nombrePersonal,
                          ...
                          else
                          {
                                    ...
                                    if(cantidadMenor>0){
                                      ...
                                      celdaPersonal+="<tr class='outputTextNormal'>" +generarCeldaPersonal(format.format(fechaIni),horas.format(fechaIni),format.format(fechaFin),horas.format(fechaFin),nombrePersonal,
                                              formato.format(horasPersonal),entero.format(cantidadPersonal),formato.format(cantidadPersonal/horasPersonal),formato.format(horasExtraPersonal),entero.format(cantidadExtraPersonal))+
                                              "</tr>";
                          }
