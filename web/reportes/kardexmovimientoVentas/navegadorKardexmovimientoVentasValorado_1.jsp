    ...
    <head>
        ...
        <script>
            ...
            var codigo=f.codAreaEmpresa.value;
                location.href="navegadorKardexmovimientoVentasValorado_1.jsf?codArea="+codigo;
            }
            function nuevoAjax()
            {	var xmlhttp=false;
                try {
		...
		ajax=nuevoAjax();
        ajax.open("GET","ajaxProductosEstado.jsf?codEstadoProducto="+estadoProducto+"&a="+Math.random(),true);
...
function viewReport(f){
          ...
          var j=0;
            ...
            var arrayCodPresentacion=new Array();
            var arrayNombrePresentacion=new Array();
            j=0;
            for(var i=0;i<=f.codPresentacion.options.length-1;i++)
            {
                if(f.codPresentacion.options[i].selected)
                {	arrayCodPresentacion[j]=f.codPresentacion.options[i].value;
                    arrayNombrePresentacion[j]=f.codPresentacion.options[i].innerHTML;
                    j++;
                }
            }
            f.codPresentacionP.value= arrayCodPresentacion;
            f.nombrePresentacionP.value= arrayNombrePresentacion;

            //alert(f.codPresentacionP.value);
            //alert(f.nombrePresentacionP.value);
    ...
    <body>
        ...
        <form method="post" action="reporteKardexmovimientoVentasValorado_1.jsf" name="form1" target="_blank">
            <div align="center">
                <table border="0"  class="outputText2" style="border:1px solid #000000" cellspacing="0">    
                    ...
                    <tr class="outputText3">
                        ...
                        %> 
                        <td>
                            <select name="codAlmacen" class="outputText3" multiple style="height:100px">
                                <option value="0">Seleccione una opción</option>
                                <%
                                String codAlmacen="";
                    ...
                    <tr class="outputText3">
                        ...
                        <td>
                            <div id="div_producto">
                                <select name="codPresentacion" class="outputText3" multiple style="height:180px">
                                    <option value="0">Seleccione una opción</option>
                                    <%
            ...
            <br>
            <center>
                <input type="submit"   class="commandButtonR" onclick="viewReport(form1)" value="Ver Reporte" name="btnVerReporte">
                <input type="reset"   class="commandButtonR"  value="Limpiar" name="limpiar">
            </center>
            <input type="hidden" value="" name="codAlmacenP">
            <input type="hidden" value="" name="nombreAlmacenP">
            <input type="hidden" value="" name="codPresentacionP">
            <input type="hidden" value="" name="nombrePresentacionP">
        </form>
