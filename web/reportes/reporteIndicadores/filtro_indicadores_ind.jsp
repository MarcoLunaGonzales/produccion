...
<html>
    ...
    <body >
        <br>
        <br>
        <h4 align="center">Listado de Indicadores de Trabajo y Tiempos de Produccion</h4>
        <form  >
            <div align="center">
            ...
            <center>
                <input type="button" class="btn" size="35" value="Generar" onclick="detalle(this.form);">
            </center>
        </form>
