...
<%
            ...
            consulta = " select nombre_area_empresa_cp,  COD_LOTE_PRODUCCION,  sum(horas_hombre) horas_hombre,  sum(unidades_producidas) unidades_producidas," +
                    ...
                    " and p.COD_LOTE_PRODUCCION = '"+codLoteProduccionR+"' and p.COD_PROGRAMA_PROD = '"+codProgramaProd+"' and p.COD_COMPPROD = '"+codCompProd+"' and p.COD_FORMULA_MAESTRA = '"+codFormulaMaestra+"') as tabla" + //and ae1.cod_area_empresa = '"+codAreaEmpresaActv+"'
