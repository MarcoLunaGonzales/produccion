...
<%
            ...
            consulta = " select nombre_area_empresa_cp,  COD_LOTE_PRODUCCION,  sum(horas_hombre) horas_hombre,  sum(unidades_producidas) unidades_producidas," +
                    ...
                    " cod_programa_prod,       nombre_actividad,cod_actividad_formula,orden_actividad" +
                    " from ( select ae.nombre_area_empresa nombre_area_empresa_cp, p.COD_LOTE_PRODUCCION,  segui.horas_hombre,   segui.unidades_producidas," +
                    ...
                    " and p.COD_LOTE_PRODUCCION = '"+codLoteProduccionR+"' and p.COD_PROGRAMA_PROD = '"+codProgramaProd+"' and p.COD_COMPPROD = '"+codCompProd+"' and p.COD_FORMULA_MAESTRA = '"+codFormulaMaestra+"') as tabla" +
                    " group by nombre_area_empresa_cp,COD_LOTE_PRODUCCION, nombre_prod_semiterminado,  nombre_area_empresa_actv, nombre_actividad,cod_actividad_formula, cod_compprod, cod_formula_maestra, cod_programa_prod, cod_lote_produccion,orden_actividad" +
