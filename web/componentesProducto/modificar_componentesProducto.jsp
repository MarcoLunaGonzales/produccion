        ...
        <a4j:region id="regionUno">
            ...
            <div align="center">
                ...
                <h:panelGrid columns="4" styleClass="panelgrid" headerClass="headerClassACliente" style="width:70%;border:1px solid #cccccc">
                    ...
                    <h:outputText  styleClass="outputText2"  value="::" style="font-weight:bold"/>
                    <h:outputText  styleClass="outputText2"  value="#{ManagedComponentesProducto.componentesProdbean.concentracionEnvasePrimario}"/>
                    <h:outputText  styleClass="outputText2"  value=""/>
                ...
                <br>
                <h:commandButton value="Guardar" styleClass="btn" action="#{ManagedComponentesProducto.modificarComponentesProd}" onclick="return validar('form1:detalle');" />
