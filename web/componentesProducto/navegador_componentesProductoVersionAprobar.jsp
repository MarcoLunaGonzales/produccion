...
<f:view>
    ...
    function seleccionar(nombreTabla)
                ...
                function mostrarModalx(){
                    document.getElementById('divx').style.visibility='visible';
                }
</script>
        </head>
        ...
        <body onload="carga()">
            <div  id="divDetalle" style="
              ...
              text-align:center;
                ...
                <button class="btn" onclick="if(confirm('Esta seguro de aprobar la version')==false){return false;}else{aprobar_action();}">Aprobar</button>
                <button class="btn" onclick="if(confirm('Esta seguro de rechazar la version')==false){return false;}else{rechazar_action();}">Rechazar</button>
        ...
        <div  id="formsuper"  style=" padding: 50px;
            ...
            <h:form id="form1"  >
                ...
                <div align="center">
                    ...
                    <h3>Aprobar Versiones de Producto Semiterminado</h3>
                    
                    <a4j:jsFunction action="#{ManagedComponentesProducto.aprobarComponenteProdVersion_action}"  name="aprobar_action" oncomplete="ocultarModal();location='navegador_componentesProductoVersionAprobar.jsf?codEstadoVersion=1'" />
                    <a4j:jsFunction action="#{ManagedComponentesProducto.rechazarComponenteProdVersion_action}"  name="rechazar_action" oncomplete="ocultarModal();location='navegador_componentesProductoVersionAprobar.jsf?codEstadoVersion=1'" />
                    ...
                    <br>
                    <a4j:commandButton styleClass="btn" action="#{ManagedComponentesProducto.verAprobarComponentesProdVersion_action}"
                    value="Aprobar" reRender="dataProductosVersion" onclick="if(seleccionar('form1:dataProductosVersion')==false){return false;}"
                    oncomplete="verModificacionProductoSemiterminado('#{ManagedComponentesProducto.componentesProdbean.codCompprod}','#{ManagedComponentesProducto.componentesProdbean.codVersion}');" />
