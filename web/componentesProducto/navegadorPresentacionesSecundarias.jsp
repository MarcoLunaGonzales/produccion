    ...
    <html>
        ...
        <body>
            ...
            <h:form id="form1"  >
                <div align="center">                    
                        <br><br>                
                        <h:outputText value="#{ManagedComponentesProducto.cargarPresentacionesSecundariasComponentesProd}"   />
                    ...
                    <a4j:commandButton value="Eliminar"  styleClass="commandButton"  action="#{ManagedComponentesProducto.eliminarComponentesPresProd_action}"  
            ...
            <rich:modalPanel id="panelAgregarPresentacionSecundaria" minHeight="200"  minWidth="650"
                        ...
                        <h:panelGroup id="contenidoAgregarPresentacionSecundaria">
                            <h:panelGrid columns="3">
                                ...
                                action="#{ManagedComponentesProducto.guardarComponentesPresProd_action}" reRender="dataComponentesPresProd"
                                />
            ...
            <rich:modalPanel id="panelEditarPresentacionSecundaria" minHeight="200"  minWidth="650"
                        ...
                        <h:panelGroup id="contenidoEditarPresentacionSecundaria">
                                ...
                                action="#{ManagedComponentesProducto.guardarEditarComponentesPresProd_action}" reRender="dataComponentesPresProd"
                                                    />
