        ...
        <a4j:region id="regionUno">
            <div align="center">
                ...
                <div style="margin-top:6px">
                    <h:commandButton value="Guardar" styleClass="btn"  action="#{ManagedComponentesProducto.guardarEdicionRegistroSanitarioNuevaVersion_action}" onclick="if(validarRegistro()==false){return false;}"/>
