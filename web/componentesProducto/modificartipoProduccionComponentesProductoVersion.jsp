    ...
    <a4j:form id="form1"  >
        ...
        <a4j:region id="regionUno">
            ...
            <div align="center">
                ...
                <h:commandButton value="Guardar" styleClass="commandButton" action="#{ManagedComponentesProducto.guardarEditarTipoProduccionVersion_action}"  />
                <a4j:commandButton value="Cancelar"  styleClass="commandButton" onclick="location='navegador_componentesProductoVersion.jsf'" />
            </div>
        </a4j:region>
    </a4j:form>
    </div>
