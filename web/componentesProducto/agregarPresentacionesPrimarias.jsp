            ...
            <div style="text-align:center">                            
                <h:form id="form1"  >
                    ...
                    <div align="center">                
                        ...
                        <h:commandButton value="Guardar" onclick="return validarRegistro()" styleClass="commandButton" action="#{ManagedComponentesProducto.guardarPresentacionesPrimarias}"  />
