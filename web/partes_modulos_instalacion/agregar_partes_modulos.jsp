    ...
    <html>
        ...
        <body>
            ...
            <h:form id="form1"  >                
                <div align="center">
                    <br>
                    <h:outputText value="Registrar Parte del Módulo de Instalación :#{ManagedPartesModulosInstalacion.nombreModuloInstalacion} " styleClass="tituloCabezera1" />     
                    <br><br>
                    ...
                    <h:commandButton value="Guardar" styleClass="commandButton"  action="#{ManagedPartesModulosInstalacion.guardarPartesModulosInstalacion}" onclick="return validar()" />
