            ...
            <h:form id="form1"  >                
                <div align="center">
                    ...
                    <rich:dataTable  value="#{ManagedPresentacionesProductoDatosComerciales.agenciasVentaList}"  
                        ...
                        <rich:column>
                            <f:facet name="header">
                                <h:outputText value="<div id=\"1\"  name=\"1\"><span>Precio Institucional</span> <img src=\"../img/rep.png\"   onclick=\"repetir(this);\"  onmouseover=\"this.style.cursor='hand';this.src='../img/rep2.png'\" onmouseout=\"this.src='../img/rep.png'\"   alt='Repetir'></div> "  escape="false" />
                            </f:facet>
                            <h:inputText styleClass="inputText" size="15" value="#{data.precioInstitucional}" onkeypress="valNum();" /> 
                        </rich:column> 
                        <rich:column>
                            <f:facet name="header">
                                <h:outputText value="<div id=\"2\"  name=\"2\"><span>Precio Institucional 2</span> <img src=\"../img/rep.png\"   onclick=\"repetir(this);\"     alt='Repetir'  onmouseover=\"this.style.cursor='hand';this.src='../img/rep2.png'\" onmouseout=\"this.src='../img/rep.png'\"></div> "  escape="false" />
                            </f:facet>
                            <h:inputText styleClass="inputText" size="15" value="#{data.precioInstitucional2}" onkeypress="valNum();" /> 
                        </rich:column> 
                    </rich:dataTable>                    
                    <h:commandButton value="Guardar" styleClass="commandButton"  action="#{ManagedPresentacionesProductoDatosComerciales.EditPresentacionesProductoDatosComercialesInstitucional}"/>
                    <h:commandButton value="Cancelar"  styleClass="commandButton" action="#{ManagedPresentacionesProductoDatosComerciales.Cancelar1Institucional}" />
                </div>                
            </h:form>
        </body>
    </html>
