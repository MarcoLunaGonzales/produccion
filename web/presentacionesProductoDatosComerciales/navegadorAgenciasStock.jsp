        ...
        <head>
            ...
            <script>
                function getCodigo(codigo){
                   location='../presentacionesProductoDatosComerciales/navegadorPresentacionesProductoStock.jsf?codigoAreaEmpresa='+codigo;
                }
            </script>
        </head>
        <body >
            <h:form id="form1">               
                <div align="center">                    
                    ...
                    <h:outputText value="Stock x Agencia"  styleClass="outputTextNormal" />
