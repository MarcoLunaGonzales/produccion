...
<f:view>
    <html>
        <head>
           ...
           function tareaOM(codTareaOM,nombreTareaOM,idModal)
           {
               ...
               this.refrescar=function(hideModal)
               {
                   ...
                   var codPersonalAsignacion="";
                   for(var i=0;i<this.personal.length;i++)
                   {
                       if(this.personal[i].seleccionado)
                       {
                            codPersonalAsignacion+=(codPersonalAsignacion==''?'':',')+this.personal[i].idPersonal;
                       }
                   ...
                   innerHTMLOM+="</table></center>";
                    var peticion="ajaxGuardarPermisosPersonal.jsf?codPersonalAsignar="+codPersonalAsignacion+
                                "&fechaPermiso="+document.getElementById("fechaPermiso").value+
                                "&codActividad="+this.codTareaOM+
            ...
            function iniciarAsignacion(variables)
            {
                tareasOMScriptValue=variables;
                 ...
                 divRegistro.innerHTML="<div class='large-6 medium-8 small-12 large-centered medium-centered small-centered columns'><div class='panelPersonal'><div style='width:100%;text-right;' class='divHeaderRound'>"+
                                       ...
                                       "<div id='contentPersonaljScript1213' style='max-height:20em;overflow:auto;margin-top:1em'></div>"+
        ...
        <body>
                     ...
                     <div class="large-6 medium-9 small-12 large-centered medium-centered small-centered columns" >
                        ...
                        <div class="row">
                           <div class="large-12 medium-12 small-12 columns divHeaderClass" style="text-align:center" >
                                 ...
                                 <center><input id="fechaPermiso" type="tel" value="<%=(sdf.format(new Date()))%>" style="width:8em" onkeypress="return false;"/></center>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="large-12 medium-12 small-12 large-centered medium-centered small-centered columns">
                              ...
                              try
                              {
                                  ...
                                  consulta="select a.COD_ACTIVIDAD,ap.NOMBRE_ACTIVIDAD,p.COD_PERSONAL,"+
                                           ...
                                           " order by a.ORDEN,a.COD_ACTIVIDAD,p.COD_PERSONAL,p.AP_PATERNO_PERSONAL,p.AP_MATERNO_PERSONAL,p.NOMBRES_PERSONAL,p.nombre2_personal";
                                    ...
                                    while(res.next())
                                    {
                                        ...
                                        {
                                            if(codActividadCabecera>0)
                                            {
                                                actividadesIndirectas+=(actividadesIndirectas.equals("")?"":",")+"tarea"+codActividadCabecera;
                                                out.println("<script type='text/javascript'>var tarea"+codActividadCabecera+"=new tareaOM("+codActividadCabecera+",'"+nombreActividad+"','formsuper');tarea"+codActividadCabecera+".crearPersonal('"+personaltarea+"');</script>");
                                                out.println("<tr><td><div class='borderPanelRoundGreen' onclick='tarea"+
                                                            codActividadCabecera+".asociarPersonal();'><div class='large-12 medium-12 small-12 columns divHeaderRoundGreen' ><span>"+nombreActividad+"<span></div><div id='detalleTareaScriptOM"+codActividadCabecera+"'>" +
            ...
            <script type="text/javascript">iniciarAsignacion('<%=(actividadesIndirectas)%>');</script>
        </body>
    </html>
</f:view>
