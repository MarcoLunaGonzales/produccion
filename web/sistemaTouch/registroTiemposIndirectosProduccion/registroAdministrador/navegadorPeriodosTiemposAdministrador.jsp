    ...
    <html>
        ...
        <body>
         ...
         <center><img src="../../reponse/img/load3.GIF"  style="z-index:6; "><%--margin-top:2%;position:fixed;--%>
                 ...
                 <nav>
                          <li class="parent"><span class="textHeaderClass" id="nombreUsuarioPersonal"><%=(nombrePersonal)%></span>
                             <ul>
                                ...
                                <li onclick="sqlConnection.terminarSessionUsuario(function(){window.location.href='../loginIndirectos.jsf?data='+(new Date()).getTime().toString();});"><span class="textHeaderClass">Salir</span></li>
            ...
            <%
            out.println("<iframe style=\"margin-top:4em;width:100%;height:92%\" src=\"navegadorOpciones.jsf?ca="+request.getParameter("ca")+"&data="+(new Date()).getTime()+"\"></iframe>");
            %>
