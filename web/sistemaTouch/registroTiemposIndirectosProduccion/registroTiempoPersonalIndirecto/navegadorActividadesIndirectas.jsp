                        ...
                        <div  class="divContentClass large-12 medium-12 small-12 columns ">
                            ...
                            try
                            {
                                ...
                                String consulta="select a.ORDEN,a.COD_ACTIVIDAD,a.COD_ESTADO_REGISTRO,ap.NOMBRE_ACTIVIDAD,a.COD_AREA_EMPRESA,e.NOMBRE_ESTADO_REGISTRO,a.HORAS_HOMBRE " +
                                                ...
                                                " sppi.COD_ACTVIDAD=a.COD_ACTIVIDAD and sppi.COD_PERSONAL='"+codPersonal+"' and sppi.REGISTRO_CERRADO=0 and sppi.FECHA_INICIO>'"+sdf.format(new Date())+" 00:00') pendiente" +
                                                " OUTER APPLY(select count(*) as registrado from SEGUIMIENTO_PROGRAMA_PRODUCCION_INDIRECTO_PERSONAL sppi1"+
                                                " where sppi1.COD_ACTVIDAD = a.COD_ACTIVIDAD and sppi1.COD_PERSONAL = '"+codPersonal+"' and sppi1.REGISTRO_CERRADO = 1 and sppi1.FECHA_INICIO>'"+sdf.format(new Date())+" 00:00') registrado" +
                                                " where ap.COD_ESTADO_REGISTRO = 1 and a.COD_ESTADO_REGISTRO=1 and a.COD_AREA_EMPRESA = '"+codAreaEmpresa+"'" +
