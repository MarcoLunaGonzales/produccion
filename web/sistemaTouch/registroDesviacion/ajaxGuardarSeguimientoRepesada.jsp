package sistemaTouch.registroRepesada;
...
boolean terminado=(request.getParameter("terminado").equals("1"));
Connection con=null;
String mensaje="";
try
{
     ...
     if(codSeguimiento==0)
     {
        ...
        consulta="INSERT INTO SEGUIMIENTO_REPESADA_LOTE(COD_LOTE, COD_PROGRAMA_PROD,"+
                (administrador?" COD_PERSONAL_SUPERVISOR, FECHA_CIERRE,COD_ESTADO_HOJA,":"")+
                " COD_SEGUIMIENTO_REPESADA_LOTE, OBSERVACION)"+
     ...
     else
     {
         if(administrador)
         {
             consulta="UPDATE SEGUIMIENTO_REPESADA_LOTE SET COD_PERSONAL_SUPERVISOR =?,"+
                      (terminado?" FECHA_CIERRE = '"+sdf.format(new Date())+"',":"") +
    ...
    consulta = " INSERT INTO SEGUIMIENTO_PROGRAMA_PRODUCCION_PERSONAL( COD_COMPPROD,  COD_PROGRAMA_PROD,  COD_LOTE_PRODUCCION,  COD_FORMULA_MAESTRA," +
                        ...
                        " '"+codTipoProgramaProd+"'," +
                        " '"+codPersonalUsuario+"','"+horasHombreRepesada+"','0'" +
