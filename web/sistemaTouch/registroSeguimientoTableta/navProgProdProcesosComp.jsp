            ...
            <script language="javascript" type="text/javascript">
               ...
               var div1=null;
                ...
                function buscarLote()
                {
                    ...
                    ajax.open("GET","ajaxMostrarLotesFiltroComp.jsf?codLote="+lote.value+"&codProgramaProd="+codProgProd+"&a="+Math.random(),true);
                 ...
                 <section class="main" style="margin-top:5px;width:100%;border:1px solid blue;" >
                        ...
                        <div  class="divContentClass large-12 medium-12 small-12 columns">
                                ...
                                <div class="row" style="margin-top:12px">
                                    ...
                                    <div class="row ">
                                            ...
                                            <div class="large-8 medium-8 small-12 columns">
                                             <input type="text" value="" class="inputText" id="codLote"/>
                                           
                                            </div>
                                    </div>

                                    <div class="large-6 small-8 madium-10 large-centered columns">
                                        <input type="button"class="small button succes radius" onclick="buscarLote();" value="Buscar Lote">
                                    
                                    <%--a4j:commandButton reRender="dataProgramaproduccionList" value="Buscar Lote" styleClass=" " action="#{ManagedSeguimientoProcesosPorLote.buscarLotesProgramaProd_action}"
                                    oncomplete="ocultarModal();"/--%>
                                    </div>
                                </div>
                         </div>
                         </div>
                     ...
                     <div class="row" style="width:100%;margin-top:0px" >
                         ...
                         <table cellpadding="0px" cellspacing="0px" style="width:100%">
                             ...
                             <td class="tableHeaderClass" style="width:10%"><span class="textHeaderClass">Despeje<br>Linea</span></td>
                             ...
                             <td class="tableHeaderClass" style="width:10%"><span class="textHeaderClass">Limpieza<br>Ambientes</span></td>
                                 ...
                                 <%--rich:dataTable value="#{ManagedSeguimientoProcesosPorLote.programaProduccionDataModel}" var="data"
                                 headerClass="" id="dataProgramaproduccionList" style="">
                                         ...
                                         <f:facet name="header">
                                             <rich:columnGroup>
                                                 <rich:column  style="width:30%" styleClass="tableHeaderClass">
                                                        ...
                                                        <rich:column  style="width:10%" styleClass="tableHeaderClass">
                                                            <h:outputText value="Area"  styleClass="textHeaderClass"/>
                                                        </rich:column>
                                                        ...
                                                        <rich:column  style="width:10%" styleClass="tableHeaderClass">
                                                            <h:outputText value="Proceso Preparado"  styleClass="textHeaderClass"/>
                                                        </rich:column>
                                                        <rich:column style="width:10%" styleClass="tableHeaderClass">
                                                            <h:outputText value="Proceso Despiro" styleClass="textHeaderClass"  />
                                                        </rich:column>
                                                        <rich:column style="width:10%" styleClass="tableHeaderClass">
                                                            <h:outputText value="Proceso Lavado" styleClass="textHeaderClass"  />
                                                        </rich:column>
                                                </rich:columnGroup>
                                         </f:facet>
                                    ...
                                    <rich:column style="width:10%" styleClass="tableCell">
                                        <h:outputText styleClass="textHeaderClassBody" value="#{data.formulaMaestra.componentesProd.areasEmpresa.nombreAreaEmpresa}"/>
                                    </rich:column>
                                    ...
                                    <rich:column  style="width:10%" styleClass="tableCell">
                                        <a4j:commandLink
                                        onclick="openPopup('seguimientoProcesos.jsf?codComprod=#{data.formulaMaestra.componentesProd.codCompprod}&codLote=#{data.codLoteProduccion}&codAreaEmpresa=#{data.formulaMaestra.componentesProd.areasEmpresa.codAreaEmpresa}')">
                                             <h:graphicImage url="../../img/detalle.jpg" title="Registro de Seguimiento"/>
                                         </a4j:commandLink>
                                    </rich:column>
                                    <rich:column  style="width:10%" styleClass="tableCell">
                                        <a4j:commandLink styleClass="outputText2"
                                        onclick="openPopup('registroDespirogenizado/registroDespirogenizado.jsf?codComprod=#{data.formulaMaestra.componentesProd.codCompprod}&codLote=#{data.codLoteProduccion}&codAreaEmpresa=#{data.formulaMaestra.componentesProd.areasEmpresa.codAreaEmpresa}')">
                                             <h:graphicImage url="../../img/detalle.jpg" title="Proceso Despirogenizado"/>
                                         </a4j:commandLink>
                                    </rich:column>
                                    <rich:column style="width:10%" styleClass="tableCell">
                                        <a4j:commandLink styleClass="outputText2"
                                        onclick="openPopup('registroEtapaLavado/registroEtapaLavado.jsf?codComprod=#{data.formulaMaestra.componentesProd.codCompprod}&codLote=#{data.codLoteProduccion}&codAreaEmpresa=#{data.formulaMaestra.componentesProd.areasEmpresa.codAreaEmpresa}')">
                                             <h:graphicImage url="../../img/detalle.jpg" title="Proceso Despirogenizado"/>
                                         </a4j:commandLink>
                                    </rich:column>
                                 </rich:dataTable--%>
