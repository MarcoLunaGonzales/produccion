...
function nuevoRegistro(nombreTabla)
   {
       ...
       element2.id="fechaTiempo"+table.rows.length;
       element2.type = "tel";
       element2.value=document.getElementById("fechaSistema").value;
       ...
       for(var i=0;i<2;i++)
       {
           ...
           element3.id='celdaTime'+i+"t"+contadorRegistroTiempos;
...
<div id="principal">
        ...
        <script type="text/javascript">
            ...
            <%
                ...
                consulta="select t.COD_PERSONAL from TAREAS_OM_PERSONAL_LOTE t where t.COD_TAREA_OM=6 and t.COD_LOTE='"+codLote+"'" +
                         " and t.COD_PROGRAMA_PROD='"+codProgramaProd+"'";
                System.out.println("consulta personal permiso "+consulta);
                res=st.executeQuery(consulta);
                String codPersonalPermiso="";
                while(res.next())codPersonalPermiso+=(codPersonalPermiso.equals("")?"":",")+res.getInt("COD_PERSONAL");
                consulta="select a.COD_PERSONAL from ADMINISTRADORES_TABLETA a where a.COD_AREA_EMPRESA = 81";
                res=st.executeQuery(consulta);
                while(res.next())codPersonalPermiso+=(codPersonalPermiso.equals("")?"":",")+res.getInt("COD_PERSONAL");
                if(codPersonalPermiso.equals(""))
                    {

                    System.out.println("vivan los piscos");
                    out.println("alert('No existe personal registrado para esta tareas');window.close();</script>");
                    }
                consulta="select P.COD_PERSONAL,(P.AP_PATERNO_PERSONAL + ' ' + P.AP_MATERNO_PERSONAL + ' ' +P.NOMBRES_PERSONAL + ' ' + P.nombre2_personal) NOMBRES_PERSONAL"+
                                         ...
                                         " and p.cod_personal in ("+codPersonalPermiso+")"+
                                         ...
                                         " from personal p where (p.cod_area_empresa in (81) or P.COD_PERSONAL in (select a.COD_PERSONAL from ADMINISTRADORES_TABLETA a where a.COD_AREA_EMPRESA=81)) and p.COD_ESTADO_PERSONA = 1"+
                                         " and p.cod_personal in ("+codPersonalPermiso+")"+
                    ...
                    <div class="row" >
                        <div  class="divContentClass large-12 medium-12 small-12 columns">
                           ...
                           <%
                                ...
                                out.println("<script>operariosRegistro=\""+operarios+"\";</script>");
                                ...
                                while(res.next())
                                {
                                    ...
                                    out.println("<tr onclick='seleccionarFila(this)' ><td class='tableCell' style='text-align:left'>"+
                                                " <select id='codPersonalObrero"+res.getRow()+"'>"+operarios+"</select><script>codPersonalObrero"+res.getRow()+".value='"+res.getString("COD_PERSONAL")+"'</script></td>"+
                                                " <td class='tableCell' style='text-align:left'>" +
                                                "<input id='fechaTiempo"+res.getRow()+"' type='tel' value='"+sdfDia.format(res.getTimestamp("FECHA_INICIO"))+"' onclick='seleccionarDatePickerJs(this)'></td>" +
                                                " <td class='tableCell' style='text-align:left;width:6em;'><input type='text' id='horaInicio"+res.getRow()+"' onclick='seleccionarHora(this);' onfocus='calcularDiferenciaHoras(this);' onkeyup='calcularDiferenciaHoras(this);' value='"+sdfHora.format(res.getTimestamp("FECHA_INICIO"))+"'></td>" +
                                                " <td class='tableCell' style='text-align:left;width:6em;'><input type='text' id='horaFinal"+res.getRow()+"' onclick='seleccionarHora(this);' onfocus='calcularDiferenciaHoras(this);' onkeyup='calcularDiferenciaHoras(this);' value='"+sdfHora.format(res.getTimestamp("FECHA_FINAL"))+"'></td>" +
                           ...
                           <div class="row">
                              ...
                              <div class="large-1 medium-1 small-2 columns">
                                    <button class="small button succes radius buttonAction" onclick="nuevoRegistro('registroTiempo')">+</button>
                              </div>
                              <div class="large-1 medium-1 small-2 columns">
                        ...
                        %>
                             <div class="row" style="margin-top:0px;">
                                        <div class="large-6 small-8 medium-10 large-centered medium-centered columns">
                                            <div class="row">
                                                <div class="large-6 medium-6 small-12 columns">
                                                    <button class="small button succes radius buttonAction" onclick="guardarSeguimientoProgramaProduccion(admin,codPersonal);" >Guardar Seguimiento</button>
                                                </div>
                                                    <div class="large-6 medium-6 small-12  columns">
