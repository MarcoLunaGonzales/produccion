package sistemaTouch.registroSeguimientoTableta;
...
<style>
  ...
  <%
   int cantPixeles=0;
        ...
        out.println("<title>("+codLote+")Preparado</title>");
        ...
        <script type="text/javascript">
            ...
            <%
                ...
                consulta="select p.COD_PERSONAL,(p.AP_PATERNO_PERSONAL+' '+p.AP_MATERNO_PERSONAL+' '+p.NOMBRES_PERSONAL+' '+p.nombre2_personal) as nombrePersonal"+
                         " from PERSONAL p where p.COD_ESTADO_PERSONA=1 order by p.AP_PATERNO_PERSONAL,p.AP_MATERNO_PERSONAL,p.NOMBRE_PILA";
