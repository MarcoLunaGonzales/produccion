...
System.out.println(request.getParameter("dataSeguimientoPersonal"));
String codMaquina=request.getParameter("codMaquina");
String horasMaquina=request.getParameter("horasMaquina");
String horasHombreActivad=request.getParameter("horasHombreActivad");
...
try
{
    ...
    String fechaInicio="";
    String fechaFinal="";
    for(int i=0;(i<dataSeguimientoPersonal.length&&dataSeguimientoPersonal.length>1);i+=5)
    {
    ...
    consulta=" INSERT INTO SEGUIMIENTO_PROGRAMA_PRODUCCION( COD_COMPPROD,  COD_PROGRAMA_PROD, " +
            ...
            "  '"+codMaquina+"', '"+horasMaquina+"'," +
            "  '"+horasHombreActivad+"', '"+codTipoProduccion+"')";
