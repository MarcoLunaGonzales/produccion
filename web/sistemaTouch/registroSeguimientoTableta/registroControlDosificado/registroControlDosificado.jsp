    ...
    function guardarControlDosificado()
    {
        ...
        if(!admin)
        {
                for(var i=1;i<tablaControlDosificado.rows.length;i++)
                {
                    ...
                    {
                        dataControlDosificado[cont]=tablaControlDosificado.rows[i].cells[1].getElementsByTagName('select')[0].value;
                        cont++;
                        dataControlDosificado[cont]=parseInt(tablaControlDosificado.rows[i].cells[2].getElementsByTagName('input')[0].value);
                        cont++;
                        dataControlDosificado[cont]=parseInt(tablaControlDosificado.rows[i].cells[3].getElementsByTagName('input')[0].value);
                        cont++;
                        dataControlDosificado[cont]=parseInt(tablaControlDosificado.rows[i].cells[4].getElementsByTagName('input')[0].value);
                        cont++;
                        dataControlDosificado[cont]=parseInt(tablaControlDosificado.rows[i].cells[5].getElementsByTagName('input')[0].value);
                        cont++;
                        dataControlDosificado[cont]=tablaControlDosificado.rows[i].cells[6].getElementsByTagName('input')[0].value;
                        cont++;
                        dataControlDosificado[cont]=tablaControlDosificado.rows[i].cells[7].getElementsByTagName('input')[0].value;
                        cont++;
                        dataControlDosificado[cont]=tablaControlDosificado.rows[i].cells[8].getElementsByTagName('input')[0].value;
                        cont++;
                        dataControlDosificado[cont]=redondeo2decimales(getNumeroDehoras((dataControlDosificado[cont-3]+' '+dataControlDosificado[cont-2]),(dataControlDosificado[cont-3]+' '+dataControlDosificado[cont-1])));
                        cont++;
                    }
                    else
                    {
            ...
            <div class="large-12 medium-12 small-12 large-centered medium-centered small-centered columns" >
                        ...
                        <div class="row">
                            <div class="large-12 medium-12 small-12 large-centered medium-centered small-centered columns">
                                ...
                                <tr>
                                    <td class='tableHeaderClass' style='text-align:center;' ><span class='textHeaderClass'>No</span></td>
                                    <td class='tableHeaderClass' style='text-align:center;' ><span class='textHeaderClass'>Operario<br>Envasador</span></td>
                                    <td class='tableHeaderClass' style='text-align:center;' ><span class='textHeaderClass'>No Ampollas<br> Envasadas</span></td>
                                    <td class='tableHeaderClass' style='text-align:center;' ><span class='textHeaderClass'>No Ampollas<br>para C.C.</span></td>
                                    <td class='tableHeaderClass' style='text-align:center;' ><span class='textHeaderClass'>No Ampollas<br>con globos,<br>negras,<br>carbones</span></td>
                                    <td class='tableHeaderClass' style='text-align:center;' ><span class='textHeaderClass'>No Ampollas<br>rotas</span></td>
                              ...
                              <%
                                ...
                                consulta="SELECT srdlp.CANT_AMPOLLAS_ACOND,srdlp.CANT_AMPOLLAS_CARBONES,srdlp.CANT_AMPOLLAS_CC,srdlp.CANT_AMPOLLAS_ROTAS,"+
                                ...
                                while(res.next())
                                {
                                    out.println("<tr onclick='seleccionarFila(this);' ><td class='tableCell' style='text-align:left'><span class='textHeaderClassBody' >"+res.getRow()+"</span></td>"+
                                                ...
                                                " <td class='tableCell' style='text-align:left'><input "+(administrador?"disabled":"")+" type='tel' style='width:6em' value='"+res.getInt("CANT_AMPOLLAS_CARBONES")+"'></td>" +
                                                " <td class='tableCell' style='text-align:left'><center><input "+(administrador?"disabled":"")+" type='tel' style='width:6em' value='"+res.getInt("CANT_AMPOLLAS_ROTAS")+"'></center></td>" +
