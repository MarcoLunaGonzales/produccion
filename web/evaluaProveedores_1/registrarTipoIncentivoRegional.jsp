...
package calculoTipoIncentivoRegionalesOtros;
...
<html>
    ...
    <body>
        ...
        <form name="form1" action="guardarTipoIncentivoRegional.jsp">
            <%! Connection con=null;
            %>
            <%
...
%>
            ...
            <h3 align="center">Registrar Incentivos Categoría A por  Regional Gestión - Mes</h3>
            <br>
             <table width="50%" align="center" class="outputText2" style="border : solid #f2f2f2 1px;" cellpadding="0" cellspacing="0">
                <tr class="headerClassACliente">
                    <td  colspan="2" align="center" class=colh style="border : solid #f2f2f2 0px;">Introduzca los Datos</td>
                </tr>
