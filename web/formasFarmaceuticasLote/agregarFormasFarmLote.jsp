        ...
        <body>
            <h:form id="form1"  >                
                <div align="center">
                    ...
                    <h:outputText value="#{ManagedFormasFarmLote.cargarContenidoAgregarFormasFarmLote}" />
                    ...
                    <h:commandButton value="Guardar" styleClass="commandButton"   action="#{ManagedFormasFarmLote.guardarFormasFarmLote_action}"  onclick="return validar();"  />
