...
<f:view>
    <html>
        ...
        <body>
            <br><br>
            <h:form id="form1"  >
                <h:outputText value="#{ManagedAccionesTerapeuticas.codigoAccionTerapeutica}" styleClass="outputText2" />
                <div align="center">
                    <br>
                    <h:outputText value="Registrar Acción Terapeútica" styleClass="tituloCabezera1"    />
                    ...
                    <br>
                    <h:commandButton value="Guardar" styleClass="commandButton" action="#{ManagedAccionesTerapeuticas.guardarAccionesTerapeuticas}"   onclick="return validar();" />
