...
<f:view>
    <html>
            ...
            <script>
                function validar(){
                   ...
                   if(nombreCadenaCliente.value==''){
                     alert('El Campo Sabor Producto esta vacío.');
        ...
        <body>
            <br><br>
            <h:form id="form1"  >
                <h:outputText value="#{ManagedSaboresProducto.codigoSabores}" styleClass="outputText2" />
                <div align="center">
                    <br>
                    <h:outputText value="Registrar Sabor Producto" styleClass="tituloCabezera1"    />
                    ...
                    <br>
                    <h:commandButton value="Guardar" styleClass="commandButton" action="#{ManagedSaboresProducto.guardarSaboresProducto}"   onclick="return validar();" />
