            ...
            <h:form id="form1"  >
                <div align="center">
                    <rich:panel headerClass="headerClassACliente" style="width:80%">
                        <f:facet name="header">
                            <h:outputText value="Edicion de Marca"/>
                        </f:facet>
                        <h:panelGrid columns="3">
                            <h:outputText value="Nombre Marca" styleClass="outputText2" style="font-weight:bold"/>
                            <h:outputText value="::" styleClass="outputText2" style="font-weight:bold"/>
                            <h:inputText value="#{ManagedCertificadosSanitarios.marcasProductoEditar.nombreMarcaProducto}"
                            styleClass="inputText" style="width:25em"/>
                            <h:outputText value="Estado" styleClass="outputText2" style="font-weight:bold"/>
                            <h:outputText value="::" styleClass="outputText2" style="font-weight:bold"/>
                            <h:selectOneMenu value="#{ManagedCertificadosSanitarios.marcasProductoEditar.estadosMarcaProducto.codEstadoMarcaProducto}"
                            ...
                            <h:outputText value="::" styleClass="outputText2" style="font-weight:bold"/>
                            <h:inputText value="#{ManagedCertificadosSanitarios.marcasProductoEditar.resolucionRenovacion}"
                            styleClass="inputText" style="width:25em"/>
                            <h:outputText value="Fecha Registro Marca" styleClass="outputText2" style="font-weight:bold"/>
                            <h:outputText value="::" styleClass="outputText2" style="font-weight:bold"/>
                            <rich:calendar value="#{ManagedCertificadosSanitarios.marcasProductoEditar.fechaRegistroMarca}" datePattern="dd/MM/yyyy" styleClass="inputText"/>
                            <h:outputText value="Producto que se renovara" styleClass="outputText2" style="font-weight:bold"/>
                            <h:outputText value="::" styleClass="outputText2" style="font-weight:bold"/>
                            <h:selectBooleanCheckbox value="#{ManagedCertificadosSanitarios.marcasProductoEditar.productoRenovacion}"/>
                            <h:outputText value="Observacion" styleClass="outputText2" style="font-weight:bold"/>
                            <h:outputText value="::" styleClass="outputText2" style="font-weight:bold"/>
                            <h:inputTextarea value="#{ManagedCertificadosSanitarios.marcasProductoEditar.observacion}" style="width:25em" rows="4" styleClass="inputText"/>
                            
                        </h:panelGrid>
                        <CENTER STYLE="margin-top:1em">
                            <a4j:commandButton value="Guardar" styleClass="btn" action="#{ManagedCertificadosSanitarios.guardarEdicionMarcaProducto_action}"
                            ...
                            window.location.href='navegadorControlMarcasCertificado.jsf?cancele='+a;"/>
                        </CENTER>
                    </rich:panel>
