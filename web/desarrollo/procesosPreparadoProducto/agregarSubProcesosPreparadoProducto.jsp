        ...
        <body>
            <a4j:form id="form1">
                <div align="center">
                    ...
                    <h:outputText value="#{ManagedProductosDesarrolloVersion.cargarAgregarSubProcesosPreparadoProducto}"/>
                    <rich:panel headerClass="headerClassACliente" style="width:70%">
                        ...
                        <h:panelGrid columns="3" id="contenidoRegistrarSubProceso">
                            ...
                            <h:selectOneMenu value="#{ManagedProductosDesarrolloVersion.procesosPreparadoProducto.actividadesPreparado.codActividadPreparado}" id="codActividadPreparado" styleClass="inputText chosen">
                   ...
                   <rich:panel headerClass="headerClassACliente" style="width:70%">
                            ...
                            <a4j:commandButton value="Guardar"
                                               ...
                                               action="#{ManagedProductosDesarrolloVersion.guardarSubProcesosPreparadoProductoAction}" 
