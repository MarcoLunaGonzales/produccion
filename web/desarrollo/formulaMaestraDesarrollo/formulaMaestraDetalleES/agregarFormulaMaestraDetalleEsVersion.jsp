        ...
        <body >
            <h:form id="form1"  >
                ...
                <div align="center">
                    ...
                    <h:outputText value="#{ManagedProductosDesarrolloVersion.cargarAgregarFormulaMaestraDetalleEs}"/>
                    <rich:panel headerClass="headerClassACliente" style="width:70%;margin-top:0.3em">
                        ...
                        <rich:panel headerClass="headerClassACliente" style="min-width:50%;max-width:95%" id="datosPresentacion">
                            ...
                            <h:panelGrid columns="3">
                                ...
                                <h:selectOneMenu value="#{ManagedProductosDesarrolloVersion.componentesPresProdVersion.presentacionesProducto.codPresentacion}" styleClass="inputText chosen">
                                    <f:selectItems value="#{ManagedProductosDesarrolloVersion.presentacionesSelectList}"/>
                                    <a4j:support event="onchange" action="#{ManagedProductosDesarrolloVersion.codPresentacionAgregar_change}" reRender="datosPresentacion"/>
                                </h:selectOneMenu>
                                <h:outputText value="Tipo Programa Produccion" styleClass="outputText2" style="font-weight:bold"/>
                                <h:outputText value="::" styleClass="outputText2" style="font-weight:bold"/>
                                <h:selectOneMenu value="#{ManagedProductosDesarrolloVersion.componentesPresProdVersion.tiposProgramaProduccion.codTipoProgramaProd}" styleClass="inputText" id="codTipoProduccion">
                        ...
                        <h:column rendered="#{ManagedProductosDesarrolloVersion.defineLoteEs}">
                            <f:facet name="header">
                    ...
                    <div id="bottonesAcccion" class="barraBotones" >
                        <a4j:commandButton  value="Guardar" styleClass="btn"  action="#{ManagedProductosDesarrolloVersion.guardarComponentesPresProdVersionAction()}"
