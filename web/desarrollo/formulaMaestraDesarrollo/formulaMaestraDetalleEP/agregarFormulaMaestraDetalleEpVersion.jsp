...
<f:view>
    <html>
        ...
        <body >
            <h:form id="form1"  >
                <div align="center">
                    <h:outputText value="#{ManagedProductosDesarrolloVersion.cargarAgregarFormulaMaestraDetallaEp}"/>
                    ...
                    <div id="bottonesAcccion" class="barraBotones" >
                        <a4j:commandButton  value="Guardar" styleClass="btn"  action="#{ManagedProductosDesarrolloVersion.guardarPresentacionPrimariaAction()}"
                                    onclick="if(!validadRegistroCantidad()){return false;}"
                                    oncomplete="if(#{ManagedProductosDesarrolloVersion.mensaje eq '1'}){alert('Se registraron los materiales');var a=Math.random();redireccionar('navegadorFormulaMaestraEP.jsf');}else
                                    {alert('#{ManagedProductosDesarrolloVersion.mensaje}');}" />
