...
<f:view>
    ...
    <html>
        ...
        <a4j:form id="form1">
            <div align="center">
                <h:outputText value="#{ManagedProductosDesarrolloVersion.cargarAgregarEspecificacionesMaquinariaProcesoProducto}"/>
                ...
                <br/>
                    <rich:panel headerClass="headerClassACliente" style="width:50%">
                        ...
                        <h:panelGrid columns="3" headerClass="headerClassACliente">
                           ...
                           <h:outputText value="#{ManagedProductosDesarrolloVersion.componentesProdVersionMaquinariaProcesoBean.procesosOrdenManufactura.nombreProcesoOrdenManufactura}" styleClass="outputText2"/>
                           ...
                           <h:outputText value="#{ManagedProductosDesarrolloVersion.componentesProdVersionSeleccionado.forma.nombreForma} " styleClass="outputText2"/>
                            ...
                            <h:outputText value="::" styleClass="outputTextBold" />
                            <h:selectOneMenu value="#{ManagedProductosDesarrolloVersion.componentesProdVersionMaquinariaProcesoBean.maquinaria.codMaquina}" styleClass="inputText chosen">
                                <f:selectItems value="#{ManagedProductosDesarrolloVersion.maquinariasSelectList}"/>
                                <a4j:support event="onchange" reRender="dataEspecificaciones"
                                             action="#{ManagedProductosDesarrolloVersion.codCompProdVersionMaquinariaProceso_action}" />
                            </h:selectOneMenu>
                        </h:panelGrid>
                    </rich:panel>

                    <rich:dataTable value = "#{ManagedProductosDesarrolloVersion.componentesProdVersionMaquinariaProcesoBean.especificacionesProcesosProductoMaquinariaList}"
                        ...
                        <f:facet name="header">
                            <rich:columnGroup>
                                ...
                                <rich:column rendered="#{ManagedProductosDesarrolloVersion.componentesProdVersionMaquinariaProcesoBean.procesosOrdenManufactura.aplicaTipoEspecificacion}">
                        ...
                        <rich:columnGroup style="background-color:#{data.checked?'#90EE90':'#ffffff'}">
                            ...
                            <rich:column rendered="#{ManagedProductosDesarrolloVersion.componentesProdVersionMaquinariaProcesoBean.procesosOrdenManufactura.aplicaTipoEspecificacion}">
                                <h:selectOneMenu styleClass="inputText" value="#{data.tiposEspecificacionesProcesosProductoMaquinaria.codTipoEspecificacionProcesoProductoMaquinaria}">
                                    ...
                                    <f:selectItems value="#{ManagedProductosDesarrolloVersion.tiposEspecificacionesProcesoProductoMaquinariaSelectList}"/>
                                </h:selectOneMenu>
                            </rich:column>
                        </rich:columnGroup>
                    </rich:dataTable>
                    <div id="bottonesAcccion" class="barraBotones">
                        <a4j:commandButton value="Guardar" styleClass="btn" action="#{ManagedProductosDesarrolloVersion.guardarComponentesProdVersionMaquinariaProcesoAction}"
                        ...
                        <a4j:commandButton value="Cancelar"  styleClass="btn" oncomplete="redireccionar('navegadorMaquinariasPorProceso.jsf')"/>
                    </div>   
                </div>
