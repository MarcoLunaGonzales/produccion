        ...
        <center>
            ...
            <rich:panel headerClass="headerClassACliente" style="width:80%" id="contenidoEditar">
                ...
                <h:panelGrid columns="3">
                    ...
                    <h:outputText value="::" styleClass="outputTextBold"/>
                    <h:selectOneRadio value="#{ManagedProductosDesarrolloVersion.componentesProdVersion.productoSemiterminado}" styleClass="outputText2"
                ...
                <rich:dataTable value="#{ManagedProductosDesarrolloVersion.componentesProdVersion.componentesProdConcentracionList}" 
                            ...
                            <f:facet name="header">
                                ...
                                <rich:column>
                                    <h:inputText value="#{data.pesoMolecular}" size="5"/>
                                </rich:column>
                                <rich:column>
                                ...
                                <rich:column>
                                 ...
                                 <f:facet name="footer">
                                     <rich:columnGroup>
                                         <rich:column colspan="12" styleClass="tdCenter">
                        ...
                        <a4j:commandButton id="btnGuardar" 
                                       ...
                                       oncomplete="if('#{facesContext.maximumSeverity}'.length == 0){mostrarMensajeTransaccionEvento(function(){redireccionar('navegadorProductosDesarrolloEnsayos.jsf')})}"/>
                        <a4j:commandButton value="Cancelar" styleClass="btn"
                                           oncomplete="redireccionar('navegadorProductosDesarrolloEnsayos.jsf')"/>
                </rich:panel>
        ...
        <a4j:form>
           ...
           <h:panelGroup id="contenidoCrearNuevoProducto">
            ...
            <a4j:commandButton value="Guardar" oncomplete="if('#{facesContext.maximumSeverity}'.length == 0){Richfaces.hideModalPanel('panelCrearNuevoProducto');}"
                               ...
                               action="#{ManagedProductosDesarrolloVersion.guardarProducto()}"
                                styleClass="btn"/>
            <a4j:commandButton value="Cancelar" styleClass="btn"
