...
<f:view>
    ...
    <html>
        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                    <h:outputText value="#{ManagedProductosDesarrolloVersion.cargarLimpiezaUtensiliosPesaje}"/>
                    ...
                    <h:panelGroup id="contenido">
                        ...
                        <rich:dataTable value="#{ManagedProductosDesarrolloVersion.componentesProdVersionLimpiezaUtensilioPesajeList}"
                            ...
                            <f:facet name="header">
                                ...
                                <rich:column>
                                    <a4j:commandButton value="Eliminar" styleClass="btn" 
                                               action="#{ManagedProductosDesarrolloVersion.eliminarLimpiezaUtensilioPesajeAction(data.codComponentesProdVersionLimpiezaMaquinaria)}"
                        ...
                        <div style='margin-top:1em'>
                            <a4j:commandButton value="Agregar" styleClass="btn" oncomplete="redireccionar('agregarLimpiezaUtensiliosPesaje.jsf');"/>
