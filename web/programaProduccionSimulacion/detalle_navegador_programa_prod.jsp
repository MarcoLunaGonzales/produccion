        ...
        <body >
            <h:form id="form1"  >
                ...
                <div align="center">
                    ...
                    <h:outputText value=" #{ManagedProgramaProduccionSimulacion.obtenerCodigo}"  />
                    <h:outputText value="Detalle de Materiales de :#{ManagedProgramaProduccionSimulacion.nombreFromulaMaestra} #{ManagedProgramaProduccion.cantidadLote}"  />
                    <br> <br>
                    <b> Materia Prima </b>
                    <br>
                    ...
                    <rich:dataTable value="#{ManagedProgramaProduccionSimulacion.formulaMaestraMRList}" var="data" id="dataFormulaMPReactivos" 
                                    onRowMouseOut="this.style.backgroundColor='#FFFFFF';" 
                                    onRowMouseOver="this.style.backgroundColor='#DDE3E4';" 
                                    headerClass="headerClassACliente" width="75%">
