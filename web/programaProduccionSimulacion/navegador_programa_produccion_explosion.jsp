    ...
    <div  align="center" id="panelCenter">
        ...
        <rich:dataTable value="#{ManagedProgramaProduccionSimulacion.programaProduccionList}" var="data" id="dataFormula" 
            ...
            <h:column>
                ...
                <h:outputText value="<a  onclick=\"getCodigo('#{data.codProgramaProduccion}','#{data.formulaMaestra.codFormulaMaestra}','#{data.formulaMaestra.componentesProd.nombreProdSemiterminado}','#{data.formulaMaestra.cantidadLote}','#{data.formulaMaestra.componentesProd.codCompprod}','#{data.codLoteProduccion}');\" style='cursor:hand;text-decoration:underline' ><img src='../img/cargos.jpg' alt='Haga click para ver Detalle'></a>  "  escape="false"  />
            </h:column>    
        ...
        <div align="center" style="" id="botones"  >
            ...
            <a4j:commandButton value="Explosión Materiales"  styleClass="btn"  action="#{ManagedProgramaProduccionSimulacion.actionEliminar}"  oncomplete="enviar('#{ManagedProgramaProduccionSimulacion.codProgramaProd}','#{ManagedProgramaProduccionSimulacion.codigos}','#{ManagedProgramaProduccionSimulacion.fecha_inicio}','#{ManagedProgramaProduccionSimulacion.fecha_final}')" />
