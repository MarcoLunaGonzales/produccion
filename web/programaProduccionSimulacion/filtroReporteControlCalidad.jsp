                            ...
                            if(cel.getElementsByTagName('input')[0].type=='checkbox'){
                                //alert(cel.getElementsByTagName('input')[0].checked);
                                  if(cel.getElementsByTagName('input')[0].checked){
                                   codLote=cellsElement[1].innerHTML;
                                   count++;
                                 }
                ...
                <table border="0"  border="0" class="tablaFiltroReporte" width="50%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            String consulta="select cp.COD_COMPPROD,cp.nombre_prod_semiterminado from COMPONENTES_PROD cp where cp.COD_ESTADO_COMPPROD=1" +
