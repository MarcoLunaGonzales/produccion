...
<body >
    ...
    <div  align="center" id="panelCenter">
        ...
        <h:outputText value="#{ManagedDemandaProductos.cargarDemandaProductos}"  />
        <h:outputText styleClass="outputTextTitulo"  value="Demanda de Productos" />
        <br>
            <rich:dataTable value="#{ManagedDemandaProductos.demandaProductosList}"
                        var="data" id="dataDemandaProductos"
                        onRowMouseOut="this.style.backgroundColor='#FFFFFF';" 
                        onRowMouseOver="this.style.backgroundColor='#DDE3E4';" 
                        headerClass="headerClassACliente"
                        binding="#{ManagedDemandaProductos.demandaProductosDataTable}" >
            
            
            <h:column>
                <f:facet name="header">
                    <h:outputText value="Nombre Demanda"  />
                </f:facet>
                <h:outputText value="#{data.nombreDemanda}"  />
            </h:column>
            <h:column>
                <f:facet name="header">
                    <h:outputText value="Fecha Registro"  />
                </f:facet>
                <h:outputText value="#{data.fechaGenerado}"  />
            </h:column>
            <h:column>
                <f:facet name="header">
                    <h:outputText value="Estado"  />
                </f:facet>
                <h:outputText value="#{data.estadoDemandaProductos.nombreEstadoDemandaProductos}"  />
            </h:column>
            <h:column>
                <f:facet name="header">
                    <h:outputText value=""  />
                </f:facet>
                <a4j:commandLink action="#{ManagedDemandaProductos.seleccionarDemandaProductos_action}" oncomplete="location='navegador_demanda_productos_detalle.jsf'">
                    <h:outputText value="Generar Simulación \\n de Programa Produccion" />
                </a4j:commandLink>
            </h:column>
