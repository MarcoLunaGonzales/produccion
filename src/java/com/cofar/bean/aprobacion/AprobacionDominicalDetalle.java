 ...
 */
public class AprobacionDominicalDetalle extends AbstractBean {
    ...
    public AprobacionDominicalDetalle(int codigoAprobacion, int codigoPersonal, String nombre, String cargo, int base, int aprobado) {
