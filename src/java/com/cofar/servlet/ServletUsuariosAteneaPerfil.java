 ...
 * @version
 */
public class ServletUsuariosAteneaPerfil extends HttpServlet {
...
/*        String codigo=request.getParameter("codigo");
        ...
        try {
            ...
            sql1+=" from  ventanas_recursos_humanos  ";
    ...
    public void  generaMenuXml(String codigo, String cod_perfil,PrintWriter writer) throws IOException{
        ...
        try {
            ...
            for(int i=1;i<=row;i++){
                ...
                String sql2=" select * ";
                sql2+=" from perfil_acceso_ventana_atenea";
    ...
    public int   obtenerCantidad(String codigo) throws IOException{
        ...
        try {
            ...
            sql+=" from ventanas_recursos_humanos ";
