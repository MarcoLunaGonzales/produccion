...
/**
 *
 * @author Wilson Chopquehuanca Gonzales
 * @version
 */
public class ServletUsuariosCronosPerfil extends HttpServlet {
    ...
    public void organigramaempresaDos(HttpServletRequest request, HttpServletResponse response) throws IOException{
        String codPerfil=request.getParameter("codigo");
        ...
        try {
            ...
            generaMenuXml(codigo,codPerfil,writer);
            writer.write("</tree>");
            writer.close();
    ...
    public void  generaMenuXml(String codigo, String codPerfil,PrintWriter writer) throws IOException{
        ...
        try {
            ...
            for(int i=1;i<=row;i++){
                ...
                sql2+=" from ventanas_compras v,perfil_acceso_ventana_cronos u";
                sql2+=" where v.codigo_ventana=u.cod_ventana ";
                sql2+=" and u.cod_perfil="+codPerfil;
